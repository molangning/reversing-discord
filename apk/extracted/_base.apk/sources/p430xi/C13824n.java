...
public final class C13824n<T> extends AbstractC9570d implements FlowCollector<T> {
    ...
    /* renamed from: xi.n$a */
    /* loaded from: /home/user/temp/discord/apk/extracted/_base.apk/classes7.dex */
    static final class C13825a extends AbstractC9614s implements Function2<Integer, CoroutineContext.InterfaceC9564b, Integer> {
    ...
    private final Object m1449c(Continuation<? super Unit> continuation, T t) {
        ...
        Object invoke = Function3.m1446a().invoke(this.f35605j, t, this);
