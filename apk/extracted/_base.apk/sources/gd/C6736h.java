...
public class C6736h {
    ...
    public class C6738b extends HashMap<EnumC6206d, AbstractC7502g> {
        C6738b() {
            put(EnumC6206d.DAY, C6736h.this.f18960e);
            put(EnumC6206d.YEAR, C6736h.this.f18965j);
            put(EnumC6206d.MONTH, C6736h.this.f18964i);
            put(EnumC6206d.DATE, C6736h.this.f18963h);
            put(EnumC6206d.HOUR, C6736h.this.f18959d);
            put(EnumC6206d.MINUTE, C6736h.this.f18961f);
            put(EnumC6206d.AM_PM, C6736h.this.f18962g);
        }
    }
