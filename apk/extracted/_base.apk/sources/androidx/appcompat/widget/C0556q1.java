...
public class C0556q1 implements InterfaceC0534k0 {
    ...
    /* loaded from: /home/user/temp/discord/apk/extracted/_base.apk/classes.dex */
    class View$OnClickListenerC0557a implements View.OnClickListener {

        /* renamed from: j */
        final C0377a f1937j;

        View$OnClickListenerC0557a() {
            this.f1937j = new C0377a(C0556q1.this.f1920a.getContext(), 0, 16908332, 0, 0, C0556q1.this.f1928i);
        }
