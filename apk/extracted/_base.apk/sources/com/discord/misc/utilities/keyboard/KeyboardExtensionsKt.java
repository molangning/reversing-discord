...
public final class KeyboardExtensionsKt {
    ...
    public static final void hideKeyboard(View view, Window window) {
        ...
        C9810j.m13193d(MainImmediateScopeKt.MainImmediateScope(), null, null, new KeyboardExtensionsKt$hideKeyboard$1(window, view, null), 3, null);
    }

    public static final void showKeyboard(View view, Window window) {
        C9612q.m13917h(view, "<this>");
        C9612q.m13917h(window, "window");
        C9810j.m13193d(MainImmediateScopeKt.MainImmediateScope(), null, null, new KeyboardExtensionsKt$showKeyboard$1(window, view, null), 3, null);
    }
}
