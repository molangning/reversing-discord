...
public final class CodeStyleProviders<R> {
    ...
    public CodeStyleProviders(StyleNode.SpanProvider<R> defaultStyleProvider, StyleNode.SpanProvider<R> commentStyleProvider, StyleNode.SpanProvider<R> literalStyleProvider, StyleNode.SpanProvider<R> keywordStyleProvider, StyleNode.SpanProvider<R> identifierStyleProvider, StyleNode.SpanProvider<R> typesStyleProvider, StyleNode.SpanProvider<R> genericsStyleProvider, StyleNode.SpanProvider<R> paramsStyleProvider) {
        C9612q.m13917h(defaultStyleProvider, "defaultStyleProvider");
        C9612q.m13917h(commentStyleProvider, "commentStyleProvider");
        C9612q.m13917h(literalStyleProvider, "literalStyleProvider");
        C9612q.m13917h(keywordStyleProvider, "keywordStyleProvider");
        C9612q.m13917h(identifierStyleProvider, "identifierStyleProvider");
        C9612q.m13917h(typesStyleProvider, "typesStyleProvider");
        C9612q.m13917h(genericsStyleProvider, "genericsStyleProvider");
        C9612q.m13917h(paramsStyleProvider, "paramsStyleProvider");
    ...
    public boolean equals(Object obj) {
        if (this != obj) {
            if (obj instanceof CodeStyleProviders) {
                ...
                return C9612q.m13922c(this.defaultStyleProvider, codeStyleProviders.defaultStyleProvider) && C9612q.m13922c(this.commentStyleProvider, codeStyleProviders.commentStyleProvider) && C9612q.m13922c(this.literalStyleProvider, codeStyleProviders.literalStyleProvider) && C9612q.m13922c(this.keywordStyleProvider, codeStyleProviders.keywordStyleProvider) && C9612q.m13922c(this.identifierStyleProvider, codeStyleProviders.identifierStyleProvider) && C9612q.m13922c(this.typesStyleProvider, codeStyleProviders.typesStyleProvider) && C9612q.m13922c(this.genericsStyleProvider, codeStyleProviders.genericsStyleProvider) && C9612q.m13922c(this.paramsStyleProvider, codeStyleProviders.paramsStyleProvider);
            }
            return false;
        }
        return true;
