...
final class SimpleMarkdownRules$createUnderlineRule$1 extends AbstractC9614s implements Function0<List<? extends CharacterStyle>> {
    ...
    public final List<? extends CharacterStyle> invoke() {
        ...
        m14109d = C9544i.m14109d(new UnderlineSpan());
        return m14109d;
    }
}
