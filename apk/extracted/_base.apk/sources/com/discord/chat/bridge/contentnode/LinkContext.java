...
public final class LinkContext {
    ...
    @Metadata(m14358d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u000f\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004HÆ\u0001¨\u0006\u0006"}, m14357d2 = {"Lcom/discord/chat/bridge/contentnode/LinkContext$Companion;", "", "()V", "serializer", "Lkotlinx/serialization/KSerializer;", "Lcom/discord/chat/bridge/contentnode/LinkContext;", "chat_release"}, m14356k = 1, m14355mv = {1, 8, 0}, m14353xi = 48)
    /* loaded from: /home/user/temp/discord/apk/extracted/_base.apk/classes8.dex */
    ...
    public /* synthetic */ LinkContext(int i, UserNameOnClick userNameOnClick, UserNameOnClick userNameOnClick2, CommandOnClick commandOnClick, ActorHook actorHook, ThreadOnClick threadOnClick, PinsOnClick pinsOnClick, WebhookNameOnClick webhookNameOnClick, HandleDelete handleDelete, RoleSubscriptionOnClick roleSubscriptionOnClick, HandleMessage handleMessage, SerializationConstructorMarker serializationConstructorMarker) {
        if ((i & 0) != 0) {
            C2620n1.m32836b(i, 0, LinkContext$$serializer.INSTANCE.getDescriptor());
        }
        if ((i & 1) == 0) {
    ...
    public static final void write$Self(LinkContext self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        boolean z10 = false;
        if (output.mo12879z(serialDesc, 0) || self.usernameOnClick != null) {
            z = true;
        } else {
            z = false;
        }
        if (z) {
            output.mo12904E(serialDesc, 0, UserNameOnClick$$serializer.INSTANCE, self.usernameOnClick);
        }
        if (output.mo12879z(serialDesc, 1) || self.otherUsernameOnClick != null) {
            z2 = true;
        } else {
            z2 = false;
        }
        if (z2) {
            output.mo12904E(serialDesc, 1, UserNameOnClick$$serializer.INSTANCE, self.otherUsernameOnClick);
        }
        if (output.mo12879z(serialDesc, 2) || self.commandNameOnClick != null) {
            z3 = true;
        } else {
            z3 = false;
        }
        if (z3) {
            output.mo12904E(serialDesc, 2, CommandOnClick$$serializer.INSTANCE, self.commandNameOnClick);
        }
        if (output.mo12879z(serialDesc, 3) || self.actorHook != null) {
            z4 = true;
        } else {
            z4 = false;
        }
        if (z4) {
            output.mo12904E(serialDesc, 3, ActorHook$$serializer.INSTANCE, self.actorHook);
        }
        if (output.mo12879z(serialDesc, 4) || self.threadOnClick != null) {
            z5 = true;
        } else {
            z5 = false;
        }
        if (z5) {
            output.mo12904E(serialDesc, 4, ThreadOnClick$$serializer.INSTANCE, self.threadOnClick);
        }
        if (output.mo12879z(serialDesc, 5) || self.pinsOnClick != null) {
            z6 = true;
        } else {
            z6 = false;
        }
        if (z6) {
            output.mo12904E(serialDesc, 5, PinsOnClick$$serializer.INSTANCE, self.pinsOnClick);
        }
        if (output.mo12879z(serialDesc, 6) || self.webhookNameOnClick != null) {
            z7 = true;
        } else {
            z7 = false;
        }
        if (z7) {
            output.mo12904E(serialDesc, 6, WebhookNameOnClick$$serializer.INSTANCE, self.webhookNameOnClick);
        }
        if (output.mo12879z(serialDesc, 7) || self.handleDelete != null) {
            z8 = true;
        } else {
            z8 = false;
        }
        if (z8) {
            output.mo12904E(serialDesc, 7, HandleDelete$$serializer.INSTANCE, self.handleDelete);
        }
        if (output.mo12879z(serialDesc, 8) || self.roleSubscriptionOnClick != null) {
            z9 = true;
        } else {
            z9 = false;
        }
        if (z9) {
            output.mo12904E(serialDesc, 8, RoleSubscriptionOnClick$$serializer.INSTANCE, self.roleSubscriptionOnClick);
        }
        if (output.mo12879z(serialDesc, 9) || self.handleMessage != null) {
            z10 = true;
        }
        if (z10) {
            output.mo12904E(serialDesc, 9, HandleMessage$$serializer.INSTANCE, self.handleMessage);
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof LinkContext) {
            ...
            return C9612q.m13922c(this.usernameOnClick, linkContext.usernameOnClick) && C9612q.m13922c(this.otherUsernameOnClick, linkContext.otherUsernameOnClick) && C9612q.m13922c(this.commandNameOnClick, linkContext.commandNameOnClick) && C9612q.m13922c(this.actorHook, linkContext.actorHook) && C9612q.m13922c(this.threadOnClick, linkContext.threadOnClick) && C9612q.m13922c(this.pinsOnClick, linkContext.pinsOnClick) && C9612q.m13922c(this.webhookNameOnClick, linkContext.webhookNameOnClick) && C9612q.m13922c(this.handleDelete, linkContext.handleDelete) && C9612q.m13922c(this.roleSubscriptionOnClick, linkContext.roleSubscriptionOnClick) && C9612q.m13922c(this.handleMessage, linkContext.handleMessage);
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return hashCode9 + (handleMessage != null ? handleMessage.hashCode() : 0);
    }
    ...
    public /* synthetic */ LinkContext(UserNameOnClick userNameOnClick, UserNameOnClick userNameOnClick2, CommandOnClick commandOnClick, ActorHook actorHook, ThreadOnClick threadOnClick, PinsOnClick pinsOnClick, WebhookNameOnClick webhookNameOnClick, HandleDelete handleDelete, RoleSubscriptionOnClick roleSubscriptionOnClick, HandleMessage handleMessage, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? null : userNameOnClick, (i & 2) != 0 ? null : userNameOnClick2, (i & 4) != 0 ? null : commandOnClick, (i & 8) != 0 ? null : actorHook, (i & 16) != 0 ? null : threadOnClick, (i & 32) != 0 ? null : pinsOnClick, (i & 64) != 0 ? null : webhookNameOnClick, (i & 128) != 0 ? null : handleDelete, (i & 256) != 0 ? null : roleSubscriptionOnClick, (i & 512) == 0 ? handleMessage : null);
    }
}
