...
public enum MessageType implements IntEnum {
    ...
    @Metadata(m14358d1 = {"\u0000\u001e\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\"\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u000f\u0010\n\u001a\b\u0012\u0004\u0012\u00020\u00050\u000bHÆ\u0001R\u0017\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0006\u0010\u0007R\u0017\u0010\b\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004¢\u0006\b\n\u0000\u001a\u0004\b\t\u0010\u0007¨\u0006\f"}, m14357d2 = {"Lcom/discord/chat/bridge/MessageType$Companion;", "", "()V", "CallTypes", "", "Lcom/discord/chat/bridge/MessageType;", "getCallTypes", "()Ljava/util/Set;", "SystemTypes", "getSystemTypes", "serializer", "Lkotlinx/serialization/KSerializer;", "chat_release"}, m14356k = 1, m14355mv = {1, 8, 0}, m14353xi = 48)
    /* loaded from: /home/user/temp/discord/apk/extracted/_base.apk/classes8.dex */
    ...
    @Metadata(m14358d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\bÆ\u0002\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0003¨\u0006\u0004"}, m14357d2 = {"Lcom/discord/chat/bridge/MessageType$Serializer;", "Lcom/discord/serialization/IntEnumSerializer;", "Lcom/discord/chat/bridge/MessageType;", "()V", "chat_release"}, m14356k = 1, m14355mv = {1, 8, 0}, m14353xi = 48)
    /* loaded from: /home/user/temp/discord/apk/extracted/_base.apk/classes8.dex */
    public static final class Serializer extends IntEnumSerializer<MessageType> {
        public static final Serializer INSTANCE = new Serializer();

        private Serializer() {
            super(C9591f0.m13969b(MessageType.class), null, 2, null);
        }
    }
    ...
    static {
        ...
        EnumSet of = EnumSet.of(r0, messageType, messageType29, messageType2, messageType3, messageType4, messageType5, messageType6, messageType7, messageType8, messageType9, messageType10, messageType30, messageType11, messageType12, messageType13, messageType14, messageType15, messageType16, messageType17, messageType18, messageType19, messageType20, messageType21, messageType22, messageType23, messageType24, messageType25, messageType26, messageType27, messageType28);
        C9612q.m13918g(of, "of(\n            RECIPIEN…G_STATS_PROMPT,\n        )");
        SystemTypes = of;
        EnumSet of2 = EnumSet.of(messageType29, messageType30);
        C9612q.m13918g(of2, "of(\n            CALL,\n  …  GUILD_STREAM,\n        )");
        CallTypes = of2;
        m7600b = C11577n.m7600b(EnumC11580p.PUBLICATION, MessageType$Companion$$cachedSerializer$delegate$1.INSTANCE);
    ...
    MessageType(int i) {
        ...
        Lazy m7601a3;
        this.serialNumber = i;
        m7601a = C11577n.m7601a(new MessageType$isSystem$2(this));
        this.isSystem$delegate = m7601a;
        m7601a2 = C11577n.m7601a(new MessageType$isAutomodSystem$2(this));
        this.isAutomodSystem$delegate = m7601a2;
        m7601a3 = C11577n.m7601a(new MessageType$isCall$2(this));
        this.isCall$delegate = m7601a3;
    }
