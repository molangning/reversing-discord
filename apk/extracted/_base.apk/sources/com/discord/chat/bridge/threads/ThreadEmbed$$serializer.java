...
public final class ThreadEmbed$$serializer implements InterfaceC2582f0<ThreadEmbed> {
    ...
    static {
        ...
        pluginGeneratedSerialDescriptor.m12856l("messageCountLabel", false);
        pluginGeneratedSerialDescriptor.m12856l("messagePreviewString", true);
        pluginGeneratedSerialDescriptor.m12856l("archived", true);
        pluginGeneratedSerialDescriptor.m12856l("archivedIconUrl", true);
    ...
    public KSerializer<?>[] childSerializers() {
        ...
        return new KSerializer[]{c2560a2, c2560a2, C0213a.m40920u(c2560a2), C0213a.m40920u(C2590h.f7055a), C0213a.m40920u(c2560a2), C0213a.m40920u(ThreadEmbedMessage$$serializer.INSTANCE)};
    }
    ...
    public ThreadEmbed deserialize(Decoder decoder) {
        ...
        if (mo12920b.mo12865p()) {
            ...
            obj2 = mo12920b.mo12867n(descriptor2, 3, C2590h.f7055a, null);
            obj3 = mo12920b.mo12867n(descriptor2, 4, c2560a2, null);
            obj4 = mo12920b.mo12867n(descriptor2, 5, ThreadEmbedMessage$$serializer.INSTANCE, null);
            str = mo12868m;
            str2 = mo12868m2;
            i = 63;
        } else {
            ...
            while (z) {
                ...
                switch (mo12866o) {
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        obj6 = mo12920b.mo12867n(descriptor2, 3, C2590h.f7055a, obj6);
                        i2 |= 8;
                        break;
                    case 4:
                        ...
                        break;
                    case 5:
                        obj8 = mo12920b.mo12867n(descriptor2, 5, ThreadEmbedMessage$$serializer.INSTANCE, obj8);
                        i2 |= 32;
                        break;
                    default:
        ...
        return new ThreadEmbed(i, str, str2, (String) obj, (Boolean) obj2, (String) obj3, (ThreadEmbedMessage) obj4, (SerializationConstructorMarker) null);
    }
    ...
    public void serialize(Encoder encoder, ThreadEmbed value) {
        ...
        ThreadEmbed.write$Self(value, mo12900b, descriptor2);
