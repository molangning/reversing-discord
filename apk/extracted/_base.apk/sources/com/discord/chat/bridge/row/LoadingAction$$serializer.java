...
public final class LoadingAction$$serializer implements InterfaceC2582f0<LoadingAction> {
    ...
    public LoadingAction deserialize(Decoder decoder) {
        ...
        if (mo12920b.mo12865p()) {
            obj = mo12920b.mo12862y(descriptor2, 0, LoadingActionType.Companion.serializer(), null);
        } else {
            int i2 = 0;
            obj = null;
            while (i != 0) {
                ...
                if (mo12866o == -1) {
                    ...
                    obj = mo12920b.mo12862y(descriptor2, 0, LoadingActionType.Companion.serializer(), obj);
                    i2 |= 1;
                }
            }
            i = i2;
    ...
    public void serialize(Encoder encoder, LoadingAction value) {
        ...
        LoadingAction.write$Self(value, mo12900b, descriptor2);
