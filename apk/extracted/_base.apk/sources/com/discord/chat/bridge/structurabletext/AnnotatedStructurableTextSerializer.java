...
public final class AnnotatedStructurableTextSerializer implements KSerializer<AnnotatedStructurableText> {
    ...
    private static final SerialDescriptor descriptor = C2340g.m33640a("AnnotatedStructurableText", AbstractC2325e.C2334i.f6445a);
    ...
    public AnnotatedStructurableText deserialize(Decoder decoder) {
        ...
        return new AnnotatedStructurableText((List) decoder.mo12924G(new C2581f(ContentNodeSerializer.INSTANCE)));
    }
