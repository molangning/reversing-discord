...
public final class LineBreakContentNode extends ContentNode {
    ...
    public /* synthetic */ LineBreakContentNode(int i, SerializationConstructorMarker serializationConstructorMarker) {
        super(null);
        if ((i & 0) != 0) {
            C2620n1.m32836b(i, 0, LineBreakContentNode$$serializer.INSTANCE.getDescriptor());
        }
    }
