...
public final class TimestampContentNode extends ContentNode {
    ...
    @Metadata(m14358d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u000f\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004HÆ\u0001¨\u0006\u0006"}, m14357d2 = {"Lcom/discord/chat/bridge/contentnode/TimestampContentNode$Companion;", "", "()V", "serializer", "Lkotlinx/serialization/KSerializer;", "Lcom/discord/chat/bridge/contentnode/TimestampContentNode;", "chat_release"}, m14356k = 1, m14355mv = {1, 8, 0}, m14353xi = 48)
    /* loaded from: /home/user/temp/discord/apk/extracted/_base.apk/classes8.dex */
    ...
    public /* synthetic */ TimestampContentNode(int i, long j, String str, String str2, SerializationConstructorMarker serializationConstructorMarker) {
        super(null);
        if (7 != (i & 7)) {
            C2620n1.m32836b(i, 7, TimestampContentNode$$serializer.INSTANCE.getDescriptor());
        }
        this.timestamp = j;
        this.full = str;
        this.formatted = str2;
    ...
    public static final void write$Self(TimestampContentNode self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.mo12905D(serialDesc, 0, self.timestamp);
        output.mo12880y(serialDesc, 1, self.full);
        output.mo12880y(serialDesc, 2, self.formatted);
    }
    ...
    public final TimestampContentNode copy(long j, String full, String formatted) {
        C9612q.m13917h(full, "full");
        C9612q.m13917h(formatted, "formatted");
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof TimestampContentNode) {
            ...
            return this.timestamp == timestampContentNode.timestamp && C9612q.m13922c(this.full, timestampContentNode.full) && C9612q.m13922c(this.formatted, timestampContentNode.formatted);
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((C2689b.m32716a(this.timestamp) * 31) + this.full.hashCode()) * 31) + this.formatted.hashCode();
    }
