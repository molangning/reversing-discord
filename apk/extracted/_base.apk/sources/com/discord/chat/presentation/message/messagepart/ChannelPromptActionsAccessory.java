...
public final class ChannelPromptActionsAccessory extends MessageAccessory {
    ...
    public ChannelPromptActionsAccessory(Message message) {
        super(message.m41436getId3Eiw7ao(), "channel deadchat prompt actions", null);
        C9612q.m13917h(message, "message");
        this.message = message;
    }

    public static /* synthetic */ ChannelPromptActionsAccessory copy$default(ChannelPromptActionsAccessory channelPromptActionsAccessory, Message message, int i, Object obj) {
        if ((i & 1) != 0) {
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof ChannelPromptActionsAccessory) && C9612q.m13922c(this.message, ((ChannelPromptActionsAccessory) obj).message);
    }
