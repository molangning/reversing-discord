...
public final class InviteToSpeakView extends LinearLayout {
    ...
    public static final void setProps$lambda$1(Function1 onInviteToSpeakClicked, Message message, View view) {
        ...
        onInviteToSpeakClicked.invoke(MessageId.m42073boximpl(message.m41436getId3Eiw7ao()));
    }

    public final void setProps(final Message message, final Function1<? super MessageId, Unit> onInviteToSpeakClicked) {
        C9612q.m13917h(message, "message");
        C9612q.m13917h(onInviteToSpeakClicked, "onInviteToSpeakClicked");
        NestedScrollOnTouchUtilsKt.setOnClickListenerNested$default(this, false, new View.OnClickListener() { // from class: d2.a
        ...
        C9612q.m13918g(simpleDraweeView, "binding.moveToSpeakerIcon");
        ...
        C9612q.m13918g(simpleDraweeView2, "binding.moveToSpeakerIcon");
