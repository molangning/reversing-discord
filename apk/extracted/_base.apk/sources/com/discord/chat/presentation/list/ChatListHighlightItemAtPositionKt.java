...
@Metadata(m14358d1 = {"\u0000\"\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\t\n\u0000\n\u0002\u0010\b\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0002\b\u0004\u001a(\u0010\u0000\u001a\u00020\u0001*\u00020\u00022\u0006\u0010\u0003\u001a\u00020\u00042\b\b\u0001\u0010\u0005\u001a\u00020\u00062\b\b\u0001\u0010\u0007\u001a\u00020\u0006H\u0002\u001a2\u0010\b\u001a\u00020\u0001*\u00020\u00022\u0006\u0010\u0003\u001a\u00020\u00042\b\b\u0001\u0010\u0005\u001a\u00020\u00062\b\b\u0001\u0010\t\u001a\u00020\u00062\b\b\u0001\u0010\u0007\u001a\u00020\u0006H\u0002\u001a\u001e\u0010\n\u001a\u00020\u0001*\u00020\u000b2\u0006\u0010\f\u001a\u00020\u00062\b\b\u0002\u0010\r\u001a\u00020\u0004H\u0000\u001a\u001e\u0010\u000e\u001a\u00020\u0001*\u00020\u000b2\u0006\u0010\f\u001a\u00020\u00062\b\b\u0002\u0010\r\u001a\u00020\u0004H\u0000¨\u0006\u000f"}, m14357d2 = {"animateBackgroundColor", "", "Landroid/view/View;", "delay", "", "startColor", "", "endColor", "animateHighlightBackgroundColor", "fullColor", "chatListEmphasizeHighlightItemAtPosition", "Landroidx/recyclerview/widget/RecyclerView;", ViewProps.POSITION, "delayMilliseconds", "chatListHighlightItemAtPosition", "chat_release"}, m14356k = 2, m14355mv = {1, 8, 0}, m14353xi = 48)
...
public final class ChatListHighlightItemAtPositionKt {
    ...
    private static final void animateBackgroundColor$anim(long j, final View view, int i, int i2, final Function1<? super Animator, Unit> function1) {
        ...
        animator.addListener(new Animator.AnimatorListener() { // from class: com.discord.chat.presentation.list.ChatListHighlightItemAtPositionKt$animateBackgroundColor$anim$lambda$1$$inlined$addListener$default$1
            ...
            public void onAnimationCancel(Animator animator2) {
                C9612q.m13917h(animator2, "animator");
            }
    ...
    public static final void animateBackgroundColor$anim$lambda$1$lambda$0(View this_animateBackgroundColor, ValueAnimator valueAnimator) {
        C9612q.m13917h(this_animateBackgroundColor, "$this_animateBackgroundColor");
        C9612q.m13917h(valueAnimator, "valueAnimator");
    ...
    public static final void animateHighlightBackgroundColor$anim$4$lambda$3$lambda$2(View this_animateHighlightBackgroundColor, ValueAnimator valueAnimator) {
        C9612q.m13917h(this_animateHighlightBackgroundColor, "$this_animateHighlightBackgroundColor");
        C9612q.m13917h(valueAnimator, "valueAnimator");
        Object animatedValue = valueAnimator.getAnimatedValue();
        C9612q.m13919f(animatedValue, "null cannot be cast to non-null type kotlin.Int");
    ...
    public static final void chatListEmphasizeHighlightItemAtPosition(RecyclerView recyclerView, int i, long j) {
        ...
        if (layoutManager != null && (mo35749N = layoutManager.mo35749N(i)) != null) {
            ...
            animateHighlightBackgroundColor(mo35749N, j, colorCompat, ColorUtilsKt.getColorCompat(context2, ThemeManagerKt.getTheme().getColorRes(C2912R.color.brand_new_360_alpha_20, C2912R.color.brand_new_360_alpha_25)), ThemeManagerKt.getTheme().getBackgroundMessageHighlight());
        }
    }
    ...
    public static final void chatListHighlightItemAtPosition(RecyclerView recyclerView, int i, long j) {
        ...
        if (layoutManager != null && (mo35749N = layoutManager.mo35749N(i)) != null) {
            Context context = recyclerView.getContext();
            C9612q.m13918g(context, "context");
            animateBackgroundColor(mo35749N, j, ColorUtilsKt.getColorCompat(context, 17170445), ThemeManagerKt.getTheme().getBackgroundModifierSelected());
        }
    }
