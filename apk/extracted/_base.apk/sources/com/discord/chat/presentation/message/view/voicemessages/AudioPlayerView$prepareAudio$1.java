...
public final class AudioPlayerView$prepareAudio$1 extends AbstractC9614s implements Function1<MediaPlayer.Event, Unit> {
    ...
    public final void invoke2(MediaPlayer.Event event) {
        ...
        if (C9612q.m13922c(event, MediaPlayer.Event.Paused.INSTANCE) ? true : C9612q.m13922c(event, MediaPlayer.Event.PlaybackEnded.INSTANCE)) {
        ...
        } else if (C9612q.m13922c(event, MediaPlayer.Event.StartedPlaying.INSTANCE)) {
