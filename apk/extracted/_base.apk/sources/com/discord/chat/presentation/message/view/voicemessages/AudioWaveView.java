...
public final class AudioWaveView extends View {
    ...
    private final void finishAnimation() {
        ...
        this.animationJob = C9810j.m13193d(CoroutineViewUtilsKt.getAttachedScope(this), null, null, new AudioWaveView$finishAnimation$1(this, null), 3, null);
    }
    ...
    private final void recalculateSampleData(byte[] bArr, int i, boolean z) {
        if (z && i != this.downSampleData.length) {
            C9810j.m13193d(CoroutineViewUtilsKt.getAttachedScope(this), null, null, new AudioWaveView$recalculateSampleData$1(this, bArr, i, null), 3, null);
        } else {
            invalidate();
        }
    }
