...
public final class GuildEventInviteViewHolder extends MessagePartViewHolder {
    ...
    public GuildEventInviteViewHolder(GuildEventInviteView guildEventInviteView, ChatEventHandler eventHandler, Function1<? super MessagePartViewHolder, Unit> onTapSpoiler) {
        ...
        C9612q.m13917h(guildEventInviteView, "guildEventInviteView");
    ...
    public static final void bind$lambda$3$lambda$2$lambda$0(GuildEventInviteViewHolder this$0, GuildEventInviteMessageAccessory inviteAccessory, View view) {
        ...
        this$0.eventHandler.mo41594onTapInviteEmbedAFFcxXc(inviteAccessory.mo41659getMessageId3Eiw7ao(), inviteAccessory.getCodedLinkIndex(), Boolean.TRUE, Boolean.FALSE);
    }
    ...
    public static final void bind$lambda$3$lambda$2$lambda$1(GuildEventInviteViewHolder this$0, GuildEventInviteMessageAccessory inviteAccessory, View view) {
        C9612q.m13917h(this$0, "this$0");
        C9612q.m13917h(inviteAccessory, "$inviteAccessory");
        this$0.eventHandler.mo41594onTapInviteEmbedAFFcxXc(inviteAccessory.mo41659getMessageId3Eiw7ao(), inviteAccessory.getCodedLinkIndex(), Boolean.FALSE, Boolean.TRUE);
    }
    ...
    public final void bind(final GuildEventInviteMessageAccessory inviteAccessory) {
        ...
        guildEventInviteView.setAcceptButton(invite.getAcceptLabelIcon(), invite.getAcceptLabelText(), invite.getAcceptLabelColor(), invite.getAcceptLabelBorderColor(), invite.getAcceptLabelBackgroundColor(), new View.OnClickListener() { // from class: com.discord.chat.presentation.message.viewholder.l
        ...
        guildEventInviteView.setSecondaryButton(invite.getSecondaryActionIcon(), new View.OnClickListener() { // from class: com.discord.chat.presentation.message.viewholder.m
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
