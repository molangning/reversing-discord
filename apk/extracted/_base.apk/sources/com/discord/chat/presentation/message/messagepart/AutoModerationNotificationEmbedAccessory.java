...
public final class AutoModerationNotificationEmbedAccessory extends MessageAccessory {
    ...
    public static /* synthetic */ AutoModerationNotificationEmbedAccessory m41668copyu7_MRrM$default(AutoModerationNotificationEmbedAccessory autoModerationNotificationEmbedAccessory, String str, Message message, AutoModerationContext autoModerationContext, int i, Object obj) {
        if ((i & 1) != 0) {
            str = autoModerationNotificationEmbedAccessory.mo41659getMessageId3Eiw7ao();
        }
        if ((i & 2) != 0) {
        ...
        return autoModerationNotificationEmbedAccessory.m41670copyu7_MRrM(str, message, autoModerationContext);
    }

    /* renamed from: component1-3Eiw7ao  reason: not valid java name */
    public final String m41669component13Eiw7ao() {
    ...
    public final AutoModerationNotificationEmbedAccessory m41670copyu7_MRrM(String messageId, Message message, AutoModerationContext moderationContext) {
        C9612q.m13917h(messageId, "messageId");
        C9612q.m13917h(message, "message");
        C9612q.m13917h(moderationContext, "moderationContext");
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AutoModerationNotificationEmbedAccessory) {
            ...
            return MessageId.m42077equalsimpl0(mo41659getMessageId3Eiw7ao(), autoModerationNotificationEmbedAccessory.mo41659getMessageId3Eiw7ao()) && C9612q.m13922c(this.message, autoModerationNotificationEmbedAccessory.message) && C9612q.m13922c(this.moderationContext, autoModerationNotificationEmbedAccessory.moderationContext);
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((MessageId.m42078hashCodeimpl(mo41659getMessageId3Eiw7ao()) * 31) + this.message.hashCode()) * 31) + this.moderationContext.hashCode();
    }
    ...
    public String toString() {
        ...
        return "AutoModerationNotificationEmbedAccessory(messageId=" + m42079toStringimpl + ", message=" + message + ", moderationContext=" + autoModerationContext + ")";
    }
}
