...
public final class MessageItem extends ChatListItem {
    ...
    public /* synthetic */ MessageItem(Message message, MessageFrame messageFrame, MessageContext messageContext, boolean z, boolean z2, BackgroundHighlight backgroundHighlight, Integer num, boolean z3, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(message, (i & 2) != 0 ? null : messageFrame, (i & 4) != 0 ? new MessageContext(false, false, null, null, null, null, null, false, false, false, false, false, null, 8191, null) : messageContext, (i & 8) != 0 ? true : z, (i & 16) != 0 ? false : z2, (i & 32) != 0 ? null : backgroundHighlight, (i & 64) == 0 ? num : null, (i & 128) == 0 ? z3 : false);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof MessageItem) {
            ...
            return C9612q.m13922c(this.message, messageItem.message) && C9612q.m13922c(this.messageFrame, messageItem.messageFrame) && C9612q.m13922c(this.messageContext, messageItem.messageContext) && this.allowChildGestures == messageItem.allowChildGestures && this.isHighlight == messageItem.isHighlight && C9612q.m13922c(this.backgroundHighlight, messageItem.backgroundHighlight) && C9612q.m13922c(this.reactTag, messageItem.reactTag) && this.renderContentOnly == messageItem.renderContentOnly;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        int hashCode3 = (i4 + (backgroundHighlight == null ? 0 : backgroundHighlight.hashCode())) * 31;
