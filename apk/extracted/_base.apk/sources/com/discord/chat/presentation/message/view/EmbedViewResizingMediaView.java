...
public final class EmbedViewResizingMediaView extends MediaView {
    ...
    public final Target getTarget() {
        ...
        C9612q.m13900y(TouchesHelper.TARGET_KEY);
        return null;
    }

    public final void setTarget(Target target) {
        C9612q.m13917h(target, "<set-?>");
        this.target = target;
    }
    ...
    public final void setTarget(int i, int i2, int i3, int i4) {
        ...
        if (this.target == null || !C9612q.m13922c(getTarget(), target)) {
            setTarget(target);
        }
