...
@Metadata(m14358d1 = {"\u00004\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0011\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0006\bÇ\u0002\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0013\u0010\u0014J\u001a\u0010\u0005\u001a\f\u0012\b\u0012\u0006\u0012\u0002\b\u00030\u00040\u0003HÖ\u0001¢\u0006\u0004\b\u0005\u0010\u0006J\u0011\u0010\t\u001a\u00020\u00022\u0006\u0010\b\u001a\u00020\u0007HÖ\u0001J\u0019\u0010\u000e\u001a\u00020\r2\u0006\u0010\u000b\u001a\u00020\n2\u0006\u0010\f\u001a\u00020\u0002HÖ\u0001R\u0014\u0010\u0012\u001a\u00020\u000f8VXÖ\u0005¢\u0006\u0006\u001a\u0004\b\u0010\u0010\u0011¨\u0006\u0015"}, m14357d2 = {"com/discord/chat/reactevents/VoiceMessagePlaybackStartedData.$serializer", "Lcj/f0;", "Lcom/discord/chat/reactevents/VoiceMessagePlaybackStartedData;", "", "Lkotlinx/serialization/KSerializer;", "childSerializers", "()[Lkotlinx/serialization/KSerializer;", "Lkotlinx/serialization/encoding/Decoder;", "decoder", "deserialize", "Lkotlinx/serialization/encoding/Encoder;", "encoder", "value", "", "serialize", "Lkotlinx/serialization/descriptors/SerialDescriptor;", "getDescriptor", "()Lkotlinx/serialization/descriptors/SerialDescriptor;", "descriptor", "<init>", "()V", "chat_release"}, m14356k = 1, m14355mv = {1, 8, 0})
/* loaded from: /home/user/temp/discord/apk/extracted/_base.apk/classes8.dex */
public final class VoiceMessagePlaybackStartedData$$serializer implements InterfaceC2582f0<VoiceMessagePlaybackStartedData> {
    ...
    static {
        ...
        pluginGeneratedSerialDescriptor.m12856l("startDurationSecs", false);
    ...
    public KSerializer<?>[] childSerializers() {
        ...
        return new KSerializer[]{MessageId$$serializer.INSTANCE, c2578e0, c2578e0, UserId$$serializer.INSTANCE};
    }
    ...
    public VoiceMessagePlaybackStartedData deserialize(Decoder decoder) {
        ...
        if (mo12920b.mo12865p()) {
            ...
            while (z) {
                ...
                if (mo12866o == -1) {
                    ...
                    f4 = mo12920b.mo12863u(descriptor2, 1);
                    i2 |= 2;
                } else if (mo12866o == 2) {
                    f3 = mo12920b.mo12863u(descriptor2, 2);
                    i2 |= 4;
                } else if (mo12866o != 3) {
        ...
        return new VoiceMessagePlaybackStartedData(i, messageId != null ? messageId.m42081unboximpl() : null, f2, f, (UserId) obj2, null, null);
    }
    ...
    public void serialize(Encoder encoder, VoiceMessagePlaybackStartedData value) {
        ...
        VoiceMessagePlaybackStartedData.write$Self(value, mo12900b, descriptor2);
