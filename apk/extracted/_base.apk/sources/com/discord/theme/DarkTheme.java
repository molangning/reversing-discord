...
public final class DarkTheme extends DiscordTheme {
    ...
    public DarkTheme(Context context) {
        ...
        this.androidNavigationBarBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.primary_830);
        this.androidNavigationScrimBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.android_navigation_scrim_background_dark);
        this.androidRipple = ColorUtilsKt.getColorCompat(context, C3511R.color.android_ripple_dark);
        int i2 = C3511R.color.primary_530;
        this.backgroundAccent = ColorUtilsKt.getColorCompat(context, i2);
        int i3 = C3511R.color.primary_800;
        this.backgroundFloating = ColorUtilsKt.getColorCompat(context, i3);
        this.backgroundMentioned = ColorUtilsKt.getColorCompat(context, C3511R.color.background_mentioned_dark);
        this.backgroundMentionedHover = ColorUtilsKt.getColorCompat(context, C3511R.color.background_mentioned_hover_dark);
        this.backgroundMessageAutomod = ColorUtilsKt.getColorCompat(context, C3511R.color.background_message_automod_dark);
        this.backgroundMessageAutomodHover = ColorUtilsKt.getColorCompat(context, C3511R.color.background_message_automod_hover_dark);
        this.backgroundMessageHighlight = ColorUtilsKt.getColorCompat(context, C3511R.color.background_message_highlight_dark);
        this.backgroundMessageHighlightHover = ColorUtilsKt.getColorCompat(context, C3511R.color.background_message_highlight_hover_dark);
        this.backgroundMessageHover = ColorUtilsKt.getColorCompat(context, C3511R.color.background_message_hover_dark);
        int i4 = C3511R.color.primary_600;
        this.backgroundMobilePrimary = ColorUtilsKt.getColorCompat(context, i4);
        int i5 = C3511R.color.primary_630;
        this.backgroundMobileSecondary = ColorUtilsKt.getColorCompat(context, i5);
        this.backgroundModifierAccent = ColorUtilsKt.getColorCompat(context, C3511R.color.background_modifier_accent_dark);
        this.backgroundModifierAccent2 = ColorUtilsKt.getColorCompat(context, C3511R.color.background_modifier_accent_2_dark);
        this.backgroundModifierActive = ColorUtilsKt.getColorCompat(context, C3511R.color.background_modifier_active_dark);
        this.backgroundModifierHover = ColorUtilsKt.getColorCompat(context, C3511R.color.background_modifier_hover_dark);
        this.backgroundModifierSelected = ColorUtilsKt.getColorCompat(context, C3511R.color.background_modifier_selected_dark);
        this.backgroundNestedFloating = ColorUtilsKt.getColorCompat(context, i5);
        this.backgroundPrimary = ColorUtilsKt.getColorCompat(context, i4);
        this.backgroundSecondary = ColorUtilsKt.getColorCompat(context, i5);
        int i6 = C3511R.color.primary_660;
        this.backgroundSecondaryAlt = ColorUtilsKt.getColorCompat(context, i6);
        this.backgroundTertiary = ColorUtilsKt.getColorCompat(context, i);
        this.bgBackdrop = ColorUtilsKt.getColorCompat(context, C3511R.color.bg_backdrop_dark);
        int i7 = C3511R.color.black_500;
        this.bgBackdropNoOpacity = ColorUtilsKt.getColorCompat(context, i7);
        this.bgBasePrimary = ColorUtilsKt.getColorCompat(context, i4);
        this.bgBaseSecondary = ColorUtilsKt.getColorCompat(context, i5);
        this.bgBaseTertiary = ColorUtilsKt.getColorCompat(context, i6);
        this.bgModFaint = ColorUtilsKt.getColorCompat(context, C3511R.color.bg_mod_faint_dark);
        this.bgModStrong = ColorUtilsKt.getColorCompat(context, C3511R.color.bg_mod_strong_dark);
        this.bgModSubtle = ColorUtilsKt.getColorCompat(context, C3511R.color.bg_mod_subtle_dark);
        this.bgSurfaceOverlay = ColorUtilsKt.getColorCompat(context, i3);
        this.bgSurfaceOverlayTmp = ColorUtilsKt.getColorCompat(context, i3);
        this.bgSurfaceRaised = ColorUtilsKt.getColorCompat(context, i4);
        this.black = ColorUtilsKt.getColorCompat(context, i7);
        this.blurFallback = ColorUtilsKt.getColorCompat(context, C3511R.color.blur_fallback_dark);
        this.blurFallbackPressed = ColorUtilsKt.getColorCompat(context, C3511R.color.blur_fallback_pressed_dark);
        this.borderFaint = ColorUtilsKt.getColorCompat(context, C3511R.color.border_faint_dark);
        this.borderStrong = ColorUtilsKt.getColorCompat(context, C3511R.color.border_strong_dark);
        this.borderSubtle = ColorUtilsKt.getColorCompat(context, C3511R.color.border_subtle_dark);
        this.bugReporterModalSubmittingBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.bug_reporter_modal_submitting_background_dark);
        ...
        this.buttonOutlineBrandBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.button_outline_brand_background_dark);
        ...
        this.buttonOutlineDangerBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.button_outline_danger_background_dark);
        ...
        this.buttonOutlinePositiveBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.button_outline_positive_background_dark);
        ...
        this.buttonOutlinePrimaryBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.button_outline_primary_background_dark);
        int i18 = C3511R.color.primary_430;
        this.buttonOutlinePrimaryBackgroundActive = ColorUtilsKt.getColorCompat(context, i18);
        int i19 = C3511R.color.primary_500;
        this.buttonOutlinePrimaryBackgroundHover = ColorUtilsKt.getColorCompat(context, i19);
        this.buttonOutlinePrimaryBorder = ColorUtilsKt.getColorCompat(context, i19);
        ...
        int i20 = C3511R.color.primary_400;
        ...
        this.cardGradientBg = ColorUtilsKt.getColorCompat(context, C3511R.color.card_gradient_bg_dark);
        this.cardGradientPressedBg = ColorUtilsKt.getColorCompat(context, C3511R.color.card_gradient_pressed_bg_dark);
        int i21 = C3511R.color.primary_560;
        this.cardPrimaryBg = ColorUtilsKt.getColorCompat(context, i21);
        int i22 = C3511R.color.primary_645;
        this.cardPrimaryPressedBg = ColorUtilsKt.getColorCompat(context, i22);
        this.cardSecondaryBg = ColorUtilsKt.getColorCompat(context, i21);
        this.cardSecondaryPressedBg = ColorUtilsKt.getColorCompat(context, i22);
        ...
        int i23 = C3511R.color.primary_360;
        this.channelsDefault = ColorUtilsKt.getColorCompat(context, i23);
        this.channeltextareaBackground = ColorUtilsKt.getColorCompat(context, i21);
        this.chatBackground = ColorUtilsKt.getColorCompat(context, i4);
        this.chatBorder = ColorUtilsKt.getColorCompat(context, i);
        this.chatInputContainerBackground = ColorUtilsKt.getColorCompat(context, i4);
        this.chatSwipeToReplyBackground = ColorUtilsKt.getColorCompat(context, i6);
        int i24 = C3511R.color.brand_360;
        this.controlBrandForeground = ColorUtilsKt.getColorCompat(context, i24);
        this.controlBrandForegroundNew = ColorUtilsKt.getColorCompat(context, i24);
        ...
        this.creatorRevenueInfoBoxBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.creator_revenue_info_box_background_dark);
        int i25 = C3511R.color.teal_400;
        this.creatorRevenueInfoBoxBorder = ColorUtilsKt.getColorCompat(context, i25);
        this.creatorRevenueLockedChannelIcon = ColorUtilsKt.getColorCompat(context, C3511R.color.teal_345);
        this.creatorRevenueProgressBar = ColorUtilsKt.getColorCompat(context, i25);
        this.deprecatedCardBg = ColorUtilsKt.getColorCompat(context, C3511R.color.deprecated_card_bg_dark);
        this.deprecatedCardEditableBg = ColorUtilsKt.getColorCompat(context, C3511R.color.deprecated_card_editable_bg_dark);
        this.deprecatedQuickswitcherInputBackground = ColorUtilsKt.getColorCompat(context, i20);
        this.deprecatedQuickswitcherInputPlaceholder = ColorUtilsKt.getColorCompat(context, C3511R.color.deprecated_quickswitcher_input_placeholder_dark);
        this.deprecatedStoreBg = ColorUtilsKt.getColorCompat(context, i4);
        this.deprecatedTextInputBg = ColorUtilsKt.getColorCompat(context, i);
        this.deprecatedTextInputBorder = ColorUtilsKt.getColorCompat(context, C3511R.color.deprecated_text_input_border_dark);
        ...
        this.displayBannerOverflowBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.display_banner_overflow_background_dark);
        this.dividerStrong = ColorUtilsKt.getColorCompat(context, C3511R.color.divider_strong_dark);
        this.dividerSubtle = ColorUtilsKt.getColorCompat(context, C3511R.color.divider_subtle_dark);
        int i26 = C3511R.color.blue_345;
        this.focusPrimary = ColorUtilsKt.getColorCompat(context, i26);
        this.forumPostExtraMediaCountContainerBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.forum_post_extra_media_count_container_background_dark);
        this.forumPostTagBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.forum_post_tag_background_dark);
        this.guildNotificationsBottomSheetPillBackground = ColorUtilsKt.getColorCompat(context, i);
        this.headerMuted = ColorUtilsKt.getColorCompat(context, i23);
        int i27 = C3511R.color.primary_130;
        this.headerPrimary = ColorUtilsKt.getColorCompat(context, i27);
        int i28 = C3511R.color.primary_330;
        this.headerSecondary = ColorUtilsKt.getColorCompat(context, i28);
        this.homeBackground = ColorUtilsKt.getColorCompat(context, i22);
        this.homeCardRestingBorder = ColorUtilsKt.getColorCompat(context, C3511R.color.home_card_resting_border_dark);
        this.iconMuted = ColorUtilsKt.getColorCompat(context, i20);
        this.iconPrimary = ColorUtilsKt.getColorCompat(context, i27);
        this.iconSecondary = ColorUtilsKt.getColorCompat(context, i28);
        this.infoBoxBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.info_box_background_dark);
        this.infoDangerBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.info_danger_background_dark);
        ...
        this.infoHelpBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.info_help_background_dark);
        this.infoHelpForeground = ColorUtilsKt.getColorCompat(context, i26);
        this.infoHelpText = ColorUtilsKt.getColorCompat(context, i12);
        this.infoPositiveBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.info_positive_background_dark);
        ...
        this.infoWarningBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.info_warning_background_dark);
        int i29 = C3511R.color.yellow_300;
        this.infoWarningForeground = ColorUtilsKt.getColorCompat(context, i29);
        this.infoWarningText = ColorUtilsKt.getColorCompat(context, i12);
        this.inputBackground = ColorUtilsKt.getColorCompat(context, i);
        this.inputPlaceholderText = ColorUtilsKt.getColorCompat(context, C3511R.color.input_placeholder_text_dark);
        this.interactiveActive = ColorUtilsKt.getColorCompat(context, i12);
        int i30 = C3511R.color.primary_230;
        ...
        this.interactiveNormal = ColorUtilsKt.getColorCompat(context, i28);
        this.legacyAndroidBlurOverlayDefault = ColorUtilsKt.getColorCompat(context, C3511R.color.legacy_android_blur_overlay_default_dark);
        this.legacyAndroidBlurOverlayUltraThin = ColorUtilsKt.getColorCompat(context, C3511R.color.legacy_android_blur_overlay_ultra_thin_dark);
        this.legacyBlurFallbackDefault = ColorUtilsKt.getColorCompat(context, C3511R.color.legacy_blur_fallback_default_dark);
        this.legacyBlurFallbackUltraThin = ColorUtilsKt.getColorCompat(context, C3511R.color.legacy_blur_fallback_ultra_thin_dark);
        this.liveStageTileBorder = ColorUtilsKt.getColorCompat(context, C3511R.color.live_stage_tile_border_dark);
        this.logoPrimary = ColorUtilsKt.getColorCompat(context, i12);
        this.mentionBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.mention_background_dark);
        this.mentionForeground = ColorUtilsKt.getColorCompat(context, C3511R.color.brand_260);
        this.modalBackground = ColorUtilsKt.getColorCompat(context, i4);
        this.modalFooterBackground = ColorUtilsKt.getColorCompat(context, i5);
        this.navigatorHeaderTint = ColorUtilsKt.getColorCompat(context, i12);
        this.profileGradientCardBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.profile_gradient_card_background_dark);
        this.profileGradientMessageInputBorder = ColorUtilsKt.getColorCompat(context, C3511R.color.profile_gradient_message_input_border_dark);
        this.profileGradientNoteBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.profile_gradient_note_background_dark);
        this.profileGradientOverlay = ColorUtilsKt.getColorCompat(context, C3511R.color.profile_gradient_overlay_dark);
        this.profileGradientOverlaySyncedWithUserTheme = ColorUtilsKt.getColorCompat(context, C3511R.color.profile_gradient_overlay_synced_with_user_theme_dark);
        this.profileGradientProfileBodyBackgroundHover = ColorUtilsKt.getColorCompat(context, C3511R.color.profile_gradient_profile_body_background_hover_dark);
        this.profileGradientRolePillBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.profile_gradient_role_pill_background_dark);
        this.profileGradientRolePillBorder = ColorUtilsKt.getColorCompat(context, C3511R.color.profile_gradient_role_pill_border_dark);
        this.profileGradientSectionBox = ColorUtilsKt.getColorCompat(context, C3511R.color.profile_gradient_section_box_dark);
        this.redesignActivityCardBackground = ColorUtilsKt.getColorCompat(context, i21);
        this.redesignActivityCardBackgroundPressed = ColorUtilsKt.getColorCompat(context, i5);
        this.redesignActivityCardBadgeIcon = ColorUtilsKt.getColorCompat(context, i23);
        this.redesignActivityCardBorder = ColorUtilsKt.getColorCompat(context, C3511R.color.redesign_activity_card_border_dark);
        this.redesignActivityCardOverflowBackground = ColorUtilsKt.getColorCompat(context, i5);
        ...
        this.redesignButtonOverlayAlphaBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.redesign_button_overlay_alpha_background_dark);
        this.redesignButtonOverlayAlphaPressedBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.redesign_button_overlay_alpha_pressed_background_dark);
        ...
        this.redesignButtonOverlayText = ColorUtilsKt.getColorCompat(context, C3511R.color.primary_860);
        ...
        this.redesignButtonPrimaryAltBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.redesign_button_primary_alt_background_dark);
        this.redesignButtonPrimaryAltBorder = ColorUtilsKt.getColorCompat(context, i24);
        this.redesignButtonPrimaryAltOnBlurpleBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.redesign_button_primary_alt_on_blurple_background_dark);
        this.redesignButtonPrimaryAltOnBlurpleBorder = ColorUtilsKt.getColorCompat(context, i12);
        int i31 = C3511R.color.brand_530;
        this.redesignButtonPrimaryAltOnBlurplePressedBackground = ColorUtilsKt.getColorCompat(context, i31);
        this.redesignButtonPrimaryAltOnBlurplePressedBorder = ColorUtilsKt.getColorCompat(context, i24);
        this.redesignButtonPrimaryAltOnBlurpleText = ColorUtilsKt.getColorCompat(context, i12);
        this.redesignButtonPrimaryAltPressedBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.redesign_button_primary_alt_pressed_background_dark);
        this.redesignButtonPrimaryAltPressedBorder = ColorUtilsKt.getColorCompat(context, C3511R.color.redesign_button_primary_alt_pressed_border_dark);
        this.redesignButtonPrimaryAltPressedText = ColorUtilsKt.getColorCompat(context, i24);
        this.redesignButtonPrimaryAltText = ColorUtilsKt.getColorCompat(context, i24);
        ...
        this.redesignButtonPrimaryOnBlurplePressedText = ColorUtilsKt.getColorCompat(context, i31);
        ...
        this.redesignButtonSecondaryAltBackground = ColorUtilsKt.getColorCompat(context, i6);
        this.redesignButtonSecondaryAltPressedBackground = ColorUtilsKt.getColorCompat(context, i21);
        this.redesignButtonSecondaryAltPressedText = ColorUtilsKt.getColorCompat(context, i28);
        this.redesignButtonSecondaryAltText = ColorUtilsKt.getColorCompat(context, i30);
        this.redesignButtonSecondaryBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.primary_460);
        this.redesignButtonSecondaryBorder = ColorUtilsKt.getColorCompat(context, C3511R.color.redesign_button_secondary_border_dark);
        this.redesignButtonSecondaryPressedBackground = ColorUtilsKt.getColorCompat(context, i19);
        this.redesignButtonSecondaryPressedBorder = ColorUtilsKt.getColorCompat(context, C3511R.color.redesign_button_secondary_pressed_border_dark);
        this.redesignButtonSecondaryText = ColorUtilsKt.getColorCompat(context, i30);
        this.redesignChannelCategoryNameText = ColorUtilsKt.getColorCompat(context, i28);
        this.redesignChannelMessagePreviewText = ColorUtilsKt.getColorCompat(context, i23);
        this.redesignChannelNameMutedText = ColorUtilsKt.getColorCompat(context, i23);
        this.redesignChannelNameText = ColorUtilsKt.getColorCompat(context, i27);
        this.redesignChatInputBackground = ColorUtilsKt.getColorCompat(context, i);
        this.redesignInputControlActiveBg = ColorUtilsKt.getColorCompat(context, i22);
        this.redesignInputControlSelected = ColorUtilsKt.getColorCompat(context, i11);
        this.redesignOnlyBackgroundActive = ColorUtilsKt.getColorCompat(context, i2);
        this.redesignOnlyBackgroundDefault = ColorUtilsKt.getColorCompat(context, i4);
        this.redesignOnlyBackgroundOverlay = ColorUtilsKt.getColorCompat(context, i22);
        this.redesignOnlyBackgroundRaised = ColorUtilsKt.getColorCompat(context, i5);
        this.redesignOnlyBackgroundSunken = ColorUtilsKt.getColorCompat(context, i6);
        int i32 = C3511R.color.primary_730;
        this.scrollbarAutoScrollbarColorThumb = ColorUtilsKt.getColorCompat(context, i32);
        this.scrollbarAutoScrollbarColorTrack = ColorUtilsKt.getColorCompat(context, i5);
        ...
        this.scrollbarThinTrack = ColorUtilsKt.getColorCompat(context, C3511R.color.scrollbar_thin_track_dark);
        this.spoilerHiddenBackground = ColorUtilsKt.getColorCompat(context, i);
        this.spoilerRevealedBackground = ColorUtilsKt.getColorCompat(context, i6);
        ...
        this.statusIdle = ColorUtilsKt.getColorCompat(context, i29);
        this.statusOffline = ColorUtilsKt.getColorCompat(context, i23);
        ...
        this.statusWarning = ColorUtilsKt.getColorCompat(context, i29);
        this.statusWarningBackground = ColorUtilsKt.getColorCompat(context, i29);
        this.statusWarningText = ColorUtilsKt.getColorCompat(context, i7);
        this.textBrand = ColorUtilsKt.getColorCompat(context, i24);
        this.textDanger = ColorUtilsKt.getColorCompat(context, C3511R.color.red_345);
        this.textLink = ColorUtilsKt.getColorCompat(context, i26);
        this.textLinkLowSaturation = ColorUtilsKt.getColorCompat(context, C3511R.color.blue_330);
        this.textLowContrast = ColorUtilsKt.getColorCompat(context, i23);
        this.textMessagePreviewLowSat = ColorUtilsKt.getColorCompat(context, i23);
        this.textMuted = ColorUtilsKt.getColorCompat(context, i23);
        this.textMutedOnDefault = ColorUtilsKt.getColorCompat(context, i28);
        this.textNormal = ColorUtilsKt.getColorCompat(context, i30);
        this.textPositive = ColorUtilsKt.getColorCompat(context, C3511R.color.green_330);
        this.textPrimary = ColorUtilsKt.getColorCompat(context, i30);
        this.textSecondary = ColorUtilsKt.getColorCompat(context, i28);
        this.textWarning = ColorUtilsKt.getColorCompat(context, i29);
        this.textboxMarkdownSyntax = ColorUtilsKt.getColorCompat(context, i23);
        this.themeLockedBlurFallback = ColorUtilsKt.getColorCompat(context, C3511R.color.theme_locked_blur_fallback_dark);
        this.userProfileHeaderOverflowBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.user_profile_header_overflow_background_dark);
        this.voiceVideoTileBlurFallback = ColorUtilsKt.getColorCompat(context, C3511R.color.voice_video_tile_blur_fallback_dark);
        this.voiceVideoVideoTileBlurFallback = ColorUtilsKt.getColorCompat(context, C3511R.color.voice_video_video_tile_blur_fallback_dark);
