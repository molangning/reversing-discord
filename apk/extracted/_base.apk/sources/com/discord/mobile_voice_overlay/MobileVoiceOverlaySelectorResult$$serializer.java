...
public final class MobileVoiceOverlaySelectorResult$$serializer implements InterfaceC2582f0<MobileVoiceOverlaySelectorResult> {
    ...
    static {
        ...
        pluginGeneratedSerialDescriptor.m12856l("categoryName", false);
    ...
    public KSerializer<?>[] childSerializers() {
        ...
        return new KSerializer[]{GuildId$$serializer.INSTANCE, ChannelId$$serializer.INSTANCE, c2560a2, c2560a2, c2560a2};
    }
    ...
    public MobileVoiceOverlaySelectorResult deserialize(Decoder decoder) {
        ...
        if (mo12920b.mo12865p()) {
            obj = mo12920b.mo12862y(descriptor2, 0, GuildId$$serializer.INSTANCE, null);
            obj2 = mo12920b.mo12862y(descriptor2, 1, ChannelId$$serializer.INSTANCE, null);
            ...
            while (z) {
                ...
                if (mo12866o == -1) {
                    ...
                    obj3 = mo12920b.mo12862y(descriptor2, 0, GuildId$$serializer.INSTANCE, obj3);
                    i2 |= 1;
                } else if (mo12866o == 1) {
                    obj4 = mo12920b.mo12862y(descriptor2, 1, ChannelId$$serializer.INSTANCE, obj4);
                    i2 |= 2;
                } else if (mo12866o == 2) {
        ...
        return new MobileVoiceOverlaySelectorResult(i, (GuildId) obj, (ChannelId) obj2, str, str2, str3, null, null);
    }
    ...
    public void serialize(Encoder encoder, MobileVoiceOverlaySelectorResult value) {
        ...
        MobileVoiceOverlaySelectorResult.write$Self(value, mo12900b, descriptor2);
