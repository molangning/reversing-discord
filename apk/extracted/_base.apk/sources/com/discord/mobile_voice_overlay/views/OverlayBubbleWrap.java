...
public abstract class OverlayBubbleWrap extends OverlayView {
    ...
    public OverlayBubbleWrap(Context context) {
        ...
        this.isMoving$delegate = new AbstractC9624c<Boolean>(bool) { // from class: com.discord.mobile_voice_overlay.views.OverlayBubbleWrap$special$$inlined$observable$1
    ...
    public OverlayBubbleWrap(Context context, AttributeSet attributeSet) {
        ...
        C9622a c9622a = C9622a.f25358a;
        final Boolean bool = Boolean.FALSE;
        this.isMoving$delegate = new AbstractC9624c<Boolean>(bool) { // from class: com.discord.mobile_voice_overlay.views.OverlayBubbleWrap$special$$inlined$observable$2
            @Override // kotlin.properties.AbstractC9624c
            protected void afterChange(KProperty<?> property, Boolean bool2, Boolean bool3) {
                C9612q.m13917h(property, "property");
                boolean booleanValue = bool3.booleanValue();
    ...
    public OverlayBubbleWrap(Context context, AttributeSet attributeSet, int i) {
        ...
        C9622a c9622a = C9622a.f25358a;
        final Boolean bool = Boolean.FALSE;
        this.isMoving$delegate = new AbstractC9624c<Boolean>(bool) { // from class: com.discord.mobile_voice_overlay.views.OverlayBubbleWrap$special$$inlined$observable$3
            @Override // kotlin.properties.AbstractC9624c
            protected void afterChange(KProperty<?> property, Boolean bool2, Boolean bool3) {
                C9612q.m13917h(property, "property");
                boolean booleanValue = bool3.booleanValue();
