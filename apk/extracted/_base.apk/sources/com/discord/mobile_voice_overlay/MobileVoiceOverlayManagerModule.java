...
public final class MobileVoiceOverlayManagerModule extends NativeMobileVoiceOverlaySpec {
    ...
    @Metadata(m14358d1 = {"\u0000$\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u000e\u0010\u0007\u001a\u00020\b2\u0006\u0010\t\u001a\u00020\nR\u000e\u0010\u0003\u001a\u00020\u0004X\u0086T¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0006X\u0086T¢\u0006\u0002\n\u0000¨\u0006\u000b"}, m14357d2 = {"Lcom/discord/mobile_voice_overlay/MobileVoiceOverlayManagerModule$Companion;", "", "()V", "NAME", "", "OVERLAY_REQUEST_CODE", "", "create", "Lcom/facebook/react/bridge/NativeModule;", "reactContext", "Lcom/facebook/react/bridge/ReactApplicationContext;", "mobile_voice_overlay_release"}, m14356k = 1, m14355mv = {1, 8, 0}, m14353xi = 48)
    /* loaded from: /home/user/temp/discord/apk/extracted/_base.apk/classes6.dex */
    ...
    public MobileVoiceOverlayManagerModule(ReactApplicationContext reactContext) {
        ...
        Lazy m7601a;
        C9612q.m13917h(reactContext, "reactContext");
        m7601a = C11577n.m7601a(new MobileVoiceOverlayManagerModule$mobileVoiceOverlay$2(this));
        this.mobileVoiceOverlay$delegate = m7601a;
    }
    ...
    @Override // com.discord.codegen.NativeMobileVoiceOverlaySpec, com.facebook.react.bridge.NativeModule
    ...
    public void setData(ReadableMap readableMap) {
        if (readableMap != null) {
            ...
            json.mo265a();
            final MobileVoiceOverlayData mobileVoiceOverlayData = (MobileVoiceOverlayData) json.mo232b(MobileVoiceOverlayData.Companion.serializer(), jsonString);
    ...
    public void showOverlay(ReadableMap readableMap) {
        if (readableMap != null) {
            ...
            String jsonString = NativeMapExtensionsKt.toJsonString(readableMap);
            json.mo265a();
            final MobileVoiceOverlayAssets mobileVoiceOverlayAssets = (MobileVoiceOverlayAssets) json.mo232b(MobileVoiceOverlayAssets.Companion.serializer(), jsonString);
