...
public class C3614f extends Drawable implements Drawable.Callback, TransformCallback, InterfaceC3625o, InterfaceC3610c {
    private static final Matrix sTempTransform = new Matrix();
    private Drawable mCurrentDelegate;
    private final DrawableProperties mDrawableProperties = new DrawableProperties();
    protected TransformCallback mTransformCallback;

    public C3614f(Drawable drawable) {
    ...
    public void setAlpha(int i) {
        this.mDrawableProperties.m31543b(i);
        Drawable drawable = this.mCurrentDelegate;
        if (drawable != null) {
            drawable.setAlpha(i);
        }
    ...
    public void setColorFilter(ColorFilter colorFilter) {
        this.mDrawableProperties.m31542c(colorFilter);
        Drawable drawable = this.mCurrentDelegate;
        if (drawable != null) {
    ...
    protected Drawable setCurrentWithoutInvalidate(Drawable drawable) {
        ...
        C3611d.m31524d(drawable2, null, null);
        C3611d.m31524d(drawable, null, null);
        C3611d.m31523e(drawable, this.mDrawableProperties);
    ...
    public void setDither(boolean z) {
        this.mDrawableProperties.m31541d(z);
        Drawable drawable = this.mCurrentDelegate;
        if (drawable != null) {
    ...
    public void setFilterBitmap(boolean z) {
        this.mDrawableProperties.m31540e(z);
        Drawable drawable = this.mCurrentDelegate;
        if (drawable != null) {
