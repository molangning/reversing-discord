...
public class NativeViewHierarchyManager {
    ...
    private static String constructManageChildrenErrorMessage(ViewGroup viewGroup, ViewGroupManager viewGroupManager, int[] iArr, ViewAtIndex[] viewAtIndexArr, int[] iArr2) {
        ...
        if (viewGroup != null) {
            ...
            for (int i5 = 0; viewGroupManager.getChildAt((ViewGroupManager) viewGroup, i5) != null; i5 += 16) {
                int i6 = 0;
                while (true) {
                    if (viewGroupManager.getChildAt((ViewGroupManager) viewGroup, i5 + i6) != null && i6 < 16) {
                        sb2.append(viewGroupManager.getChildAt((ViewGroupManager) viewGroup, i4).getId() + ",");
                        i6++;
                    }
                }
    ...
    protected final synchronized void addRootViewGroup(int i, View view) {
        if (view.getId() != -1) {
            String str = TAG;
            C13677a.m1854j(str, "Trying to add a root view with an explicit id (" + view.getId() + ") already set. React Native uses the id field to track react tags and will overwrite this field. If that is fine, explicitly overwrite the id field to View.NO_ID before calling addRootView.");
        }
    ...
    public synchronized void createView(ThemedReactContext themedReactContext, int i, String str, ReactStylesDiffMap reactStylesDiffMap) {
        ...
        C7384b.m20802a(0L, "NativeViewHierarchyManager_createView").mo20800a("tag", i).mo20799b("className", str).mo20798c();
    ...
    public synchronized void dropView(View view) {
        ...
        if ((view instanceof ViewGroup) && (viewManager instanceof ViewGroupManager)) {
            ...
            for (int childCount = viewGroupManager.getChildCount((ViewGroupManager) viewGroup) - 1; childCount >= 0; childCount--) {
                ...
                if (childAt == null) {
                    C13677a.m1854j(TAG, "Unable to drop null child view");
    ...
    public long getInstanceHandle(int i) {
        View view = this.mTagsToViews.get(i);
        if (view != null) {
            Long l = (Long) view.getTag(C3893R.C3895id.view_tag_instance_handle);
            if (l != null) {
                return l.longValue();
            }
    ...
    public synchronized void updateInstanceHandle(int i, long j) {
        ...
        try {
            ...
            String str = TAG;
            C13677a.m1853k(str, "Unable to update properties for view tag " + i, e);
        }
    }

    public synchronized void updateLayout(int i, int i2, int i3, int i4, int i5, int i6) {
        UiThreadUtil.assertOnUiThread();
        C7384b.m20802a(0L, "NativeViewHierarchyManager_updateLayout").mo20800a("parentTag", i).mo20800a("tag", i2).mo20798c();
    ...
    private void updateInstanceHandle(View view, long j) {
        UiThreadUtil.assertOnUiThread();
        view.setTag(C3893R.C3895id.view_tag_instance_handle, Long.valueOf(j));
    }
