...
public class OnLayoutEvent extends Event<OnLayoutEvent> {
    ...
    /* renamed from: mX */
    private int f10914mX;

    /* renamed from: mY */
    private int f10915mY;
    ...
    protected WritableMap getEventData() {
        ...
        createMap.putDouble("x", PixelUtil.toDIPFromPixel(this.f10914mX));
        createMap.putDouble("y", PixelUtil.toDIPFromPixel(this.f10915mY));
