...
abstract class BaseLayoutAnimation extends AbstractLayoutAnimation {
    ...
    /* loaded from: /home/user/temp/discord/apk/extracted/_base.apk/classes3.dex */
    static /* synthetic */ class C42291 {

        /* renamed from: $SwitchMap$com$facebook$react$uimanager$layoutanimation$AnimatedPropertyType */
        static final /* synthetic */ int[] f10923x36728427;

        static {
            int[] iArr = new int[AnimatedPropertyType.values().length];
            f10923x36728427 = iArr;
            try {
                iArr[AnimatedPropertyType.OPACITY.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                f10923x36728427[AnimatedPropertyType.SCALE_XY.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f10923x36728427[AnimatedPropertyType.SCALE_X.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f10923x36728427[AnimatedPropertyType.SCALE_Y.ordinal()] = 4;
    ...
    Animation createAnimationImpl(View view, int i, int i2, int i3, int i4) {
        ...
        if (animatedPropertyType != null) {
            int i5 = C42291.f10923x36728427[animatedPropertyType.ordinal()];
            float f8 = 0.0f;
            if (i5 != 1) {
                if (i5 != 2) {
                    if (i5 != 3) {
