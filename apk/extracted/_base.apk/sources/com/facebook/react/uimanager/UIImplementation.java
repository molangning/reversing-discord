...
public class UIImplementation {
    ...
    private void assertNodeDoesNotNeedCustomLayoutForChildren(ReactShadowNode reactShadowNode) {
        ViewManager viewManager = (ViewManager) C5743a.m24583c(this.mViewManagers.get(reactShadowNode.getViewClass()));
    ...
    private boolean checkOrAssertViewExists(int i, String str) {
        ...
        C13677a.m1870H(ReactConstants.TAG, "Unable to execute operation " + str + " on view with tag: " + i + ", since the view does not exist");
        return false;
    }
    ...
    protected void calculateRootLayout(ReactShadowNode reactShadowNode) {
        float size;
        C7384b.m20802a(0L, "cssRoot.calculateLayout").mo20800a("rootTag", reactShadowNode.getReactTag()).mo20798c();
    ...
    public void createView(int i, String str, int i2, ReadableMap readableMap) {
        ...
        synchronized (this.uiImplementationThreadLock) {
            ...
            C5743a.m24582d(node, "Root node with tag " + i2 + " doesn't exist");
    ...
    public void dispatchViewUpdates(int i) {
        ...
        C7384b.m20802a(0L, "UIImplementation.dispatchViewUpdates").mo20800a("batchId", i).mo20798c();
        long uptimeMillis = SystemClock.uptimeMillis();
        try {
            updateViewHierarchy();
    ...
    */
    ...
    public int resolveRootTagFromReactTag(int i) {
        ...
        C13677a.m1870H(ReactConstants.TAG, "Warning : attempted to resolve a non-existent react shadow node. reactTag=" + i);
        return 0;
    }
    ...
    public void setViewLocalData(int i, Object obj) {
        ReactShadowNode node = this.mShadowNodeRegistry.getNode(i);
        if (node == null) {
            C13677a.m1870H(ReactConstants.TAG, "Attempt to set local data for view with unknown tag: " + i);
            return;
        }
    ...
    public void updateNodeSize(int i, int i2, int i3) {
        ReactShadowNode node = this.mShadowNodeRegistry.getNode(i);
        if (node == null) {
            C13677a.m1870H(ReactConstants.TAG, "Tried to update size of non-existent tag: " + i);
            return;
        }
    ...
    public void updateRootView(int i, int i2, int i3) {
        ReactShadowNode node = this.mShadowNodeRegistry.getNode(i);
        if (node == null) {
            C13677a.m1870H(ReactConstants.TAG, "Tried to update non-existent root tag: " + i);
            return;
        }
    ...
    protected void updateViewHierarchy() {
        C7382a.m20813c(0L, "UIImplementation.updateViewHierarchy");
        for (int i = 0; i < this.mShadowNodeRegistry.getRootNodeCount(); i++) {
            try {
                ...
                if (node.getWidthMeasureSpec() != null && node.getHeightMeasureSpec() != null) {
                    C7384b.m20802a(0L, "UIImplementation.notifyOnBeforeLayoutRecursive").mo20800a("rootTag", node.getReactTag()).mo20798c();
                    notifyOnBeforeLayoutRecursive(node);
                    C7382a.m20809g(0L);
                    calculateRootLayout(node);
                    C7384b.m20802a(0L, "UIImplementation.applyUpdatesRecursive").mo20800a("rootTag", node.getReactTag()).mo20798c();
