...
public class ViewProps {
    ...
    /* renamed from: ON */
    public static final String f10920ON = "on";
    ...
    public static boolean isLayoutOnly(ReadableMap readableMap, String str) {
        ...
        switch (c) {
            ...
            case '\b':
                ...
                return false;
            case '\t':
                if (readableMap.getType(BORDER_BLOCK_START_COLOR) == ReadableType.Number && readableMap.getInt(BORDER_BLOCK_START_COLOR) == 0) {
                    return true;
                }
                return false;
            case '\n':
                ...
                return false;
            case 11:
                if (readableMap.getType(BORDER_BLOCK_COLOR) == ReadableType.Number && readableMap.getInt(BORDER_BLOCK_COLOR) == 0) {
                    return true;
                }
                return false;
            case '\f':
                ...
                return false;
            case '\r':
                if (readableMap.getType(BORDER_BLOCK_END_COLOR) == ReadableType.Number && readableMap.getInt(BORDER_BLOCK_END_COLOR) == 0) {
                    return true;
                }
                return false;
            case 14:
