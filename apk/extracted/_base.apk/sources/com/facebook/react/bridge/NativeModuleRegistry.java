...
public class NativeModuleRegistry {
    ...
    public <T extends NativeModule> T getModule(Class<T> cls) {
        ...
        if (reactModule != null) {
            return (T) ((ModuleHolder) C5743a.m24582d(this.mModules.get(reactModule.name()), reactModule.name() + " could not be found. Is it defined in " + cls.getName())).getModule();
        }
    ...
    public void notifyJSInstanceDestroy() {
        ...
        C7382a.m20813c(0L, "NativeModuleRegistry_notifyJSInstanceDestroy");
        try {
            for (ModuleHolder moduleHolder : this.mModules.values()) {
    ...
    public void notifyJSInstanceInitialized() {
        ...
        C7382a.m20813c(0L, "NativeModuleRegistry_notifyJSInstanceInitialized");
        try {
            for (ModuleHolder moduleHolder : this.mModules.values()) {
    ...
    public void registerModules(NativeModuleRegistry nativeModuleRegistry) {
        C5743a.m24584b(this.mReactApplicationContext.equals(nativeModuleRegistry.getReactApplicationContext()), "Extending native modules with non-matching application contexts.");
    ...
    public NativeModule getModule(String str) {
        return ((ModuleHolder) C5743a.m24582d(this.mModules.get(str), "Could not find module with name " + str)).getModule();
    }
}
