...
public class JavaOnlyArray implements ReadableArray, WritableArray {
    ...
    /* loaded from: /home/user/temp/discord/apk/extracted/_base.apk/classes3.dex */
    public static /* synthetic */ class C39831 {
    ...
    public static JavaOnlyArray deepClone(ReadableArray readableArray) {
        ...
        for (int i = 0; i < size; i++) {
            switch (C39831.$SwitchMap$com$facebook$react$bridge$ReadableType[readableArray.getType(i).ordinal()]) {
                case 1:
    ...
    /* renamed from: of */
    public static JavaOnlyArray m30478of(Object... objArr) {
