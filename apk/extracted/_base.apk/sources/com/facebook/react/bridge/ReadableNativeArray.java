...
public class ReadableNativeArray extends NativeArray implements ReadableArray {
    ...
    /* loaded from: /home/user/temp/discord/apk/extracted/_base.apk/classes3.dex */
    public static /* synthetic */ class C39891 {
    ...
    private Object[] getLocalArray() {
        ...
        synchronized (this) {
            if (this.mLocalArray == null) {
                jniPassCounter++;
                this.mLocalArray = (Object[]) C5743a.m24583c(importArray());
            }
        }
    ...
    private ReadableType[] getLocalTypeArray() {
        ...
        synchronized (this) {
            if (this.mLocalTypeArray == null) {
                jniPassCounter++;
                Object[] objArr = (Object[]) C5743a.m24583c(importTypeArray());
    ...
    public ArrayList<Object> toArrayList() {
        ...
        for (int i = 0; i < size(); i++) {
            switch (C39891.$SwitchMap$com$facebook$react$bridge$ReadableType[getType(i).ordinal()]) {
                case 1:
                    arrayList.add(null);
                    break;
                case 2:
