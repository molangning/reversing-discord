...
public class JsonWriterHelper {
    ...
    /* loaded from: /home/user/temp/discord/apk/extracted/_base.apk/classes3.dex */
    public static /* synthetic */ class C39861 {
    ...
    private static void dynamicValue(JsonWriter jsonWriter, Dynamic dynamic) {
        switch (C39861.$SwitchMap$com$facebook$react$bridge$ReadableType[dynamic.getType().ordinal()]) {
            case 1:
    ...
    public static void readableArrayValue(JsonWriter jsonWriter, ReadableArray readableArray) {
        ...
        for (int i = 0; i < readableArray.size(); i++) {
            try {
                switch (C39861.$SwitchMap$com$facebook$react$bridge$ReadableType[readableArray.getType(i).ordinal()]) {
                    case 1:
                        jsonWriter.nullValue();
                        break;
                    case 2:
    ...
    private static void readableMapValue(JsonWriter jsonWriter, ReadableMap readableMap) {
        ...
        try {
            ...
            while (keySetIterator.hasNextKey()) {
                ...
                switch (C39861.$SwitchMap$com$facebook$react$bridge$ReadableType[readableMap.getType(nextKey).ordinal()]) {
                    case 1:
                        jsonWriter.nullValue();
                        break;
                    case 2:
