...
public class Arguments {
    ...
    /* loaded from: /home/user/temp/discord/apk/extracted/_base.apk/classes3.dex */
    public static /* synthetic */ class C39582 {
    ...
    public static Bundle toBundle(ReadableMap readableMap) {
        ...
        while (keySetIterator.hasNextKey()) {
            ...
            switch (C39582.$SwitchMap$com$facebook$react$bridge$ReadableType[readableMap.getType(nextKey).ordinal()]) {
                case 1:
    ...
    public static ArrayList toList(ReadableArray readableArray) {
        ...
        for (int i = 0; i < readableArray.size(); i++) {
            switch (C39582.$SwitchMap$com$facebook$react$bridge$ReadableType[readableArray.getType(i).ordinal()]) {
                case 1:
                    arrayList.add(null);
                    break;
                case 2:
