...
public class StatusBarModule extends NativeStatusBarManagerAndroidSpec {
    ...
    public Map<String, Object> getTypedExportedConstants() {
        ...
        return MapBuilder.m30469of(HEIGHT_KEY, Float.valueOf(f), DEFAULT_BACKGROUND_COLOR_KEY, str);
    }
    ...
    public void setColor(double d, final boolean z) {
        ...
        if (currentActivity == null) {
            C13677a.m1870H(ReactConstants.TAG, "StatusBarModule: Ignored status bar change, current activity is null.");
        } else {
