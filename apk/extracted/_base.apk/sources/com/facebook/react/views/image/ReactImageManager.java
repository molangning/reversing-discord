...
public class ReactImageManager extends SimpleViewManager<ReactImageView> {
    ...
    public AbstractDraweeControllerBuilder getDraweeControllerBuilder() {
        if (this.mDraweeControllerBuilder == null) {
            this.mDraweeControllerBuilder = C10035c.m12506g();
        }
    ...
    public Map getExportedCustomDirectEventTypeConstants() {
        ...
        exportedCustomDirectEventTypeConstants.putAll(MapBuilder.m30466of(ImageLoadEvent.eventNameForType(4), MapBuilder.m30470of("registrationName", "onLoadStart"), ImageLoadEvent.eventNameForType(5), MapBuilder.m30470of("registrationName", "onProgress"), ImageLoadEvent.eventNameForType(2), MapBuilder.m30470of("registrationName", "onLoad"), ImageLoadEvent.eventNameForType(1), MapBuilder.m30470of("registrationName", "onError"), ImageLoadEvent.eventNameForType(3), MapBuilder.m30470of("registrationName", "onLoadEnd")));
    ...
    public void setResizeMethod(ReactImageView reactImageView, String str) {
        if (str != null && !"auto".equals(str)) {
            if ("resize".equals(str)) {
                ...
                C13677a.m1870H(ReactConstants.TAG, "Invalid resize method: '" + str + "'");
                return;
            }
        }
        reactImageView.setResizeMethod(ImageResizeMethod.AUTO);
