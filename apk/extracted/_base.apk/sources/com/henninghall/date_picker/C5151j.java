...
public class C5151j {
    ...
    /* loaded from: /home/user/temp/discord/apk/extracted/_base.apk/classes3.dex */
    class C5152a extends HashMap<String, AbstractC6402k> {
        C5152a() {
            put("date", C5151j.this.f14495b);
            put("mode", C5151j.this.f14496c);
            put("locale", C5151j.this.f14497d);
            put("fadeToColor", C5151j.this.f14498e);
            put("textColor", C5151j.this.f14499f);
            put("minuteInterval", C5151j.this.f14500g);
            put("minimumDate", C5151j.this.f14501h);
            put("maximumDate", C5151j.this.f14502i);
            put("timezoneOffsetInMinutes", C5151j.this.f14503j);
            put("height", C5151j.this.f14504k);
            put("androidVariant", C5151j.this.f14505l);
            put("dividerHeight", C5151j.this.f14506m);
            put("is24hourSource", C5151j.this.f14507n);
        }
    }
