    ...
    public final boolean handleMessage(Message message) {
        ...
        switch (i) {
            case 1:
                ...
                for (C0093b<?> c0093b5 : this.f12685u.keySet()) {
                    Handler handler = this.f12689y;
                    handler.sendMessageDelayed(handler.obtainMessage(12, c0093b5), this.f12676l);
                }
                break;
            case 2:
            ...
            case 5:
                ...
                if (c4649t != null) {
                    if (c13930a.m1144r() == 13) {
                        ...
                        sb2.append(": ");
                        sb2.append(m1143z);
                        C4649t.m28072y(c4649t, new Status(17, sb2.toString()));
                        break;
                    } else {
                        C4649t.m28072y(c4649t, m28202i(C4649t.m28074w(c4649t), c13930a));
                        break;
                    }
                } else {
            ...
            case 9:
                ...
                break;
            case 10:
                for (C0093b<?> c0093b6 : this.f12688x) {
                    C4649t<?> remove = this.f12685u.remove(c0093b6);
                    if (remove != null) {
                        remove.m28101L();
                    }
                }
            ...
            case 14:
                ...
                if (!this.f12685u.containsKey(m28128a)) {
                    ...
                    c4640n.m28127b().m28011c(Boolean.valueOf(C4649t.m28099N(this.f12685u.get(m28128a), false)));
                    break;
                }
            case 15:
                C4650u c4650u = (C4650u) message.obj;
                Map<C0093b<?>, C4649t<?>> map = this.f12685u;
                c0093b = c4650u.f12767a;
                if (map.containsKey(c0093b)) {
                    Map<C0093b<?>, C4649t<?>> map2 = this.f12685u;
                    c0093b2 = c4650u.f12767a;
                    C4649t.m28111B(map2.get(c0093b2), c4650u);
                    break;
                }
                break;
            case 16:
                ...
                c0093b3 = c4650u2.f12767a;
                if (map3.containsKey(c0093b3)) {
                    Map<C0093b<?>, C4649t<?>> map4 = this.f12685u;
                    c0093b4 = c4650u2.f12767a;
                    C4649t.m28110C(map4.get(c0093b4), c4650u2);
                    break;
                }
                break;
            case 17:
