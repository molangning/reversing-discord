...
public final class C0237d {
    ...
    /* renamed from: b */
    private final AudioAttributesCompat f740b;
    ...
    public C0237d(int i, AudioAttributesCompat audioAttributesCompat, int i2, int i3, int i4) {
        this.f739a = i;
        this.f740b = audioAttributesCompat;
        this.f741c = i2;
        this.f742d = i3;
        this.f743e = i4;
    }
