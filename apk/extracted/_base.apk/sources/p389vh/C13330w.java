...
public final class C13330w extends AbstractC13295a0<Byte> {
    public C13330w(byte b) {
    ...
    public AbstractC7264g0 mo2775a(InterfaceC11928h0 module) {
        ...
        InterfaceC11914e m6652a = C11994x.m6652a(module, C10884k.C10885a.f28519y0);
        if (m6652a != null) {
        ...
        if (abstractC7302o0 == null) {
            return C8967k.m16945d(EnumC8966j.NOT_FOUND_UNSIGNED_TYPE, "UByte");
        }
    ...
    public String toString() {
        return mo2813b().intValue() + ".toUByte()";
    }
}
