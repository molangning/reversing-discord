...
public final class StreamParameters {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StreamParameters) {
            ...
            return this.type == streamParameters.type && C9612q.m13922c(this.rid, streamParameters.rid) && this.ssrc == streamParameters.ssrc && this.rtxSsrc == streamParameters.rtxSsrc && this.active == streamParameters.active && this.maxBitrate == streamParameters.maxBitrate && this.quality == streamParameters.quality && this.maxPixelCount == streamParameters.maxPixelCount;
        }
        return false;
    }
    ...
    public String toString() {
        ...
        int i4 = this.quality;
        int i5 = this.maxPixelCount;
        return "StreamParameters(type=" + mediaType + ", rid=" + str + ", ssrc=" + i + ", rtxSsrc=" + i2 + ", active=" + z + ", maxBitrate=" + i3 + ", quality=" + i4 + ", maxPixelCount=" + i5 + ")";
    }
}
