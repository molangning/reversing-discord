...
final class Duration {
    ...
    public String toString() {
        int i = this.listening;
        int i2 = this.speaking;
        int i3 = this.participation;
        int i4 = this.connected;
        return "Duration(listening=" + i + ", speaking=" + i2 + ", participation=" + i3 + ", connected=" + i4 + ")";
    }
}
