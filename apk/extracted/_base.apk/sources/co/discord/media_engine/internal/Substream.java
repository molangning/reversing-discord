...
public final class Substream {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof Substream) {
            ...
            return this.avgDelay == substream.avgDelay && C9612q.m13922c(this.frameCounts, substream.frameCounts) && this.height == substream.height && this.isFlexFEC == substream.isFlexFEC && this.isRTX == substream.isRTX && this.maxDelay == substream.maxDelay && this.retransmitBitrate == substream.retransmitBitrate && C9612q.m13922c(this.rtcpStats, substream.rtcpStats) && C9612q.m13922c(this.rtpStats, substream.rtpStats) && this.ssrc == substream.ssrc && this.totalBitrate == substream.totalBitrate && this.width == substream.width;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return ((((((((((((((i2 + (z2 ? 1 : z2 ? 1 : 0)) * 31) + this.maxDelay) * 31) + this.retransmitBitrate) * 31) + this.rtcpStats.hashCode()) * 31) + this.rtpStats.hashCode()) * 31) + C2689b.m32716a(this.ssrc)) * 31) + this.totalBitrate) * 31) + this.width;
    }
    ...
    public String toString() {
        ...
        int i4 = this.retransmitBitrate;
        RtcpStats rtcpStats = this.rtcpStats;
        RtpStats rtpStats = this.rtpStats;
        long j = this.ssrc;
        int i5 = this.totalBitrate;
        int i6 = this.width;
        return "Substream(avgDelay=" + i + ", frameCounts=" + frameCounts + ", height=" + i2 + ", isFlexFEC=" + z + ", isRTX=" + z2 + ", maxDelay=" + i3 + ", retransmitBitrate=" + i4 + ", rtcpStats=" + rtcpStats + ", rtpStats=" + rtpStats + ", ssrc=" + j + ", totalBitrate=" + i5 + ", width=" + i6 + ")";
    }
}
