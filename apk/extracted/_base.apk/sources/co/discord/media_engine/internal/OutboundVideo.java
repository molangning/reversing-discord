...
public final class OutboundVideo {
    ...
    public OutboundVideo(String codecName, int i, int i2, boolean z, boolean z2, int i3, int i4, String encoderImplementationName, long j, int i5, int i6, int i7, int i8, long j2, Substream[] substreams, boolean z3, int i9) {
        ...
        C9612q.m13917h(substreams, "substreams");
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof OutboundVideo) {
            ...
            return C9612q.m13922c(this.codecName, outboundVideo.codecName) && this.codecPayloadType == outboundVideo.codecPayloadType && this.avgEncodeTime == outboundVideo.avgEncodeTime && this.bwLimitedResolution == outboundVideo.bwLimitedResolution && this.cpuLimitedResolution == outboundVideo.cpuLimitedResolution && this.encodeFrameRate == outboundVideo.encodeFrameRate && this.encodeUsage == outboundVideo.encodeUsage && C9612q.m13922c(this.encoderImplementationName, outboundVideo.encoderImplementationName) && this.framesEncoded == outboundVideo.framesEncoded && this.inputFrameRate == outboundVideo.inputFrameRate && this.mediaBitrate == outboundVideo.mediaBitrate && this.numberOfCPUAdaptChanges == outboundVideo.numberOfCPUAdaptChanges && this.numberOfQualityAdaptChanges == outboundVideo.numberOfQualityAdaptChanges && this.qpSum == outboundVideo.qpSum && C9612q.m13922c(this.substreams, outboundVideo.substreams) && this.suspended == outboundVideo.suspended && this.targetMediaBitrate == outboundVideo.targetMediaBitrate;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        int hashCode2 = (((((((((((((((((((((i2 + i3) * 31) + this.encodeFrameRate) * 31) + this.encodeUsage) * 31) + this.encoderImplementationName.hashCode()) * 31) + C2689b.m32716a(this.framesEncoded)) * 31) + this.inputFrameRate) * 31) + this.mediaBitrate) * 31) + this.numberOfCPUAdaptChanges) * 31) + this.numberOfQualityAdaptChanges) * 31) + C2689b.m32716a(this.qpSum)) * 31) + Arrays.hashCode(this.substreams)) * 31;
        boolean z3 = this.suspended;
        return ((hashCode2 + (z3 ? 1 : z3 ? 1 : 0)) * 31) + this.targetMediaBitrate;
    }

    public String toString() {
        String str = this.codecName;
        int i = this.codecPayloadType;
        int i2 = this.avgEncodeTime;
        boolean z = this.bwLimitedResolution;
        boolean z2 = this.cpuLimitedResolution;
        int i3 = this.encodeFrameRate;
        int i4 = this.encodeUsage;
        String str2 = this.encoderImplementationName;
        long j = this.framesEncoded;
        int i5 = this.inputFrameRate;
        int i6 = this.mediaBitrate;
        int i7 = this.numberOfCPUAdaptChanges;
        int i8 = this.numberOfQualityAdaptChanges;
        long j2 = this.qpSum;
        String arrays = Arrays.toString(this.substreams);
        boolean z3 = this.suspended;
        int i9 = this.targetMediaBitrate;
        return "OutboundVideo(codecName=" + str + ", codecPayloadType=" + i + ", avgEncodeTime=" + i2 + ", bwLimitedResolution=" + z + ", cpuLimitedResolution=" + z2 + ", encodeFrameRate=" + i3 + ", encodeUsage=" + i4 + ", encoderImplementationName=" + str2 + ", framesEncoded=" + j + ", inputFrameRate=" + i5 + ", mediaBitrate=" + i6 + ", numberOfCPUAdaptChanges=" + i7 + ", numberOfQualityAdaptChanges=" + i8 + ", qpSum=" + j2 + ", substreams=" + arrays + ", suspended=" + z3 + ", targetMediaBitrate=" + i9 + ")";
    }
}
