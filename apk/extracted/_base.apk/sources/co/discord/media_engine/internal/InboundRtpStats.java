...
public final class InboundRtpStats {
    ...
    public int hashCode() {
        return (((((((((C2689b.m32716a(this.packets) * 31) + C2689b.m32716a(this.jitter)) * 31) + this.packetsLost) * 31) + C2689b.m32716a(this.headerBytes)) * 31) + C2689b.m32716a(this.paddingBytes)) * 31) + C2689b.m32716a(this.payloadBytes);
    }
    ...
    public String toString() {
        ...
        long j3 = this.headerBytes;
        long j4 = this.paddingBytes;
        long j5 = this.payloadBytes;
        return "InboundRtpStats(packets=" + j + ", jitter=" + j2 + ", packetsLost=" + i + ", headerBytes=" + j3 + ", paddingBytes=" + j4 + ", payloadBytes=" + j5 + ")";
    }
}
