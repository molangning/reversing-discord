...
public interface EglBase {
    ...
    public static final int[] CONFIG_PLAIN = C11326o.m8292a().createConfigAttributes();
    public static final int[] CONFIG_RGBA = C11326o.m8292a().setHasAlphaChannel(true).createConfigAttributes();
    public static final int[] CONFIG_PIXEL_BUFFER = C11326o.m8292a().setSupportsPixelBuffer(true).createConfigAttributes();
    public static final int[] CONFIG_PIXEL_RGBA_BUFFER = C11326o.m8292a().setHasAlphaChannel(true).setSupportsPixelBuffer(true).createConfigAttributes();
    public static final int[] CONFIG_RECORDABLE = C11326o.m8292a().setIsRecordable(true).createConfigAttributes();
