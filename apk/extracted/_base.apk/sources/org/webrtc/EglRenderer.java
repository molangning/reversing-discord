...
public class EglRenderer implements VideoSink {
    ...
    public static class HandlerWithExceptionCallback extends Handler {
        ...
        public void dispatchMessage(Message message) {
            try {
                ...
                Logging.m8409e(EglRenderer.TAG, "Exception on EglRenderer thread", e);
    ...
    public /* synthetic */ void lambda$init$0(EglBase.Context context, int[] iArr) {
        if (context == null) {
            ...
            this.eglBase = C11326o.m8286g(iArr);
            return;
        }
        logD("EglBase.create shared context");
        this.eglBase = C11326o.m8289d(context, iArr);
    }
    ...
    private void logE(String str, Throwable th2) {
        String str2 = this.name;
        Logging.m8409e(TAG, str2 + str, th2);
    }
    ...
    public void logStatistics() {
        ...
        synchronized (this.statisticsLock) {
            ...
            if (j > 0 && (this.minRenderPeriodNs != Long.MAX_VALUE || this.framesReceived != 0)) {
                ...
                logD("Duration: " + millis + " ms. Frames received: " + i + ". Dropped: " + i2 + ". Rendered: " + i3 + ". Render fps: " + format + ". Average render time: " + averageTimeAsString + ". Average swapBuffer time: " + averageTimeAsString2 + ".");
    ...
    public void init(final EglBase.Context context, final int[] iArr, RendererCommon.GlDrawer glDrawer, boolean z) {
        synchronized (this.handlerLock) {
            if (this.renderThreadHandler == null) {
                ...
                ThreadUtils.invokeAtFrontUninterruptibly(handlerWithExceptionCallback, new Runnable() { // from class: org.webrtc.w
                    @Override // java.lang.Runnable
    ...
    public void onFrame(VideoFrame videoFrame) {
        ...
        synchronized (this.handlerLock) {
            ...
            synchronized (this.frameLock) {
                ...
                videoFrame.retain();
                this.renderThreadHandler.post(new Runnable() { // from class: org.webrtc.p
                    @Override // java.lang.Runnable
                    public final void run() {
    ...
    public void release() {
        ...
        synchronized (this.handlerLock) {
            ...
            this.renderThreadHandler.postAtFrontOfQueue(new Runnable() { // from class: org.webrtc.r
                @Override // java.lang.Runnable
                public final void run() {
            ...
            this.renderThreadHandler.post(new Runnable() { // from class: org.webrtc.s
                @Override // java.lang.Runnable
                public final void run() {
    ...
    public void releaseEglSurface(final Runnable runnable) {
        ...
        synchronized (this.handlerLock) {
            ...
            if (handler != null) {
                ...
                this.renderThreadHandler.postAtFrontOfQueue(new Runnable() { // from class: org.webrtc.u
                    @Override // java.lang.Runnable
                    public final void run() {
    ...
    public void removeFrameListener(final FrameListener frameListener) {
        ...
        synchronized (this.handlerLock) {
            ...
            if (Thread.currentThread() != this.renderThreadHandler.getLooper().getThread()) {
                postToRenderThread(new Runnable() { // from class: org.webrtc.q
                    @Override // java.lang.Runnable
                    public final void run() {
    ...
    public void clearImage(final float f, final float f2, final float f3, final float f4) {
        synchronized (this.handlerLock) {
            ...
            handler.postAtFrontOfQueue(new Runnable() { // from class: org.webrtc.v
                @Override // java.lang.Runnable
                public final void run() {
