...
public class GlShader {
    ...
    public GlShader(String str, String str2) {
        ...
        if (glCreateProgram != 0) {
            ...
            Logging.m8410e(TAG, "Could not link program: " + glGetProgramInfoLog);
    ...
    private static int compileShader(int i, String str) {
        ...
        if (glCreateShader != 0) {
            ...
            Logging.m8410e(TAG, "Compile error " + glGetShaderInfoLog + " in shader:\n" + str);
    ...
    public void release() {
        Logging.m8411d(TAG, "Deleting shader.");
        int i = this.program;
        if (i != -1) {
