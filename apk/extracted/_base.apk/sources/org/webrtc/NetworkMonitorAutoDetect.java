...
public class NetworkMonitorAutoDetect extends BroadcastReceiver implements NetworkChangeDetector {
    ...
    public static class ConnectivityManagerDelegate {
        ...
        public NetworkChangeDetector.NetworkInformation networkToInfo(Network network) {
            ...
            if (linkProperties == null) {
                ...
                Logging.m8407w(NetworkMonitorAutoDetect.TAG, "Detected unknown network: " + network2);
                return null;
            } else if (linkProperties.getInterfaceName() == null) {
                String network3 = network.toString();
                Logging.m8407w(NetworkMonitorAutoDetect.TAG, "Null interface name for network " + network3);
                return null;
            } else {
                ...
                if (connectionType == NetworkChangeDetector.ConnectionType.CONNECTION_NONE) {
                    ...
                    Logging.m8411d(NetworkMonitorAutoDetect.TAG, "Network " + network4 + " is disconnected");
                    return null;
                }
                if (connectionType == NetworkChangeDetector.ConnectionType.CONNECTION_UNKNOWN || connectionType == NetworkChangeDetector.ConnectionType.CONNECTION_UNKNOWN_CELLULAR) {
                    ...
                    Logging.m8411d(NetworkMonitorAutoDetect.TAG, "Network " + network5 + " connection type is " + connectionType + " because it has type " + networkType + " and subtype " + networkSubType);
                }
        ...
        public void releaseCallback(ConnectivityManager.NetworkCallback networkCallback) {
            if (supportNetworkCallback()) {
                Logging.m8411d(NetworkMonitorAutoDetect.TAG, "Unregister network callback");
        ...
        NetworkState getNetworkState(Network network) {
            ...
            if (network != null && (connectivityManager = this.connectivityManager) != null) {
                ...
                if (networkInfo == null) {
                    String network2 = network.toString();
                    Logging.m8407w(NetworkMonitorAutoDetect.TAG, "Couldn't retrieve information from network " + network2);
                    return new NetworkState(false, -1, -1, -1, -1);
    ...
    class SimpleNetworkCallback extends ConnectivityManager.NetworkCallback {
        ...
        public void onAvailable(Network network) {
            String network2 = network.toString();
            Logging.m8411d(NetworkMonitorAutoDetect.TAG, "Network becomes available: " + network2);
            synchronized (this.availableNetworks) {
        ...
        public void onCapabilitiesChanged(Network network, NetworkCapabilities networkCapabilities) {
            ...
            Logging.m8411d(NetworkMonitorAutoDetect.TAG, "capabilities changed: " + networkCapabilities2);
            onNetworkChanged(network);
        }

        @Override // android.net.ConnectivityManager.NetworkCallback
        public void onLinkPropertiesChanged(Network network, LinkProperties linkProperties) {
            Logging.m8411d(NetworkMonitorAutoDetect.TAG, "link properties changed");
            onNetworkChanged(network);
        }
        ...
        public void onLosing(Network network, int i) {
            String network2 = network.toString();
            Logging.m8411d(NetworkMonitorAutoDetect.TAG, "Network " + network2 + " is about to lose in " + i + "ms");
        }

        @Override // android.net.ConnectivityManager.NetworkCallback
        public void onLost(Network network) {
            String network2 = network.toString();
            Logging.m8411d(NetworkMonitorAutoDetect.TAG, "Network " + network2 + " is disconnected");
            synchronized (this.availableNetworks) {
    ...
    public static class WifiDirectManagerDelegate extends BroadcastReceiver {
        ...
        WifiDirectManagerDelegate(NetworkChangeDetector.Observer observer, Context context) {
            ...
            if (Build.VERSION.SDK_INT > 28) {
                ...
                wifiP2pManager.requestGroupInfo(wifiP2pManager.initialize(context, context.getMainLooper(), null), new WifiP2pManager.GroupInfoListener() { // from class: org.webrtc.l0
        ...
        public void lambda$new$0(WifiP2pGroup wifiP2pGroup) {
            if (wifiP2pGroup != null && wifiP2pGroup.getInterface() != null) {
                try {
                    ...
                    Logging.m8409e(NetworkMonitorAutoDetect.TAG, "Unable to get WifiP2p network interface", e);
                }
            }
        }
    ...
    public NetworkMonitorAutoDetect(NetworkChangeDetector.Observer observer, Context context) {
        ...
        if (this.connectivityManagerDelegate.supportNetworkCallback()) {
            ...
            try {
                ...
                Logging.m8407w(TAG, "Unable to obtain permission to request a cellular network.");
            }
    ...
    private void connectionTypeChanged(NetworkState networkState) {
        ...
        Logging.m8411d(TAG, "Network connectivity changed, type is: " + connectionType);
