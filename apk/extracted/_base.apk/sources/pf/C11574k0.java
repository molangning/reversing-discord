...
public final class C11574k0 {
    ...
    public static final String m7606d(long j, int i) {
        if (j >= 0) {
            String l = Long.toString(j, C9636a.m13858a(i));
        ...
        String l2 = Long.toString(j3, C9636a.m13858a(i));
        C9612q.m13918g(l2, "toString(this, checkRadix(radix))");
        sb2.append(l2);
        String l3 = Long.toString(j4, C9636a.m13858a(i));
