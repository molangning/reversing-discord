...
public final class C11775e {
    ...
    public C11775e(String str, String str2, long j, long[] jArr, C6314a[] c6314aArr) {
        this.f30712c = str;
        this.f30713d = str2;
        this.f30714e = j;
        this.f30711b = jArr;
        this.f30710a = c6314aArr;
    }

    /* renamed from: a */
    public String m6883a() {
        return this.f30712c + "/" + this.f30713d;
    }
}
