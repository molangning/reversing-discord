...
public class C9037a extends AbstractC9050n<Integer, Integer> {
    public C9037a(List<C12020a<Integer>> list) {
        super(list);
    }

    @Override // p188k1.InterfaceC9049m
    /* renamed from: a */
    public AbstractC6861a<Integer, Integer> mo16817a() {
        return new C6868b(this.f23714a);
    }
