...
final class C13487r {
    ...
    public static String m2390a(String str) {
        ...
        if (str.length() >= 2) {
            ...
            for (Object[] objArr5 : f34723b) {
                if (objArr5[0].equals(substring)) {
                    Object obj = objArr5[1];
                    if (obj == f34722a) {
                        return m2388c(2, ((Integer) objArr5[2]).intValue(), str);
                    }
                    return m2389b(2, ((Integer) obj).intValue(), str);
                }
            }
            if (str.length() >= 3) {
                String substring2 = str.substring(0, 3);
                for (Object[] objArr6 : f34724c) {
                    if (objArr6[0].equals(substring2)) {
                        Object obj2 = objArr6[1];
                        if (obj2 == f34722a) {
                            return m2388c(3, ((Integer) objArr6[2]).intValue(), str);
                        }
                        return m2389b(3, ((Integer) obj2).intValue(), str);
                    }
                }
                for (Object[] objArr7 : f34725d) {
                    if (objArr7[0].equals(substring2)) {
                        Object obj3 = objArr7[1];
                        if (obj3 == f34722a) {
                            return m2388c(4, ((Integer) objArr7[2]).intValue(), str);
                        }
                        return m2389b(4, ((Integer) obj3).intValue(), str);
                    }
                }
                if (str.length() >= 4) {
                    String substring3 = str.substring(0, 4);
                    for (Object[] objArr8 : f34726e) {
                        if (objArr8[0].equals(substring3)) {
                            Object obj4 = objArr8[1];
                            if (obj4 == f34722a) {
                                return m2388c(4, ((Integer) objArr8[2]).intValue(), str);
                            }
                            return m2389b(4, ((Integer) obj4).intValue(), str);
                        }
                    }
    ...
    /* renamed from: b */
    private static String m2389b(int i, int i2, String str) {
        if (str.length() >= i) {
            ...
            if (str.length() >= i3) {
                ...
                String m2390a = m2390a(str.substring(i3));
                if (m2390a == null) {
                    return str2;
                }
                return str2 + m2390a;
    ...
    /* renamed from: c */
    private static String m2388c(int i, int i2, String str) {
        String substring = str.substring(0, i);
        int i3 = i2 + i;
        if (str.length() < i3) {
            i3 = str.length();
