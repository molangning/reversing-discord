...
public class C0506f extends CheckBox implements InterfaceC1446p {

    /* renamed from: j */
    private final C0526i f1786j;

    /* renamed from: k */
    private final AppCompatBackgroundHelper f1787k;

    /* renamed from: l */
    private final AppCompatTextHelper f1788l;

    /* renamed from: m */
    private AppCompatEmojiTextHelper f1789m;

    public C0506f(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C5706a.f16064r);
    }

    private AppCompatEmojiTextHelper getEmojiTextViewHelper() {
        if (this.f1789m == null) {
            this.f1789m = new AppCompatEmojiTextHelper(this);
        }
        return this.f1789m;
    }
    ...
    public void drawableStateChanged() {
        ...
        AppCompatBackgroundHelper appCompatBackgroundHelper = this.f1787k;
        if (appCompatBackgroundHelper != null) {
            appCompatBackgroundHelper.m40227b();
        }
        AppCompatTextHelper appCompatTextHelper = this.f1788l;
    ...
    public ColorStateList getSupportCompoundDrawablesTintList() {
        return this.f1788l.m40176j();
    }

    public PorterDuff.Mode getSupportCompoundDrawablesTintMode() {
        return this.f1788l.m40175k();
    }
    ...
    public void setSupportCompoundDrawablesTintList(ColorStateList colorStateList) {
        this.f1788l.m40163w(colorStateList);
        this.f1788l.m40184b();
    }

    @Override // androidx.core.widget.InterfaceC1446p
    public void setSupportCompoundDrawablesTintMode(PorterDuff.Mode mode) {
        this.f1788l.m40162x(mode);
        this.f1788l.m40184b();
    }

    public C0506f(Context context, AttributeSet attributeSet, int i) {
        ...
        this.f1787k = appCompatBackgroundHelper;
        appCompatBackgroundHelper.m40224e(attributeSet, i);
        AppCompatTextHelper appCompatTextHelper = new AppCompatTextHelper(this);
        this.f1788l = appCompatTextHelper;
