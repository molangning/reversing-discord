...
public class HeadlessJsTaskContext {
    ...
    public synchronized void finishTask(final int i) {
        ...
        C5743a.m24584b(remove, "Tried to finish non-existent task with id " + i + ".");
        if (this.mActiveTaskConfigs.remove(Integer.valueOf(i)) != null) {
            z = true;
        } else {
            z = false;
        }
        C5743a.m24584b(z, "Tried to remove non-existent task config with id " + i + ".");
        removeTimeout(i);
    ...
    public synchronized boolean retryTask(final int i) {
        ...
        C5743a.m24584b(z, "Tried to retrieve non-existent task config with id " + i + ".");
    ...
    public synchronized void startTask(HeadlessJsTaskConfig headlessJsTaskConfig, int i) {
        ...
        ReactContext reactContext = (ReactContext) C5743a.m24582d(this.mReactContext.get(), "Tried to start a task on a react context that has already been destroyed");
