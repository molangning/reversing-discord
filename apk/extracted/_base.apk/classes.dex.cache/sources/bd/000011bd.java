...
public final class C2933xc30ce0b1 extends AbstractC9614s implements Function1<MessageId, Unit> {
    ...
    public C2933xc30ce0b1(MessageViewManagers.MessageBundleViewManager messageBundleViewManager, ViewMeasuringWrapper<MessageBundleView> viewMeasuringWrapper) {
        super(1);
    ...
    public /* bridge */ /* synthetic */ Unit invoke(MessageId messageId) {
        m41572invoke1xi1bu0(messageId.m42081unboximpl());
        return Unit.f25302a;
    }

    /* renamed from: invoke-1xi1bu0 */
    public final void m41572invoke1xi1bu0(String messageId) {
        C9612q.m13917h(messageId, "messageId");
        this.this$0.m41571emitOnTruncateMessageAyv7vGE(this.$wrapper, messageId);
    }
}