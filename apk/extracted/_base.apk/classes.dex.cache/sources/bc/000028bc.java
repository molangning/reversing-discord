...
public class ReactViewGroup extends ViewGroup implements ReactInterceptingViewGroup, ReactClippingViewGroup, ReactPointerEventsView, ReactHitSlopView, ReactZIndexedViewGroup, ReactOverflowViewWithInset {
    ...
    private void addInArray(View view, int i) {
        View[] viewArr = (View[]) C5743a.m24583c(this.mAllChildren);
            ...
            switch (c) {
                ...
                case 1:
                    ...
                    if (reactViewBackgroundDrawable != null) {
                        ...
                        if (f5 <= 0.0f && f6 <= 0.0f && borderRadius4 <= 0.0f && f7 <= 0.0f) {
                            f8 = f2;
                            z = false;
                        } else {
                            if (this.mPath == null) {
                            ...
                            this.mPath.rewind();
                            this.mPath.addRoundRect(new RectF(f2, f, width, height), new float[]{Math.max(f5 - directionAwareBorderInsets.left, 0.0f), Math.max(f5 - directionAwareBorderInsets.top, 0.0f), Math.max(f6 - directionAwareBorderInsets.right, 0.0f), Math.max(f6 - directionAwareBorderInsets.top, 0.0f), Math.max(borderRadius4 - directionAwareBorderInsets.right, 0.0f), Math.max(borderRadius4 - directionAwareBorderInsets.bottom, 0.0f), Math.max(f7 - directionAwareBorderInsets.left, 0.0f), Math.max(f7 - directionAwareBorderInsets.bottom, 0.0f)}, Path.Direction.CW);
    ...
    private void updateClippingToRect(Rect rect) {
        C5743a.m24583c(this.mAllChildren);
        int i = 0;
    ...
    private void updateSubviewClipStatus(Rect rect, int i, int i2) {
        ...
        View view = ((View[]) C5743a.m24583c(this.mAllChildren))[i];
    ...
    public void dispatchProvideStructure(ViewStructure viewStructure) {
        try {
            ...
            C13677a.m1853k(ReactConstants.TAG, "NullPointerException when executing dispatchProvideStructure", e);
        }
    }
    ...
    public View getChildAtWithSubviewClippingEnabled(int i) {
        return ((View[]) C5743a.m24583c(this.mAllChildren))[i];
    }
    ...
    public void removeAllViewsWithSubviewClippingEnabled() {
        C5743a.m24585a(this.mRemoveClippedSubviews);
        C5743a.m24583c(this.mAllChildren);
    ...
    public void setRemoveClippedSubviews(boolean z) {
        ...
        C5743a.m24583c(this.mClippingRect);
        C5743a.m24583c(this.mAllChildren);
        C5743a.m24583c(this.mChildrenLayoutChangeListener);
        for (int i2 = 0; i2 < this.mAllChildrenCount; i2++) {
