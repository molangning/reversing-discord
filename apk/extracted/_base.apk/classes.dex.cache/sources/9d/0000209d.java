...
public final class DarkerTheme extends DiscordTheme {
    ...
    public DarkerTheme(Context context) {
        ...
        this.androidNavigationBarBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.plum_24);
        this.androidNavigationScrimBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.android_navigation_scrim_background_darker);
        this.androidRipple = ColorUtilsKt.getColorCompat(context, C3511R.color.android_ripple_darker);
        int i2 = C3511R.color.plum_15;
        this.backgroundAccent = ColorUtilsKt.getColorCompat(context, i2);
        int i3 = C3511R.color.plum_18;
        this.backgroundFloating = ColorUtilsKt.getColorCompat(context, i3);
        this.backgroundMentioned = ColorUtilsKt.getColorCompat(context, C3511R.color.background_mentioned_darker);
        this.backgroundMentionedHover = ColorUtilsKt.getColorCompat(context, C3511R.color.background_mentioned_hover_darker);
        this.backgroundMessageAutomod = ColorUtilsKt.getColorCompat(context, C3511R.color.background_message_automod_darker);
        this.backgroundMessageAutomodHover = ColorUtilsKt.getColorCompat(context, C3511R.color.background_message_automod_hover_darker);
        this.backgroundMessageHighlight = ColorUtilsKt.getColorCompat(context, C3511R.color.background_message_highlight_darker);
        this.backgroundMessageHighlightHover = ColorUtilsKt.getColorCompat(context, C3511R.color.background_message_highlight_hover_darker);
        int i4 = C3511R.color.plum_21;
        this.backgroundMessageHover = ColorUtilsKt.getColorCompat(context, i4);
        int i5 = C3511R.color.plum_20;
        ...
        this.backgroundModifierAccent = ColorUtilsKt.getColorCompat(context, C3511R.color.background_modifier_accent_darker);
        this.backgroundModifierAccent2 = ColorUtilsKt.getColorCompat(context, C3511R.color.background_modifier_accent_2_darker);
        this.backgroundModifierActive = ColorUtilsKt.getColorCompat(context, C3511R.color.background_modifier_active_darker);
        this.backgroundModifierHover = ColorUtilsKt.getColorCompat(context, C3511R.color.background_modifier_hover_darker);
        this.backgroundModifierSelected = ColorUtilsKt.getColorCompat(context, C3511R.color.background_modifier_selected_darker);
        int i6 = C3511R.color.plum_22;
        this.backgroundNestedFloating = ColorUtilsKt.getColorCompat(context, i6);
        ...
        this.backgroundSecondaryAlt = ColorUtilsKt.getColorCompat(context, i2);
        int i7 = C3511R.color.plum_16;
        this.backgroundTertiary = ColorUtilsKt.getColorCompat(context, i7);
        this.bgBackdrop = ColorUtilsKt.getColorCompat(context, C3511R.color.bg_backdrop_darker);
        int i8 = C3511R.color.black_500;
        this.bgBackdropNoOpacity = ColorUtilsKt.getColorCompat(context, i8);
        this.bgBasePrimary = ColorUtilsKt.getColorCompat(context, i5);
        this.bgBaseSecondary = ColorUtilsKt.getColorCompat(context, i5);
        this.bgBaseTertiary = ColorUtilsKt.getColorCompat(context, i6);
        this.bgModFaint = ColorUtilsKt.getColorCompat(context, C3511R.color.bg_mod_faint_darker);
        this.bgModStrong = ColorUtilsKt.getColorCompat(context, C3511R.color.bg_mod_strong_darker);
        this.bgModSubtle = ColorUtilsKt.getColorCompat(context, C3511R.color.bg_mod_subtle_darker);
        int i9 = C3511R.color.plum_17;
        this.bgSurfaceOverlay = ColorUtilsKt.getColorCompat(context, i9);
        this.bgSurfaceOverlayTmp = ColorUtilsKt.getColorCompat(context, i9);
        this.bgSurfaceRaised = ColorUtilsKt.getColorCompat(context, i3);
        this.black = ColorUtilsKt.getColorCompat(context, i8);
        this.blurFallback = ColorUtilsKt.getColorCompat(context, C3511R.color.blur_fallback_darker);
        this.blurFallbackPressed = ColorUtilsKt.getColorCompat(context, C3511R.color.blur_fallback_pressed_darker);
        this.borderFaint = ColorUtilsKt.getColorCompat(context, C3511R.color.border_faint_darker);
        this.borderStrong = ColorUtilsKt.getColorCompat(context, C3511R.color.border_strong_darker);
        this.borderSubtle = ColorUtilsKt.getColorCompat(context, C3511R.color.border_subtle_darker);
        this.bugReporterModalSubmittingBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.bug_reporter_modal_submitting_background_darker);
        int i10 = C3511R.color.teal_430;
        this.buttonCreatorRevenueBackground = ColorUtilsKt.getColorCompat(context, i10);
        int i11 = C3511R.color.red_430;
        this.buttonDangerBackground = ColorUtilsKt.getColorCompat(context, i11);
        this.buttonDangerBackgroundActive = ColorUtilsKt.getColorCompat(context, C3511R.color.red_530);
        this.buttonDangerBackgroundDisabled = ColorUtilsKt.getColorCompat(context, i11);
        this.buttonDangerBackgroundHover = ColorUtilsKt.getColorCompat(context, C3511R.color.red_500);
        this.buttonOutlineBrandBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.button_outline_brand_background_darker);
        int i12 = C3511R.color.brand_560;
        this.buttonOutlineBrandBackgroundActive = ColorUtilsKt.getColorCompat(context, i12);
        int i13 = C3511R.color.brand_500;
        this.buttonOutlineBrandBackgroundHover = ColorUtilsKt.getColorCompat(context, i13);
        this.buttonOutlineBrandBorder = ColorUtilsKt.getColorCompat(context, i13);
        this.buttonOutlineBrandBorderActive = ColorUtilsKt.getColorCompat(context, i12);
        this.buttonOutlineBrandBorderHover = ColorUtilsKt.getColorCompat(context, i13);
        int i14 = C3511R.color.white_500;
        this.buttonOutlineBrandText = ColorUtilsKt.getColorCompat(context, i14);
        this.buttonOutlineBrandTextActive = ColorUtilsKt.getColorCompat(context, i14);
        this.buttonOutlineBrandTextHover = ColorUtilsKt.getColorCompat(context, i14);
        this.buttonOutlineDangerBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.button_outline_danger_background_darker);
        int i15 = C3511R.color.red_460;
        this.buttonOutlineDangerBackgroundActive = ColorUtilsKt.getColorCompat(context, i15);
        this.buttonOutlineDangerBackgroundHover = ColorUtilsKt.getColorCompat(context, i11);
        int i16 = C3511R.color.red_400;
        this.buttonOutlineDangerBorder = ColorUtilsKt.getColorCompat(context, i16);
        this.buttonOutlineDangerBorderActive = ColorUtilsKt.getColorCompat(context, i11);
        this.buttonOutlineDangerBorderHover = ColorUtilsKt.getColorCompat(context, i11);
        this.buttonOutlineDangerText = ColorUtilsKt.getColorCompat(context, i14);
        this.buttonOutlineDangerTextActive = ColorUtilsKt.getColorCompat(context, i14);
        this.buttonOutlineDangerTextHover = ColorUtilsKt.getColorCompat(context, i14);
        this.buttonOutlinePositiveBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.button_outline_positive_background_darker);
        int i17 = C3511R.color.green_530;
        this.buttonOutlinePositiveBackgroundActive = ColorUtilsKt.getColorCompat(context, i17);
        int i18 = C3511R.color.green_430;
        this.buttonOutlinePositiveBackgroundHover = ColorUtilsKt.getColorCompat(context, i18);
        int i19 = C3511R.color.green_360;
        this.buttonOutlinePositiveBorder = ColorUtilsKt.getColorCompat(context, i19);
        this.buttonOutlinePositiveBorderActive = ColorUtilsKt.getColorCompat(context, i17);
        this.buttonOutlinePositiveBorderHover = ColorUtilsKt.getColorCompat(context, i18);
        this.buttonOutlinePositiveText = ColorUtilsKt.getColorCompat(context, i14);
        this.buttonOutlinePositiveTextActive = ColorUtilsKt.getColorCompat(context, i14);
        this.buttonOutlinePositiveTextHover = ColorUtilsKt.getColorCompat(context, i14);
        this.buttonOutlinePrimaryBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.button_outline_primary_background_darker);
        int i20 = C3511R.color.plum_11;
        this.buttonOutlinePrimaryBackgroundActive = ColorUtilsKt.getColorCompat(context, i20);
        int i21 = C3511R.color.plum_13;
        this.buttonOutlinePrimaryBackgroundHover = ColorUtilsKt.getColorCompat(context, i21);
        this.buttonOutlinePrimaryBorder = ColorUtilsKt.getColorCompat(context, C3511R.color.primary_500);
        this.buttonOutlinePrimaryBorderActive = ColorUtilsKt.getColorCompat(context, i20);
        this.buttonOutlinePrimaryBorderHover = ColorUtilsKt.getColorCompat(context, i21);
        this.buttonOutlinePrimaryText = ColorUtilsKt.getColorCompat(context, i14);
        this.buttonOutlinePrimaryTextActive = ColorUtilsKt.getColorCompat(context, i14);
        this.buttonOutlinePrimaryTextHover = ColorUtilsKt.getColorCompat(context, i14);
        this.buttonPositiveBackground = ColorUtilsKt.getColorCompat(context, i18);
        this.buttonPositiveBackgroundActive = ColorUtilsKt.getColorCompat(context, i17);
        this.buttonPositiveBackgroundDisabled = ColorUtilsKt.getColorCompat(context, i18);
        this.buttonPositiveBackgroundHover = ColorUtilsKt.getColorCompat(context, C3511R.color.green_500);
        this.buttonSecondaryBackground = ColorUtilsKt.getColorCompat(context, i21);
        int i22 = C3511R.color.plum_10;
        this.buttonSecondaryBackgroundActive = ColorUtilsKt.getColorCompat(context, i22);
        this.buttonSecondaryBackgroundDisabled = ColorUtilsKt.getColorCompat(context, i21);
        this.buttonSecondaryBackgroundHover = ColorUtilsKt.getColorCompat(context, i20);
        this.cardGradientBg = ColorUtilsKt.getColorCompat(context, C3511R.color.card_gradient_bg_darker);
        this.cardGradientPressedBg = ColorUtilsKt.getColorCompat(context, C3511R.color.card_gradient_pressed_bg_darker);
        this.cardPrimaryBg = ColorUtilsKt.getColorCompat(context, i3);
        int i23 = C3511R.color.plum_19;
        this.cardPrimaryPressedBg = ColorUtilsKt.getColorCompat(context, i23);
        this.cardSecondaryBg = ColorUtilsKt.getColorCompat(context, i23);
        this.cardSecondaryPressedBg = ColorUtilsKt.getColorCompat(context, i4);
        this.channelIcon = ColorUtilsKt.getColorCompat(context, i22);
        this.channelTextAreaPlaceholder = ColorUtilsKt.getColorCompat(context, i20);
        int i24 = C3511R.color.plum_9;
        this.channelsDefault = ColorUtilsKt.getColorCompat(context, i24);
        this.channeltextareaBackground = ColorUtilsKt.getColorCompat(context, i2);
        this.chatBackground = ColorUtilsKt.getColorCompat(context, i7);
        this.chatBorder = ColorUtilsKt.getColorCompat(context, i5);
        this.chatInputContainerBackground = ColorUtilsKt.getColorCompat(context, i7);
        this.chatSwipeToReplyBackground = ColorUtilsKt.getColorCompat(context, i6);
        ...
        this.creatorRevenueIconGradientEnd = ColorUtilsKt.getColorCompat(context, i10);
        this.creatorRevenueIconGradientStart = ColorUtilsKt.getColorCompat(context, C3511R.color.teal_360);
        this.creatorRevenueInfoBoxBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.creator_revenue_info_box_background_darker);
        ...
        this.deprecatedCardBg = ColorUtilsKt.getColorCompat(context, C3511R.color.deprecated_card_bg_darker);
        this.deprecatedCardEditableBg = ColorUtilsKt.getColorCompat(context, C3511R.color.deprecated_card_editable_bg_darker);
        this.deprecatedQuickswitcherInputBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.primary_400);
        this.deprecatedQuickswitcherInputPlaceholder = ColorUtilsKt.getColorCompat(context, C3511R.color.deprecated_quickswitcher_input_placeholder_darker);
        ...
        this.deprecatedTextInputBorder = ColorUtilsKt.getColorCompat(context, C3511R.color.deprecated_text_input_border_darker);
        ...
        this.displayBannerOverflowBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.display_banner_overflow_background_darker);
        this.dividerStrong = ColorUtilsKt.getColorCompat(context, C3511R.color.divider_strong_darker);
        this.dividerSubtle = ColorUtilsKt.getColorCompat(context, C3511R.color.divider_subtle_darker);
        int i28 = C3511R.color.blue_345;
        this.focusPrimary = ColorUtilsKt.getColorCompat(context, i28);
        this.forumPostExtraMediaCountContainerBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.forum_post_extra_media_count_container_background_darker);
        this.forumPostTagBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.forum_post_tag_background_darker);
        this.guildNotificationsBottomSheetPillBackground = ColorUtilsKt.getColorCompat(context, i);
        this.headerMuted = ColorUtilsKt.getColorCompat(context, i22);
        int i29 = C3511R.color.plum_1;
        this.headerPrimary = ColorUtilsKt.getColorCompat(context, i29);
        this.headerSecondary = ColorUtilsKt.getColorCompat(context, i24);
        this.homeBackground = ColorUtilsKt.getColorCompat(context, i3);
        this.homeCardRestingBorder = ColorUtilsKt.getColorCompat(context, C3511R.color.home_card_resting_border_darker);
        this.iconMuted = ColorUtilsKt.getColorCompat(context, i20);
        int i30 = C3511R.color.plum_4;
        this.iconPrimary = ColorUtilsKt.getColorCompat(context, i30);
        this.iconSecondary = ColorUtilsKt.getColorCompat(context, i24);
        this.infoBoxBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.info_box_background_darker);
        this.infoDangerBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.info_danger_background_darker);
        this.infoDangerForeground = ColorUtilsKt.getColorCompat(context, i16);
        this.infoDangerText = ColorUtilsKt.getColorCompat(context, i14);
        this.infoHelpBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.info_help_background_darker);
        this.infoHelpForeground = ColorUtilsKt.getColorCompat(context, i28);
        this.infoHelpText = ColorUtilsKt.getColorCompat(context, i14);
        this.infoPositiveBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.info_positive_background_darker);
        this.infoPositiveForeground = ColorUtilsKt.getColorCompat(context, i19);
        this.infoPositiveText = ColorUtilsKt.getColorCompat(context, i14);
        this.infoWarningBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.info_warning_background_darker);
        int i31 = C3511R.color.yellow_300;
        this.infoWarningForeground = ColorUtilsKt.getColorCompat(context, i31);
        this.infoWarningText = ColorUtilsKt.getColorCompat(context, i14);
        this.inputBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.input_background_darker);
        this.inputPlaceholderText = ColorUtilsKt.getColorCompat(context, i24);
        this.interactiveActive = ColorUtilsKt.getColorCompat(context, i29);
        this.interactiveHover = ColorUtilsKt.getColorCompat(context, i30);
        this.interactiveMuted = ColorUtilsKt.getColorCompat(context, i21);
        this.interactiveNormal = ColorUtilsKt.getColorCompat(context, C3511R.color.plum_6);
        this.legacyAndroidBlurOverlayDefault = ColorUtilsKt.getColorCompat(context, C3511R.color.legacy_android_blur_overlay_default_darker);
        this.legacyAndroidBlurOverlayUltraThin = ColorUtilsKt.getColorCompat(context, C3511R.color.legacy_android_blur_overlay_ultra_thin_darker);
        this.legacyBlurFallbackDefault = ColorUtilsKt.getColorCompat(context, C3511R.color.legacy_blur_fallback_default_darker);
        this.legacyBlurFallbackUltraThin = ColorUtilsKt.getColorCompat(context, C3511R.color.legacy_blur_fallback_ultra_thin_darker);
        this.liveStageTileBorder = ColorUtilsKt.getColorCompat(context, C3511R.color.live_stage_tile_border_darker);
        this.logoPrimary = ColorUtilsKt.getColorCompat(context, i14);
        this.mentionBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.mention_background_darker);
        this.mentionForeground = ColorUtilsKt.getColorCompat(context, C3511R.color.brand_230);
        this.modalBackground = ColorUtilsKt.getColorCompat(context, i7);
        this.modalFooterBackground = ColorUtilsKt.getColorCompat(context, i9);
        this.navigatorHeaderTint = ColorUtilsKt.getColorCompat(context, i14);
        this.profileGradientCardBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.profile_gradient_card_background_darker);
        this.profileGradientMessageInputBorder = ColorUtilsKt.getColorCompat(context, C3511R.color.profile_gradient_message_input_border_darker);
        this.profileGradientNoteBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.profile_gradient_note_background_darker);
        this.profileGradientOverlay = ColorUtilsKt.getColorCompat(context, C3511R.color.profile_gradient_overlay_darker);
        this.profileGradientOverlaySyncedWithUserTheme = ColorUtilsKt.getColorCompat(context, C3511R.color.profile_gradient_overlay_synced_with_user_theme_darker);
        this.profileGradientProfileBodyBackgroundHover = ColorUtilsKt.getColorCompat(context, C3511R.color.profile_gradient_profile_body_background_hover_darker);
        this.profileGradientRolePillBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.profile_gradient_role_pill_background_darker);
        this.profileGradientRolePillBorder = ColorUtilsKt.getColorCompat(context, C3511R.color.profile_gradient_role_pill_border_darker);
        this.profileGradientSectionBox = ColorUtilsKt.getColorCompat(context, C3511R.color.profile_gradient_section_box_darker);
        this.redesignActivityCardBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.primary_560);
        int i32 = C3511R.color.primary_630;
        this.redesignActivityCardBackgroundPressed = ColorUtilsKt.getColorCompat(context, i32);
        this.redesignActivityCardBadgeIcon = ColorUtilsKt.getColorCompat(context, i22);
        this.redesignActivityCardBorder = ColorUtilsKt.getColorCompat(context, C3511R.color.redesign_activity_card_border_darker);
        this.redesignActivityCardOverflowBackground = ColorUtilsKt.getColorCompat(context, i9);
        this.redesignButtonDangerBackground = ColorUtilsKt.getColorCompat(context, i11);
        this.redesignButtonDangerPressedBackground = ColorUtilsKt.getColorCompat(context, i15);
        this.redesignButtonDangerText = ColorUtilsKt.getColorCompat(context, i14);
        this.redesignButtonOverlayAlphaBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.redesign_button_overlay_alpha_background_darker);
        this.redesignButtonOverlayAlphaPressedBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.redesign_button_overlay_alpha_pressed_background_darker);
        this.redesignButtonOverlayAlphaText = ColorUtilsKt.getColorCompat(context, i14);
        this.redesignButtonOverlayBackground = ColorUtilsKt.getColorCompat(context, i14);
        this.redesignButtonOverlayPressedBackground = ColorUtilsKt.getColorCompat(context, i30);
        this.redesignButtonOverlayText = ColorUtilsKt.getColorCompat(context, C3511R.color.plum_25);
        this.redesignButtonPositiveBackground = ColorUtilsKt.getColorCompat(context, i18);
        this.redesignButtonPositivePressedBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.green_460);
        this.redesignButtonPositiveText = ColorUtilsKt.getColorCompat(context, i14);
        this.redesignButtonPrimaryAltBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.redesign_button_primary_alt_background_darker);
        this.redesignButtonPrimaryAltBorder = ColorUtilsKt.getColorCompat(context, i25);
        this.redesignButtonPrimaryAltOnBlurpleBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.redesign_button_primary_alt_on_blurple_background_darker);
        this.redesignButtonPrimaryAltOnBlurpleBorder = ColorUtilsKt.getColorCompat(context, i14);
        int i33 = C3511R.color.brand_530;
        ...
        this.redesignButtonPrimaryAltOnBlurpleText = ColorUtilsKt.getColorCompat(context, i14);
        this.redesignButtonPrimaryAltPressedBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.redesign_button_primary_alt_pressed_background_darker);
        this.redesignButtonPrimaryAltPressedBorder = ColorUtilsKt.getColorCompat(context, C3511R.color.redesign_button_primary_alt_pressed_border_darker);
        this.redesignButtonPrimaryAltPressedText = ColorUtilsKt.getColorCompat(context, i25);
        this.redesignButtonPrimaryAltText = ColorUtilsKt.getColorCompat(context, i25);
        this.redesignButtonPrimaryBackground = ColorUtilsKt.getColorCompat(context, i13);
        this.redesignButtonPrimaryOnBlurpleBackground = ColorUtilsKt.getColorCompat(context, i14);
        ...
        this.redesignButtonPrimaryOnBlurpleText = ColorUtilsKt.getColorCompat(context, i13);
        this.redesignButtonPrimaryPressedBackground = ColorUtilsKt.getColorCompat(context, i12);
        this.redesignButtonPrimaryText = ColorUtilsKt.getColorCompat(context, i14);
        this.redesignButtonSecondaryAltBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.redesign_button_secondary_alt_background_darker);
        this.redesignButtonSecondaryAltPressedBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.redesign_button_secondary_alt_pressed_background_darker);
        this.redesignButtonSecondaryAltPressedText = ColorUtilsKt.getColorCompat(context, i24);
        int i34 = C3511R.color.plum_3;
        this.redesignButtonSecondaryAltText = ColorUtilsKt.getColorCompat(context, i34);
        this.redesignButtonSecondaryBackground = ColorUtilsKt.getColorCompat(context, i2);
        this.redesignButtonSecondaryBorder = ColorUtilsKt.getColorCompat(context, C3511R.color.redesign_button_secondary_border_darker);
        this.redesignButtonSecondaryPressedBackground = ColorUtilsKt.getColorCompat(context, i21);
        this.redesignButtonSecondaryPressedBorder = ColorUtilsKt.getColorCompat(context, C3511R.color.redesign_button_secondary_pressed_border_darker);
        this.redesignButtonSecondaryText = ColorUtilsKt.getColorCompat(context, i34);
        this.redesignChannelCategoryNameText = ColorUtilsKt.getColorCompat(context, i24);
        this.redesignChannelMessagePreviewText = ColorUtilsKt.getColorCompat(context, i22);
        this.redesignChannelNameMutedText = ColorUtilsKt.getColorCompat(context, i22);
        this.redesignChannelNameText = ColorUtilsKt.getColorCompat(context, i29);
        this.redesignChatInputBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.redesign_chat_input_background_darker);
        this.redesignInputControlActiveBg = ColorUtilsKt.getColorCompat(context, i7);
        this.redesignInputControlSelected = ColorUtilsKt.getColorCompat(context, i13);
        ...
        this.redesignOnlyBackgroundRaised = ColorUtilsKt.getColorCompat(context, i32);
        this.redesignOnlyBackgroundSunken = ColorUtilsKt.getColorCompat(context, C3511R.color.primary_660);
        this.scrollbarAutoScrollbarColorThumb = ColorUtilsKt.getColorCompat(context, i4);
        this.scrollbarAutoScrollbarColorTrack = ColorUtilsKt.getColorCompat(context, i9);
        this.scrollbarAutoThumb = ColorUtilsKt.getColorCompat(context, i4);
        this.scrollbarAutoTrack = ColorUtilsKt.getColorCompat(context, i9);
        this.scrollbarThinThumb = ColorUtilsKt.getColorCompat(context, i4);
        this.scrollbarThinTrack = ColorUtilsKt.getColorCompat(context, C3511R.color.scrollbar_thin_track_darker);
        this.spoilerHiddenBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.plum_14);
        this.spoilerRevealedBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.spoiler_revealed_background_darker);
        this.statusDanger = ColorUtilsKt.getColorCompat(context, i16);
        this.statusDangerBackground = ColorUtilsKt.getColorCompat(context, i16);
        this.statusDangerText = ColorUtilsKt.getColorCompat(context, i14);
        this.statusDnd = ColorUtilsKt.getColorCompat(context, i16);
        this.statusIdle = ColorUtilsKt.getColorCompat(context, i31);
        this.statusOffline = ColorUtilsKt.getColorCompat(context, i24);
        this.statusOnline = ColorUtilsKt.getColorCompat(context, i19);
        this.statusPositive = ColorUtilsKt.getColorCompat(context, i19);
        this.statusPositiveBackground = ColorUtilsKt.getColorCompat(context, i18);
        this.statusPositiveText = ColorUtilsKt.getColorCompat(context, i14);
        this.statusSpeaking = ColorUtilsKt.getColorCompat(context, i19);
        ...
        this.statusWarningText = ColorUtilsKt.getColorCompat(context, i8);
        this.textBrand = ColorUtilsKt.getColorCompat(context, i25);
        ...
        this.textLowContrast = ColorUtilsKt.getColorCompat(context, i20);
        this.textMessagePreviewLowSat = ColorUtilsKt.getColorCompat(context, i20);
        this.textMuted = ColorUtilsKt.getColorCompat(context, i22);
        ...
        this.textPrimary = ColorUtilsKt.getColorCompat(context, i34);
        this.textSecondary = ColorUtilsKt.getColorCompat(context, i24);
        this.textWarning = ColorUtilsKt.getColorCompat(context, i31);
        this.textboxMarkdownSyntax = ColorUtilsKt.getColorCompat(context, i24);
        this.themeLockedBlurFallback = ColorUtilsKt.getColorCompat(context, C3511R.color.theme_locked_blur_fallback_darker);
        this.userProfileHeaderOverflowBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.user_profile_header_overflow_background_darker);
        this.voiceVideoTileBlurFallback = ColorUtilsKt.getColorCompat(context, C3511R.color.voice_video_tile_blur_fallback_darker);
        this.voiceVideoVideoTileBlurFallback = ColorUtilsKt.getColorCompat(context, C3511R.color.voice_video_video_tile_blur_fallback_darker);
        this.white = ColorUtilsKt.getColorCompat(context, i14);
    }
