...
public abstract class CameraCapturer implements CameraVideoCapturer {
    ...
    private final CameraSession.CreateSessionCallback createSessionCallback = new CameraSession.CreateSessionCallback() { // from class: org.webrtc.CameraCapturer.1
        ...
        public void onDone(CameraSession cameraSession) {
            ...
            Logging.m8411d(CameraCapturer.TAG, "Create session done. Switch state: " + switchState);
        ...
        public void onFailure(CameraSession.FailureType failureType, String str) {
            ...
            synchronized (CameraCapturer.this.stateLock) {
                ...
                if (CameraCapturer.this.openAttemptsRemaining <= 0) {
                    Logging.m8407w(CameraCapturer.TAG, "Opening camera failed, passing: " + str);
                    CameraCapturer.this.sessionOpening = false;
                    CameraCapturer.this.stateLock.notifyAll();
                    SwitchState switchState = CameraCapturer.this.switchState;
                    ...
                    Logging.m8407w(CameraCapturer.TAG, "Opening camera failed, retry: " + str);
    ...
    private final CameraSession.Events cameraSessionEventsHandler = new CameraSession.Events() { // from class: org.webrtc.CameraCapturer.2
        ...
        public void onCameraClosed(CameraSession cameraSession) {
            ...
            synchronized (CameraCapturer.this.stateLock) {
                if (cameraSession != CameraCapturer.this.currentSession && CameraCapturer.this.currentSession != null) {
                    Logging.m8411d(CameraCapturer.TAG, "onCameraClosed from another session.");
                } else {
        ...
        public void onCameraDisconnected(CameraSession cameraSession) {
            ...
            synchronized (CameraCapturer.this.stateLock) {
                if (cameraSession != CameraCapturer.this.currentSession) {
                    Logging.m8407w(CameraCapturer.TAG, "onCameraDisconnected from another session.");
                    return;
                }
                CameraCapturer.this.eventsHandler.onCameraDisconnected();
        ...
        public void onCameraError(CameraSession cameraSession, String str) {
            ...
            synchronized (CameraCapturer.this.stateLock) {
                if (cameraSession != CameraCapturer.this.currentSession) {
                    Logging.m8407w(CameraCapturer.TAG, "onCameraError from another session: " + str);
                    return;
                }
                CameraCapturer.this.eventsHandler.onCameraError(str);
                CameraCapturer.this.stopCapture();
        ...
        public void onCameraOpening() {
            ...
            synchronized (CameraCapturer.this.stateLock) {
                if (CameraCapturer.this.currentSession != null) {
                    Logging.m8407w(CameraCapturer.TAG, "onCameraOpening while session was open.");
                } else {
        ...
        public void onFrameCaptured(CameraSession cameraSession, VideoFrame videoFrame) {
            ...
            synchronized (CameraCapturer.this.stateLock) {
                if (cameraSession != CameraCapturer.this.currentSession) {
                    Logging.m8407w(CameraCapturer.TAG, "onFrameCaptured from another session.");
                    return;
                }
    ...
    public void checkIsOnCameraThread() {
        ...
        Logging.m8410e(TAG, "Check is on camera thread failed.");
    ...
    public void switchCameraInternal(CameraVideoCapturer.CameraSwitchHandler cameraSwitchHandler, String str) {
        Logging.m8411d(TAG, "switchCamera internal");
        ...
        synchronized (this.stateLock) {
            ...
            Logging.m8411d(TAG, "switchCamera: Stopping session");
            ...
            Logging.m8411d(TAG, "switchCamera done");
        }
    }
    ...
    public /* synthetic */ void addMediaRecorderToCamera(MediaRecorder mediaRecorder, CameraVideoCapturer.MediaRecorderHandler mediaRecorderHandler) {
        C11311j.m8298a(this, mediaRecorder, mediaRecorderHandler);
    }

    @Override // org.webrtc.VideoCapturer
    public void changeCaptureFormat(int i, int i2, int i3) {
        Logging.m8411d(TAG, "changeCaptureFormat: " + i + "x" + i2 + "@" + i3);
        synchronized (this.stateLock) {
            stopCapture();
    ...
    public void printStackTrace() {
        ...
        if (thread != null) {
            ...
            if (stackTrace.length > 0) {
                Logging.m8411d(TAG, "CameraCapturer stack trace:");
                for (StackTraceElement stackTraceElement : stackTrace) {
                    Logging.m8411d(TAG, stackTraceElement.toString());
                }
            }
        }
    }
    ...
    public /* synthetic */ void removeMediaRecorderFromCamera(CameraVideoCapturer.MediaRecorderHandler mediaRecorderHandler) {
        C11311j.m8297b(this, mediaRecorderHandler);
    }

    @Override // org.webrtc.VideoCapturer
    public void startCapture(int i, int i2, int i3) {
        Logging.m8411d(TAG, "startCapture: " + i + "x" + i2 + "@" + i3);
        if (this.applicationContext != null) {
            synchronized (this.stateLock) {
                ...
                Logging.m8407w(TAG, "Session already open");
                return;
            }
        }
    ...
    public void stopCapture() {
        Logging.m8411d(TAG, "Stop capture");
        synchronized (this.stateLock) {
            while (this.sessionOpening) {
                Logging.m8411d(TAG, "Stop capture: Waiting for session to open");
                try {
                    this.stateLock.wait();
                } catch (InterruptedException unused) {
                    Logging.m8407w(TAG, "Stop capture interrupted while waiting for the session to open.");
                    Thread.currentThread().interrupt();
                    return;
                }
            }
            if (this.currentSession != null) {
                Logging.m8411d(TAG, "Stop capture: Nulling session");
                this.cameraStatistics.release();
                this.cameraStatistics = null;
                final CameraSession cameraSession = this.currentSession;
                ...
                Logging.m8411d(TAG, "Stop capture: No session open");
            }
        }
        Logging.m8411d(TAG, "Stop capture done");
    }

    @Override // org.webrtc.CameraVideoCapturer
    public void switchCamera(final CameraVideoCapturer.CameraSwitchHandler cameraSwitchHandler) {
        Logging.m8411d(TAG, "switchCamera");
