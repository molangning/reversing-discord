...
public final class SoundExtensionsKt {
    public static final void fetchSound(Context context, String url, SoundManager soundManager, int i, int i2, Function1<? super Integer, Unit> soundResIdPrepared) {
        ...
        C9818l.m13179d(C9824m0.m13173b(), C9677b1.m13569b(), null, new SoundExtensionsKt$fetchSound$1(context, url, getRemoteSoundFilename(url), getSoundsCacheDirectory(context), soundManager, i, i2, soundResIdPrepared, null), 2, null);
    }
