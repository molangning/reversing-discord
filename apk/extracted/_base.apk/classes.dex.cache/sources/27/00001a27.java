...
public final class MediaPlayerView {
    ...
    public MediaPlayerView(Context context) {
        ...
        if (Build.VERSION.SDK_INT < 24) {
            root = PlayerViewWithTextureViewBinding.inflate(LayoutInflater.from(context)).getRoot();
            C9612q.m13918g(root, "{\n            PlayerView…(context)).root\n        }");
        } else {
            root = PlayerViewWithSurfaceViewBinding.inflate(LayoutInflater.from(context)).getRoot();
            C9612q.m13918g(root, "{\n            PlayerView…(context)).root\n        }");
        }
        this.view = root;
    ...
    private final PlayerView getPlayerView() {
        View view = this.view;
        C9612q.m13919f(view, "null cannot be cast to non-null type com.google.android.exoplayer2.ui.PlayerView");
