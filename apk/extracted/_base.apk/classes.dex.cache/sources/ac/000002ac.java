...
public class C0613x1 extends C0502d1 {

    /* renamed from: c */
    private static boolean f2088c = false;

    /* renamed from: b */
    private final WeakReference<Context> f2089b;

    public C0613x1(Context context, Resources resources) {
        super(resources);
        this.f2089b = new WeakReference<>(context);
    }

    /* renamed from: b */
    public static boolean m39578b() {
        return f2088c;
    }

    /* renamed from: c */
    public static void m39577c(boolean z) {
        f2088c = z;
    }

    /* renamed from: d */
    public static boolean m39576d() {
        m39578b();
        return false;
    }

    @Override // androidx.appcompat.widget.C0502d1, android.content.res.Resources
    ...
    public Drawable getDrawable(int i) {
        Context context = this.f2089b.get();
        if (context != null) {
            return C0492c1.m39959h().m39947t(context, this, i);
        }
        return m39936a(i);
    }
