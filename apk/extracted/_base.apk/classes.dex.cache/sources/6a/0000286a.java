...
public class ReactTextViewManager extends ReactTextAnchorViewManager<ReactTextView, ReactTextShadowNode> implements IViewManagerWithChildren {
    ...
    public Map getExportedCustomDirectEventTypeConstants() {
        ...
        exportedCustomDirectEventTypeConstants.putAll(MapBuilder.m30469of("topTextLayout", MapBuilder.m30470of("registrationName", "onTextLayout"), "topInlineViewLayout", MapBuilder.m30470of("registrationName", "onInlineViewLayout")));
    ...
    public void updateExtraData(ReactTextView reactTextView, Object obj) {
        ...
        if (reactClickableSpanArr.length > 0) {
            reactTextView.setTag(C3893R.C3895id.accessibility_links, new ReactAccessibilityDelegate.AccessibilityLinks(reactClickableSpanArr, text));
