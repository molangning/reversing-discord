...
public enum EnumC8966j {
    ...
    EnumC8966j(String str, boolean z) {
        this.f23552j = str;
        this.f23553k = z;
    }

    /* renamed from: b */
    public final String m16950b() {
        return this.f23552j;
    }

    /* renamed from: c */
    public final boolean m16949c() {
        return this.f23553k;
    }

    /* synthetic */ EnumC8966j(String str, boolean z, int i, DefaultConstructorMarker defaultConstructorMarker) {
