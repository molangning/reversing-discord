...
@Metadata(m14358d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0010\n\u0000\n\u0002\u0010\u000e\n\u0002\b\n\b\u0087\u0001\u0018\u0000 \u000b2\b\u0012\u0004\u0012\u00020\u00000\u0001:\u0002\u000b\fB\u000f\b\u0002\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004R\u0011\u0010\u0002\u001a\u00020\u0003¢\u0006\b\n\u0000\u001a\u0004\b\u0005\u0010\u0006j\u0002\b\u0007j\u0002\b\bj\u0002\b\tj\u0002\b\n¨\u0006\r"}, m14357d2 = {"Lcom/discord/chat/bridge/contentnode/StaticChannelMentionType;", "", "channelId", "", "(Ljava/lang/String;ILjava/lang/String;)V", "getChannelId", "()Ljava/lang/String;", "Home", "Customize", "Browse", "Unknown", "Companion", "Serializer", "chat_release"}, m14356k = 1, m14355mv = {1, 8, 0}, m14353xi = 48)
...
public enum StaticChannelMentionType {
    ...
    @Metadata(m14358d1 = {"\u0000\u001e\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u000e\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u0006J\u000f\u0010\u0007\u001a\b\u0012\u0004\u0012\u00020\u00040\bHÆ\u0001¨\u0006\t"}, m14357d2 = {"Lcom/discord/chat/bridge/contentnode/StaticChannelMentionType$Companion;", "", "()V", "fromValue", "Lcom/discord/chat/bridge/contentnode/StaticChannelMentionType;", "channelId", "", "serializer", "Lkotlinx/serialization/KSerializer;", "chat_release"}, m14356k = 1, m14355mv = {1, 8, 0}, m14353xi = 48)
    /* loaded from: /home/user/temp/discord/apk/extracted/_base.apk/classes8.dex */
        ...
        public final StaticChannelMentionType fromValue(String channelId) {
            ...
            while (true) {
                if (i < length) {
                    ...
                    if (C9612q.m13922c(staticChannelMentionType.getChannelId(), channelId)) {
                        break;
                    }
                    i++;
                } else {
    ...
    public static final class Serializer implements KSerializer<StaticChannelMentionType> {
        ...
        public SerialDescriptor getDescriptor() {
            return C2340g.m33640a("StaticChannelMentionType", AbstractC2325e.C2334i.f6445a);
        }

        @Override // kotlinx.serialization.DeserializationStrategy
        public StaticChannelMentionType deserialize(Decoder decoder) {
            C9612q.m13917h(decoder, "decoder");
            return StaticChannelMentionType.Companion.fromValue(decoder.mo12909z());
        }
        ...
        public void serialize(Encoder encoder, StaticChannelMentionType value) {
            ...
            encoder.mo12903F(value.getChannelId());
        }
    }

    static {
        Lazy<KSerializer<Object>> m7600b;
        m7600b = C11577n.m7600b(EnumC11580p.PUBLICATION, StaticChannelMentionType$Companion$$cachedSerializer$delegate$1.INSTANCE);
