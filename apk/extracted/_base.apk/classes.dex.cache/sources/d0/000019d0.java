...
public final class ScreenCapturer extends ScreenCapturerAndroid {
    ...
    private final Rect currMeasuredSize;
    ...
    @Metadata(m14358d1 = {"\u0000(\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0004\n\u0002\u0010\u000e\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0010\u0010\n\u001a\u00020\u00042\u0006\u0010\u000b\u001a\u00020\u0004H\u0002J\u0010\u0010\f\u001a\u00020\r2\u0006\u0010\u000e\u001a\u00020\u000fH\u0002R\u000e\u0010\u0003\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000R\u000e\u0010\u0006\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000R\u000e\u0010\u0007\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000R\u000e\u0010\b\u001a\u00020\tX\u0082T¢\u0006\u0002\n\u0000¨\u0006\u0010"}, m14357d2 = {"Lcom/discord/media/engine/video/screen_capture/ScreenCapturer$Companion;", "", "()V", "AUDIO_FORMAT", "", "CHANNEL_CONFIG", "MIN_REPEAT_FRAMERATE", "SAMPLING_RATE_IN_HZ", "TAG", "", "closestMod16", "n", "getScreenSize", "Landroid/graphics/Rect;", "context", "Landroid/content/Context;", "media_engine_release"}, m14356k = 1, m14355mv = {1, 8, 0}, m14353xi = 48)
    /* loaded from: /home/user/temp/discord/apk/extracted/_base.apk/classes6.dex */
    ...
    @Metadata(m14358d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\b\u0016\u0018\u00002\u00020\u0001B\u0005¢\u0006\u0002\u0010\u0002J\b\u0010\u0003\u001a\u00020\u0004H\u0016¨\u0006\u0005"}, m14357d2 = {"Lcom/discord/media/engine/video/screen_capture/ScreenCapturer$OnStopCallback;", "Landroid/media/projection/MediaProjection$Callback;", "()V", "onStop", "", "media_engine_release"}, m14356k = 1, m14355mv = {1, 8, 0}, m14353xi = 48)
    /* loaded from: /home/user/temp/discord/apk/extracted/_base.apk/classes6.dex */
    ...
    @Metadata(m14358d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\b\u0082\u0004\u0018\u00002\u00020\u0001B\u0005¢\u0006\u0002\u0010\u0002J\b\u0010\u0003\u001a\u00020\u0004H\u0016¨\u0006\u0005"}, m14357d2 = {"Lcom/discord/media/engine/video/screen_capture/ScreenCapturer$Watchdog;", "Ljava/lang/Runnable;", "(Lcom/discord/media/engine/video/screen_capture/ScreenCapturer;)V", "run", "", "media_engine_release"}, m14356k = 1, m14355mv = {1, 8, 0}, m14353xi = 48)
    /* loaded from: /home/user/temp/discord/apk/extracted/_base.apk/classes6.dex */
    public final class Watchdog implements Runnable {
        public Watchdog() {
            ScreenCapturer.this = r1;
        }
    ...
    public ScreenCapturer(Intent mediaProjectionPermissionResultData) {
        ...
        C9612q.m13917h(mediaProjectionPermissionResultData, "mediaProjectionPermissionResultData");
        this.watchdog = new Watchdog();
        this.soundshare = new SoundshareAudioSource();
        this.lastMeasuredSize = new Rect();
        this.currMeasuredSize = new Rect();
    ...
    private final AudioRecord createRecorder() {
        ...
        C9612q.m13918g(build, "Builder(mediaProjection)…\n                .build()");
        try {
            ...
            Log.INSTANCE.m31912e(TAG, "Failed to record audio", e);
            return null;
        }
    }
    ...
    public final synchronized void changeCaptureFormatInternal(Rect measuredSize, int i) {
        C9612q.m13917h(measuredSize, "measuredSize");
    ...
    public void createVirtualDisplay() {
        try {
            ...
            Log.INSTANCE.m31912e(TAG, "error in createVirtualDisplay", th2);
        }
    }
    ...
    public synchronized void initialize(SurfaceTextureHelper surfaceTextureHelper, Context applicationContext, CapturerObserver capturerObserver) {
        C9612q.m13917h(surfaceTextureHelper, "surfaceTextureHelper");
        C9612q.m13917h(applicationContext, "applicationContext");
        C9612q.m13917h(capturerObserver, "capturerObserver");
    ...
    public void onFrame(VideoFrame videoFrame) {
        if (videoFrame != null) {
            ...
            if (context == null) {
                C9612q.m13900y("context");
                context = null;
            }
            rect.set(companion.getScreenSize(context));
            if (!C9612q.m13922c(this.currMeasuredSize, this.lastMeasuredSize)) {
    ...
    public final void scheduleWatchdog() {
        if (this.framerate > 0) {
            ...
            if (surfaceTextureHelper == null) {
                C9612q.m13900y("surfaceTextureHelper");
