...
public class InspectorPackagerConnection {
    ...
    /* loaded from: /home/user/temp/discord/apk/extracted/_base.apk/classes3.dex */
    public class Connection extends AbstractC12317s {
        ...
        public Connection(String str) {
            InspectorPackagerConnection.this = r1;
            this.mUrl = str;
        }

        private void abort(String str, Throwable th2) {
            C13677a.m1853k(InspectorPackagerConnection.TAG, "Error occurred, shutting down websocket connection: " + str, th2);
        ...
        private void reconnect() {
            if (!this.mClosed) {
                if (!this.mSuppressConnectionErrors) {
                    C13677a.m1870H(InspectorPackagerConnection.TAG, "Couldn't connect to packager, will silently retry");
        ...
        public void connect() {
            if (!this.mClosed) {
                ...
                this.mHttpClient.m8824C(new Request.Builder().m8722l(this.mUrl).m8732b(), this);
                return;
            }
            ...
            new AsyncTask<WebSocket, Void, Void>() { // from class: com.facebook.react.devsupport.InspectorPackagerConnection.Connection.2
                ...
                public Void doInBackground(WebSocket... webSocketArr) {
                    if (webSocketArr != null && webSocketArr.length != 0) {
                        try {
                            webSocketArr[0].mo8660b(jSONObject.toString());
                        } catch (Exception e) {
                            C13677a.m1869I(InspectorPackagerConnection.TAG, "Couldn't send event to packager", e);
                        }
                    }
                    return null;
                }
    ...
    private void handleConnect(JSONObject jSONObject) {
        ...
        if (this.mInspectorConnections.remove(string) == null) {
            try {
                ...
                C13677a.m1869I(TAG, "Failed to open page: " + string, e);
    ...
    private void handleWrappedEvent(JSONObject jSONObject) {
        ...
        if (localConnection == null) {
            C13677a.m1870H(TAG, "PageID " + string + " is disconnected. Dropping event: " + string2);
            return;
        }
