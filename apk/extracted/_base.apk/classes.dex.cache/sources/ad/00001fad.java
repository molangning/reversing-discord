...
public final class CodeRules$createInlineCodeRule$1<R, S> extends Rule<R, Node<R>, S> {
    ...
    public ParseSpec<R, S> parse(Matcher matcher, Parser<R, ? super Node<R>, S> parser, S s) {
        ...
        return ParseSpec.Companion.createTerminal(new Node.Parent<R>(new Node[]{codeNode}) { // from class: com.discord.simpleast.code.CodeRules$createInlineCodeRule$1$parse$node$1
