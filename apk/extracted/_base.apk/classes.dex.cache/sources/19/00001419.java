...
public final class AudioWaveView extends View {
    ...
    private static final int FINISH_ANIMATION_NUM_REPEAT;
    ...
    @Metadata(m14358d1 = {"\u0000&\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u0007\n\u0000\n\u0002\u0010\b\n\u0002\b\t\n\u0002\u0010\u000b\n\u0002\b\u0003\n\u0002\u0010\u000e\n\u0000\b\u0086\b\u0018\u00002\u00020\u0001B\u0015\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0005¢\u0006\u0002\u0010\u0006J\t\u0010\u000b\u001a\u00020\u0003HÆ\u0003J\t\u0010\f\u001a\u00020\u0005HÆ\u0003J\u001d\u0010\r\u001a\u00020\u00002\b\b\u0002\u0010\u0002\u001a\u00020\u00032\b\b\u0002\u0010\u0004\u001a\u00020\u0005HÆ\u0001J\u0013\u0010\u000e\u001a\u00020\u000f2\b\u0010\u0010\u001a\u0004\u0018\u00010\u0001HÖ\u0003J\t\u0010\u0011\u001a\u00020\u0005HÖ\u0001J\t\u0010\u0012\u001a\u00020\u0013HÖ\u0001R\u0011\u0010\u0004\u001a\u00020\u0005¢\u0006\b\n\u0000\u001a\u0004\b\u0007\u0010\bR\u0011\u0010\u0002\u001a\u00020\u0003¢\u0006\b\n\u0000\u001a\u0004\b\t\u0010\n¨\u0006\u0014"}, m14357d2 = {"Lcom/discord/chat/presentation/message/view/voicemessages/AudioWaveView$ProgressEvent;", "", "progress", "", "eventAction", "", "(FI)V", "getEventAction", "()I", "getProgress", "()F", "component1", "component2", "copy", "equals", "", "other", "hashCode", "toString", "", "chat_release"}, m14356k = 1, m14355mv = {1, 8, 0}, m14353xi = 48)
    /* loaded from: /home/user/temp/discord/apk/extracted/_base.apk/classes8.dex */
    ...
    static {
        ...
        MAX_DURATION = Duration.m13633p(C9662a.m13604s(30, EnumC12982c.SECONDS));
        MIN_WIDTH = i * 5;
        MAX_WIDTH = SizeUtilsKt.getDpToPx(600);
        FINISH_ANIMATION_NUM_REPEAT = 10;
    }
    ...
    private final void finishAnimation() {
        ...
        m13179d = C9818l.m13179d(CoroutineViewUtilsKt.getAttachedScope(this), null, null, new AudioWaveView$finishAnimation$1(this, null), 3, null);
        this.animationJob = m13179d;
    }
    ...
    private final void recalculateSampleData(byte[] bArr, int i, boolean z) {
        if (z && i != this.downSampleData.length) {
            C9818l.m13179d(CoroutineViewUtilsKt.getAttachedScope(this), null, null, new AudioWaveView$recalculateSampleData$1(this, bArr, i, null), 3, null);
        } else {
            invalidate();
        }
    }
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        m21930c = C6759j.m21930c((getWidth() / i6) + i5, 5);
        setNumChunks(m21930c);
    ...
    */
    protected void onMeasure(int r6, int r7) {
        ...
        L1d:
            ...
            int r0 = androidx.core.view.C1363w.m37271b(r0)
            goto L3a
        L39:
            r0 = r3
        L3a:
            ...
            if (r1 == 0) goto L49
            android.view.ViewGroup$MarginLayoutParams r0 = (android.view.ViewGroup.MarginLayoutParams) r0
            int r3 = androidx.core.view.C1363w.m37272a(r0)
        L49:
            int r6 = r6 - r3
            float r6 = (float) r6
            float r6 = r6 * r2
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        m21924i = C6759j.m21924i(event.getX(), 0.0f, getWidth());
        float width = m21924i / getWidth();
