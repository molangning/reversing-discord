...
public abstract class ViewManager<T extends View, C extends ReactShadowNode> extends BaseJavaModule {
    ...
    public void onDropViewInstance(T t) {
        ...
        if (context == null) {
            String str = NAME;
            C13677a.m1854j(str, "onDropViewInstance: view [" + t.getId() + "] has a null context");
        } else if (!(context instanceof ThemedReactContext)) {
            String str2 = NAME;
            C13677a.m1854j(str2, "onDropViewInstance: view [" + t.getId() + "] has a context that is not a ThemedReactContext: " + context);
        } else {
