...
public final class RtcpStats {
    ...
    public int hashCode() {
        return (((((((((((this.fractionLost * 31) + this.packetsLost) * 31) + C2689b.m32716a(this.firPackets)) * 31) + C2689b.m32716a(this.nackPackets)) * 31) + C2689b.m32716a(this.nackRequests)) * 31) + C2689b.m32716a(this.pliPackets)) * 31) + C2689b.m32716a(this.uniqueNackRequests);
    }

    public String toString() {
        int i = this.fractionLost;
        int i2 = this.packetsLost;
        long j = this.firPackets;
        long j2 = this.nackPackets;
        long j3 = this.nackRequests;
        long j4 = this.pliPackets;
        long j5 = this.uniqueNackRequests;
        return "RtcpStats(fractionLost=" + i + ", packetsLost=" + i2 + ", firPackets=" + j + ", nackPackets=" + j2 + ", nackRequests=" + j3 + ", pliPackets=" + j4 + ", uniqueNackRequests=" + j5 + ")";
    }
}