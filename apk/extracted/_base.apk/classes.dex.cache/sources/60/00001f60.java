...
public final class SegmentedControlView extends FrameLayout {
    ...
    private final TextView getLabelView(final int i) {
        ...
        if (textView == null) {
            ...
            C1365w0.m37185q0(textView2, new C1170a() { // from class: com.discord.segmented.control.SegmentedControlView$getLabelView$1$1
                ...
                public void onInitializeAccessibilityNodeInfo(View host, AccessibilityNodeInfoCompat info) {
                    ...
                    info.m37636E0(z);
                    info.m37642B0(this.getAccessibilityRoleDescriptions().get(i));
                }
            });
    ...
    private final void maybeUpdateSegmentWidth() {
        ...
        if (this.segmentWidth != i) {
            ...
            C9612q.m13918g(cardView, "binding.selectedSegmentBg");
    ...
    private final <T> ReadWriteProperty<Object, T> updateViewOnChange(T t, final boolean z) {
        C9622a c9622a = C9622a.f25358a;
        return new AbstractC9624c<T>(t) { // from class: com.discord.segmented.control.SegmentedControlView$updateViewOnChange$$inlined$observable$1
    ...
    public SegmentedControlView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.labels$delegate = updateViewOnChange(m14104i, true);
        m14104i2 = C9545j.m14104i();
        this.accessibilityRoleDescriptions$delegate = updateViewOnChange(m14104i2, true);
    }
}