...
public class MountItemDispatcher {
    ...
    private void executeOrEnqueue(MountItem mountItem) {
        if (this.mMountingManager.isWaitingForViewAttach(mountItem.getSurfaceId())) {
            if (FabricUIManager.ENABLE_FABRIC_LOGS) {
                C13677a.m1852l(TAG, "executeOrEnqueue: Item execution delayed, surface %s is not ready yet", Integer.valueOf(mountItem.getSurfaceId()));
            }
    ...
    public void dispatchPreMountItems(long j) {
        ...
        C7382a.m20813c(0L, "FabricUIManager::premountViews");
    ...
    private boolean dispatchMountItems() {
        ...
        if (andResetViewCommandMountItems != null) {
            C7382a.m20813c(0L, "FabricUIManager::mountViews viewCommandMountItems");
        ...
        if (andResetPreMountItems != null) {
            C7382a.m20813c(0L, "FabricUIManager::mountViews preMountItems");
        ...
        if (andResetMountItems != null) {
            C7382a.m20813c(0L, "FabricUIManager::mountViews mountItems to execute");
