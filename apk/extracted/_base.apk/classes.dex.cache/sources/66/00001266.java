...
public final class MessageBundleView$setBundle$2 extends AbstractC9614s implements Function1<MessageId, Unit> {
    ...
    public /* bridge */ /* synthetic */ Unit invoke(MessageId messageId) {
        m41630invoke1xi1bu0(messageId.m42081unboximpl());
        return Unit.f25302a;
    }

    /* renamed from: invoke-1xi1bu0 */
    public final void m41630invoke1xi1bu0(String it) {
        C9612q.m13917h(it, "it");
        this.$onTapReply.invoke(MessageId.m42073boximpl(it));
    }
}