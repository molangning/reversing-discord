...
public class C9038b extends AbstractC9050n<Float, Float> {
    public C9038b(List<C12020a<Float>> list) {
        super(list);
    }

    @Override // p188k1.InterfaceC9049m
    /* renamed from: a */
    public AbstractC6861a<Float, Float> mo16817a() {
        return new C6871d(this.f23714a);
    }
