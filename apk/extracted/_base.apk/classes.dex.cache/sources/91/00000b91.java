...
final class InboundAudio {
    ...
    public InboundAudio(long j, long j2, double d, double d2, int i, Integer[] mosBuckets, InboundBufferStats bufferStats, InboundFrameOpStats frameOpStats) {
        C9612q.m13917h(mosBuckets, "mosBuckets");
        C9612q.m13917h(bufferStats, "bufferStats");
        C9612q.m13917h(frameOpStats, "frameOpStats");
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof InboundAudio) {
            ...
            return this.packetsReceived == inboundAudio.packetsReceived && this.packetsLost == inboundAudio.packetsLost && Double.compare(this.mos, inboundAudio.mos) == 0 && Double.compare(this.mosSum, inboundAudio.mosSum) == 0 && this.mosCount == inboundAudio.mosCount && C9612q.m13922c(this.mosBuckets, inboundAudio.mosBuckets) && C9612q.m13922c(this.bufferStats, inboundAudio.bufferStats) && C9612q.m13922c(this.frameOpStats, inboundAudio.frameOpStats);
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((((((((((((C2689b.m32716a(this.packetsReceived) * 31) + C2689b.m32716a(this.packetsLost)) * 31) + C2690c.m32715a(this.mos)) * 31) + C2690c.m32715a(this.mosSum)) * 31) + this.mosCount) * 31) + Arrays.hashCode(this.mosBuckets)) * 31) + this.bufferStats.hashCode()) * 31) + this.frameOpStats.hashCode();
    }

    public String toString() {
        long j = this.packetsReceived;
        long j2 = this.packetsLost;
        double d = this.mos;
        double d2 = this.mosSum;
        int i = this.mosCount;
        String arrays = Arrays.toString(this.mosBuckets);
        InboundBufferStats inboundBufferStats = this.bufferStats;
        InboundFrameOpStats inboundFrameOpStats = this.frameOpStats;
        return "InboundAudio(packetsReceived=" + j + ", packetsLost=" + j2 + ", mos=" + d + ", mosSum=" + d2 + ", mosCount=" + i + ", mosBuckets=" + arrays + ", bufferStats=" + inboundBufferStats + ", frameOpStats=" + inboundFrameOpStats + ")";
    }
}