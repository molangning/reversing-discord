...
public final class InteractionStatus {
    ...
    @Metadata(m14358d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u000f\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004HÆ\u0001¨\u0006\u0006"}, m14357d2 = {"Lcom/discord/chat/bridge/interaction/InteractionStatus$Companion;", "", "()V", "serializer", "Lkotlinx/serialization/KSerializer;", "Lcom/discord/chat/bridge/interaction/InteractionStatus;", "chat_release"}, m14356k = 1, m14355mv = {1, 8, 0}, m14353xi = 48)
    /* loaded from: /home/user/temp/discord/apk/extracted/_base.apk/classes8.dex */
    ...
    public /* synthetic */ InteractionStatus(int i, InteractionStatusViewState interactionStatusViewState, StructurableText structurableText, SerializationConstructorMarker serializationConstructorMarker) {
        if (3 != (i & 3)) {
            C2620n1.m32836b(i, 3, InteractionStatus$$serializer.INSTANCE.getDescriptor());
        }
    ...
    public static final void write$Self(InteractionStatus self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.mo12894i(serialDesc, 0, InteractionStatusViewState.Serializer.INSTANCE, self.state);
        output.mo12894i(serialDesc, 1, StructurableTextSerializer.INSTANCE, self.text);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof InteractionStatus) {
            ...
            return this.state == interactionStatus.state && C9612q.m13922c(this.text, interactionStatus.text);
        }
        return false;
    }
