...
public final class Screenshare {
    ...
    public String toString() {
        int i = this.capturedFramesDropped;
        int i2 = this.capturedFramesCount;
        int i3 = this.capturedFramesMean;
        int i4 = this.capturedFramesStdev;
        return "Screenshare(capturedFramesDropped=" + i + ", capturedFramesCount=" + i2 + ", capturedFramesMean=" + i3 + ", capturedFramesStdev=" + i4 + ")";
    }
}