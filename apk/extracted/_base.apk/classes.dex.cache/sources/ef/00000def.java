...
public final class DCDPackageList extends PackageList {
    ...
    public ArrayList<ReactPackage> getPackages() {
        ...
        packages.add(dCDModuleProvider.getTurboPackageForModule("RTNNativePushNotificationMonitor", DCDPackageList$getPackages$82.INSTANCE));
        C9612q.m13918g(packages, "packages");
        return packages;
    }
}