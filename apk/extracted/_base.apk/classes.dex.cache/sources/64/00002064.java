...
public final class RLottieImageView extends com.discord.rlottie.RLottieImageView {
    ...
    public static final class Config {
        ...
        public static /* synthetic */ Config copy$default(Config config, String str, boolean z, int i, int i2, String str2, int i3, int i4, Object obj) {
            ...
            return config.copy(str, z2, i5, i6, str3, i3);
        }
        ...
        public boolean equals(Object obj) {
            ...
            if (obj instanceof Config) {
                ...
                return C9612q.m13922c(this.url, config.url) && this.animate == config.animate && this.widthDp == config.widthDp && this.heightDp == config.heightDp && C9612q.m13922c(this.asset, config.asset) && this.renderMode == config.renderMode;
            }
            return false;
        }
    ...
    public RLottieImageView(Context context) {
        ...
        this.rLottieStateManager = new AnimatedImageStateManager<>(new RLottieImageView$rLottieStateManager$1(this), new RLottieImageView$rLottieStateManager$2(this), new RLottieImageView$rLottieStateManager$3(this), new RLottieImageView$rLottieStateManager$4(this), new RLottieImageView$rLottieStateManager$5(this));
    }

    public final void fetchSticker(Config config) {
        C9818l.m13179d(CoroutineViewUtilsKt.getAttachedScope(this), C9677b1.m13569b(), null, new RLottieImageView$fetchSticker$1(this, config, null), 2, null);
    }
