...
public enum EnumC11651f {
    ...
    /* renamed from: a */
    private static double m7352a(int i, double d) {
        double d2;
        double d3;
        if (i < -2000 || i > 3000) {
    ...
    /* renamed from: b */
    public static double m7351b(int i, int i2) {
        if (i2 >= 1 && i2 <= 12) {
            return m7352a(i, i + ((i2 - 0.5d) / 12.0d));
        }
        throw new IllegalArgumentException("Month out of range: " + i2);
    }

    /* renamed from: c */
    public static double m7350c(InterfaceC10614a interfaceC10614a) {
        int i;
        int mo10482o = interfaceC10614a.mo10482o();
        if (C10615b.m11050e(mo10482o)) {
            i = 366;
        } else {
            i = 365;
        }
        ...
        int i2 = 1;
        int i3 = 0;
        for (int i4 = 1; i4 < mo10481p; i4++) {
            i3 += C10615b.m11051d(mo10482o, i4);
        }
        int mo10480r = i3 + interfaceC10614a.mo10480r();
        if (mo10480r <= i) {
            if (mo10482o == -2001 && mo10480r == 365) {
                mo10482o = -2000;
            } else {
                i2 = mo10480r;
            }
            return m7352a(mo10482o, mo10482o + ((i2 - 1.0d) / i));
        }
        throw new IllegalArgumentException(interfaceC10614a.toString());
    }
}