...
public class DialogModule extends NativeDialogManagerAndroidSpec implements LifecycleEventListener {
    ...
    static final Map<String, Object> CONSTANTS = MapBuilder.m30466of(ACTION_BUTTON_CLICKED, ACTION_BUTTON_CLICKED, "dismissed", "dismissed", KEY_BUTTON_POSITIVE, -1, KEY_BUTTON_NEGATIVE, -2, KEY_BUTTON_NEUTRAL, -3);
    ...
    public class FragmentManagerHelper {
        ...
        private void dismissExisting() {
            ...
            if (DialogModule.this.mIsInForeground && (alertFragment = (AlertFragment) this.mFragmentManager.m36414j0(DialogModule.FRAGMENT_TAG)) != null && alertFragment.isResumed()) {
        ...
        public void showNewAlert(Bundle bundle, Callback callback) {
            ...
            if (DialogModule.this.mIsInForeground && !this.mFragmentManager.m36469M0()) {
    ...
    public void onHostResume() {
        ...
        if (fragmentManagerHelper != null) {
            ...
            C13677a.m1874D(DialogModule.class, "onHostResume called but no FragmentManager found");
        }
    }
