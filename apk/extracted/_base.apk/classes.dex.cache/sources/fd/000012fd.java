...
public final class FileAttachmentMessageAccessory extends MessageAccessory {
    ...
    */
    ...
    /* renamed from: copy-dB0-bEw$default */
    public static /* synthetic */ FileAttachmentMessageAccessory m41680copydB0bEw$default(FileAttachmentMessageAccessory fileAttachmentMessageAccessory, String str, int i, Attachment attachment, SpoilerAttributes spoilerAttributes, String str2, String str3, Float f, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            str = fileAttachmentMessageAccessory.mo41659getMessageId3Eiw7ao();
        }
        if ((i2 & 2) != 0) {
        ...
        return fileAttachmentMessageAccessory.m41682copydB0bEw(str, i3, attachment2, spoilerAttributes2, str4, str5, f);
    }

    /* renamed from: component1-3Eiw7ao */
    public final String m41681component13Eiw7ao() {
    ...
    /* renamed from: copy-dB0-bEw */
    public final FileAttachmentMessageAccessory m41682copydB0bEw(String messageId, int i, Attachment attachment, SpoilerAttributes spoilerAttributes, String str, String str2, Float f) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof FileAttachmentMessageAccessory) {
            ...
            return MessageId.m42077equalsimpl0(mo41659getMessageId3Eiw7ao(), fileAttachmentMessageAccessory.mo41659getMessageId3Eiw7ao()) && this.attachmentIndex == fileAttachmentMessageAccessory.attachmentIndex && C9612q.m13922c(this.attachment, fileAttachmentMessageAccessory.attachment) && C9612q.m13922c(this.spoilerAttributes, fileAttachmentMessageAccessory.spoilerAttributes) && C9612q.m13922c(this.uploaderId, fileAttachmentMessageAccessory.uploaderId) && C9612q.m13922c(this.uploaderItemId, fileAttachmentMessageAccessory.uploaderItemId) && C9612q.m13922c(this.attachmentsOpacity, fileAttachmentMessageAccessory.attachmentsOpacity);
        }
        return false;
    }
    ...
    public int hashCode() {
        int m42078hashCodeimpl = ((((MessageId.m42078hashCodeimpl(mo41659getMessageId3Eiw7ao()) * 31) + this.attachmentIndex) * 31) + this.attachment.hashCode()) * 31;
    ...
    public String toString() {
        ...
        String str2 = this.uploaderItemId;
        Float f = this.attachmentsOpacity;
        return "FileAttachmentMessageAccessory(messageId=" + m42079toStringimpl + ", attachmentIndex=" + i + ", attachment=" + attachment + ", spoilerAttributes=" + spoilerAttributes + ", uploaderId=" + str + ", uploaderItemId=" + str2 + ", attachmentsOpacity=" + f + ")";
    }
}