...
public final class OnTruncateMessageData implements ReactEvent {
    ...
    @Metadata(m14358d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u000f\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004HÆ\u0001¨\u0006\u0006"}, m14357d2 = {"Lcom/discord/chat/reactevents/OnTruncateMessageData$Companion;", "", "()V", "serializer", "Lkotlinx/serialization/KSerializer;", "Lcom/discord/chat/reactevents/OnTruncateMessageData;", "chat_release"}, m14356k = 1, m14355mv = {1, 8, 0}, m14353xi = 48)
    /* loaded from: /home/user/temp/discord/apk/extracted/_base.apk/classes8.dex */
    ...
    private OnTruncateMessageData(int i, String str, SerializationConstructorMarker serializationConstructorMarker) {
        if (1 != (i & 1)) {
            C2620n1.m32836b(i, 1, OnTruncateMessageData$$serializer.INSTANCE.getDescriptor());
        }
        this.messageId = str;
    }
    ...
    public static /* synthetic */ OnTruncateMessageData m41833copy1xi1bu0$default(OnTruncateMessageData onTruncateMessageData, String str, int i, Object obj) {
        if ((i & 1) != 0) {
            str = onTruncateMessageData.messageId;
        }
        return onTruncateMessageData.m41835copy1xi1bu0(str);
    }
    ...
    public final String m41834component13Eiw7ao() {
        return this.messageId;
    }

    /* renamed from: copy-1xi1bu0 */
    public final OnTruncateMessageData m41835copy1xi1bu0(String messageId) {
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof OnTruncateMessageData) && MessageId.m42077equalsimpl0(this.messageId, ((OnTruncateMessageData) obj).messageId);
    }

    /* renamed from: getMessageId-3Eiw7ao */
    public final String m41836getMessageId3Eiw7ao() {
        return this.messageId;
    }
    ...
    public String toString() {
        ...
        return "OnTruncateMessageData(messageId=" + m42079toStringimpl + ")";
    }
