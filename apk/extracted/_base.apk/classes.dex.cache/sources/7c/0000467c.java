...
public final class Request {
    ...
    public static class Builder {
        ...
        public Builder m8722l(String url) {
            ...
            boolean m13760F2;
            C9612q.m13917h(url, "url");
            m13760F = C9653o.m13760F(url, "ws:", true);
            if (m13760F) {
                StringBuilder sb2 = new StringBuilder();
                sb2.append("http:");
                ...
                m13760F2 = C9653o.m13760F(url, "wss:", true);
                if (m13760F2) {
        ...
        public Builder(Request request) {
            ...
            if (request.m8743c().isEmpty()) {
                m6740v = new LinkedHashMap<>();
            } else {
                m6740v = C11889v.m6740v(request.m8743c());
            }
            this.f29419e = m6740v;
