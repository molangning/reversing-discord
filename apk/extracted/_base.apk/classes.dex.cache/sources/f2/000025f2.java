...
public class FpsDebugFrameCallback extends ChoreographerCompat.FrameCallback {
    ...
    public FpsDebugFrameCallback(ReactContext reactContext) {
        ...
        this.mUIManagerModule = (UIManagerModule) C5743a.m24583c((UIManagerModule) reactContext.getNativeModule(UIManagerModule.class));
    }
    ...
    public void doFrame(long j) {
        ...
        if (this.mIsRecordingFpsInfoAtEachFrame) {
            C5743a.m24583c(this.mTimeToFps);
    ...
    public FpsInfo getFpsInfo(long j) {
        C5743a.m24582d(this.mTimeToFps, "FPS was not recorded at each frame!");
