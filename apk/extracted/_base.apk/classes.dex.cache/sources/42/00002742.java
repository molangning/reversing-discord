...
public class TouchesHelper {
    ...
    /* loaded from: /home/user/temp/discord/apk/extracted/_base.apk/classes3.dex */
    public static /* synthetic */ class C42191 {
    ...
    public static void sendTouchEvent(RCTModernEventEmitter rCTModernEventEmitter, TouchEvent touchEvent) {
        ...
        C7382a.m20813c(0L, "TouchesHelper.sentTouchEventModern(" + touchEvent.getEventName() + ")");
        ...
        int i = C42191.$SwitchMap$com$facebook$react$uimanager$events$TouchEventType[touchEventType.ordinal()];
        if (i != 1) {
            if (i != 2) {
                if (i != 3) {
                    if (i != 4) {
