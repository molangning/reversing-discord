...
public final class RtpStats {
    ...
    public RtpStats(PacketStats fec, PacketStats retransmitted, PacketStats transmitted) {
        C9612q.m13917h(fec, "fec");
        C9612q.m13917h(retransmitted, "retransmitted");
        C9612q.m13917h(transmitted, "transmitted");
        this.fec = fec;
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof RtpStats) {
            ...
            return C9612q.m13922c(this.fec, rtpStats.fec) && C9612q.m13922c(this.retransmitted, rtpStats.retransmitted) && C9612q.m13922c(this.transmitted, rtpStats.transmitted);
        }
        return false;
    }
    ...
    public String toString() {
        ...
        return "RtpStats(fec=" + packetStats + ", retransmitted=" + packetStats2 + ", transmitted=" + packetStats3 + ")";
    }
}