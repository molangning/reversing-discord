...
public class EventDispatcherImpl implements EventDispatcher, LifecycleEventListener {
    ...
    public class DispatchEventsRunnable implements Runnable {
        private DispatchEventsRunnable() {
            EventDispatcherImpl.this = r1;
        }

        @Override // java.lang.Runnable
        public void run() {
            C7382a.m20813c(0L, "DispatchEventsRunnable");
            try {
                C7382a.m20812d(0L, "ScheduleDispatchFrameCallback", EventDispatcherImpl.this.mHasDispatchScheduledCount.getAndIncrement());
                EventDispatcherImpl.this.mHasDispatchScheduled = false;
                C5743a.m24583c(EventDispatcherImpl.this.mReactEventEmitter);
                synchronized (EventDispatcherImpl.this.mEventsToDispatchLock) {
                    if (EventDispatcherImpl.this.mEventsToDispatchSize > 0) {
                        ...
                        for (int i = 0; i < EventDispatcherImpl.this.mEventsToDispatchSize; i++) {
                            ...
                            if (event != null) {
                                C7382a.m20812d(0L, event.getEventName(), event.getUniqueID());
    ...
    public class ScheduleDispatchFrameCallback extends ChoreographerCompat.FrameCallback {
        ...
        public void doFrame(long j) {
            ...
            C7382a.m20813c(0L, "ScheduleDispatchFrameCallback");
            try {
                ...
                if (!EventDispatcherImpl.this.mHasDispatchScheduled) {
                    ...
                    C7382a.m20806j(0L, "ScheduleDispatchFrameCallback", EventDispatcherImpl.this.mHasDispatchScheduledCount.get());
    ...
    public void dispatchEvent(Event event) {
        C5743a.m24584b(event.isInitialized(), "Dispatched event hasn't been initialized");
        ...
        synchronized (this.mEventsStagingLock) {
            ...
            C7382a.m20806j(0L, event.getEventName(), event.getUniqueID());
        }
        maybePostFrameCallbackFromNonUI();
    }
