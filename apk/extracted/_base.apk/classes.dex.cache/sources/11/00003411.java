...
public class C6657k<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    /* renamed from: gb.k$e */
    /* loaded from: /home/user/temp/discord/apk/extracted/_base.apk/classes3.dex */
    public abstract class AbstractC6662e<T> implements Iterator<T>, p164j$.util.Iterator {
        ...
        private AbstractC6662e() {
            C6657k.this = r2;
            this.f18844j = r2.f18835n;
            this.f18845k = r2.m22203u();
            this.f18846l = -1;
        }
