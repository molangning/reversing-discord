...
public final class MobileVoiceOverlay {
    ...
    @Metadata(m14358d1 = {"\u0000(\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J \u0010\u0006\u001a\u00020\u00072\u0006\u0010\b\u001a\u00020\t2\u0006\u0010\n\u001a\u00020\u00042\b\b\u0002\u0010\u000b\u001a\u00020\fR\u000e\u0010\u0003\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000¨\u0006\r"}, m14357d2 = {"Lcom/discord/mobile_voice_overlay/MobileVoiceOverlay$Companion;", "", "()V", "ANCHOR_TAG", "", "JS_INTERFACE_NAME", "startHeadlessTask", "", "context", "Landroid/content/Context;", "taskName", "taskParams", "Landroid/os/Bundle;", "mobile_voice_overlay_release"}, m14356k = 1, m14355mv = {1, 8, 0}, m14353xi = 48)
    /* loaded from: /home/user/temp/discord/apk/extracted/_base.apk/classes6.dex */
    public static final class Companion {
        ...
        public final void startHeadlessTask(Context context, String taskName, Bundle taskParams) {
            ...
            HeadlessTasks.Companion.startHeadlessTask(context, taskName, (r18 & 4) != 0 ? 5000L : 0L, (r18 & 8) != 0, (r18 & 16) != 0 ? new Bundle() : taskParams, (r18 & 32) != 0 ? false : false);
        }
    }
    ...
    public MobileVoiceOverlay(ReactApplicationContext context) {
        ...
        this.voiceBubbleProvider = new OverlayViewProvider<>(new MobileVoiceOverlay$voiceBubbleProvider$1(this));
        this.trashWrapProvider = new OverlayViewProvider<>(new MobileVoiceOverlay$trashWrapProvider$1(this));
        this.menuDialogProvider = new OverlayViewProvider<>(new MobileVoiceOverlay$menuDialogProvider$1(this));
        this.selectorDialogProvider = new OverlayViewProvider<>(new MobileVoiceOverlay$selectorDialogProvider$1(this));
    }
