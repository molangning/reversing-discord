...
public class ColorPropConverter {
    ...
    private static int resolveResource(Context context, String str) {
        ...
        return C0980h.m38243d(context.getResources(), context.getResources().getIdentifier(split2[1], str2, packageName), context.getTheme());
    }
    ...
    public static Integer getColor(Object obj, Context context, int i) {
        try {
            ...
            C13677a.m1867K(ReactConstants.TAG, e, "Error converting ColorValue", new Object[0]);
