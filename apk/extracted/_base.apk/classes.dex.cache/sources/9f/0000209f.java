...
public final class LightTheme extends DiscordTheme {
    ...
    public LightTheme(Context context) {
        ...
        int i = C3511R.color.white_500;
        this.activityCardBackground = ColorUtilsKt.getColorCompat(context, i);
        int i2 = C3511R.color.primary_100;
        this.androidNavigationBarBackground = ColorUtilsKt.getColorCompat(context, i2);
        this.androidNavigationScrimBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.android_navigation_scrim_background_light);
        this.androidRipple = ColorUtilsKt.getColorCompat(context, C3511R.color.android_ripple_light);
        int i3 = C3511R.color.primary_430;
        ...
        this.backgroundMentioned = ColorUtilsKt.getColorCompat(context, C3511R.color.background_mentioned_light);
        this.backgroundMentionedHover = ColorUtilsKt.getColorCompat(context, C3511R.color.background_mentioned_hover_light);
        this.backgroundMessageAutomod = ColorUtilsKt.getColorCompat(context, C3511R.color.background_message_automod_light);
        this.backgroundMessageAutomodHover = ColorUtilsKt.getColorCompat(context, C3511R.color.background_message_automod_hover_light);
        this.backgroundMessageHighlight = ColorUtilsKt.getColorCompat(context, C3511R.color.background_message_highlight_light);
        this.backgroundMessageHighlightHover = ColorUtilsKt.getColorCompat(context, C3511R.color.background_message_highlight_hover_light);
        this.backgroundMessageHover = ColorUtilsKt.getColorCompat(context, C3511R.color.background_message_hover_light);
        ...
        this.backgroundModifierAccent = ColorUtilsKt.getColorCompat(context, C3511R.color.background_modifier_accent_light);
        this.backgroundModifierAccent2 = ColorUtilsKt.getColorCompat(context, C3511R.color.background_modifier_accent_2_light);
        this.backgroundModifierActive = ColorUtilsKt.getColorCompat(context, C3511R.color.background_modifier_active_light);
        this.backgroundModifierHover = ColorUtilsKt.getColorCompat(context, C3511R.color.background_modifier_hover_light);
        this.backgroundModifierSelected = ColorUtilsKt.getColorCompat(context, C3511R.color.background_modifier_selected_light);
        ...
        int i4 = C3511R.color.primary_130;
        this.backgroundSecondary = ColorUtilsKt.getColorCompat(context, i4);
        int i5 = C3511R.color.primary_160;
        this.backgroundSecondaryAlt = ColorUtilsKt.getColorCompat(context, i5);
        int i6 = C3511R.color.primary_200;
        this.backgroundTertiary = ColorUtilsKt.getColorCompat(context, i6);
        this.bgBackdrop = ColorUtilsKt.getColorCompat(context, C3511R.color.bg_backdrop_light);
        int i7 = C3511R.color.black_500;
        this.bgBackdropNoOpacity = ColorUtilsKt.getColorCompat(context, i7);
        this.bgBasePrimary = ColorUtilsKt.getColorCompat(context, i);
        this.bgBaseSecondary = ColorUtilsKt.getColorCompat(context, i4);
        this.bgBaseTertiary = ColorUtilsKt.getColorCompat(context, i5);
        this.bgModFaint = ColorUtilsKt.getColorCompat(context, C3511R.color.bg_mod_faint_light);
        this.bgModStrong = ColorUtilsKt.getColorCompat(context, C3511R.color.bg_mod_strong_light);
        this.bgModSubtle = ColorUtilsKt.getColorCompat(context, C3511R.color.bg_mod_subtle_light);
        this.bgSurfaceOverlay = ColorUtilsKt.getColorCompat(context, i);
        this.bgSurfaceOverlayTmp = ColorUtilsKt.getColorCompat(context, i4);
        this.bgSurfaceRaised = ColorUtilsKt.getColorCompat(context, i);
        this.black = ColorUtilsKt.getColorCompat(context, i7);
        this.blurFallback = ColorUtilsKt.getColorCompat(context, C3511R.color.blur_fallback_light);
        this.blurFallbackPressed = ColorUtilsKt.getColorCompat(context, C3511R.color.blur_fallback_pressed_light);
        this.borderFaint = ColorUtilsKt.getColorCompat(context, C3511R.color.border_faint_light);
        this.borderStrong = ColorUtilsKt.getColorCompat(context, C3511R.color.border_strong_light);
        this.borderSubtle = ColorUtilsKt.getColorCompat(context, C3511R.color.border_subtle_light);
        this.bugReporterModalSubmittingBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.bug_reporter_modal_submitting_background_light);
        this.buttonCreatorRevenueBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.teal_430);
        int i8 = C3511R.color.red_430;
        ...
        int i9 = C3511R.color.red_500;
        this.buttonDangerBackgroundHover = ColorUtilsKt.getColorCompat(context, i9);
        this.buttonOutlineBrandBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.button_outline_brand_background_light);
        ...
        this.buttonOutlineDangerBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.button_outline_danger_background_light);
        int i12 = C3511R.color.red_460;
        this.buttonOutlineDangerBackgroundActive = ColorUtilsKt.getColorCompat(context, i12);
        ...
        this.buttonOutlinePositiveBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.button_outline_positive_background_light);
        int i13 = C3511R.color.green_530;
        this.buttonOutlinePositiveBackgroundActive = ColorUtilsKt.getColorCompat(context, i13);
        int i14 = C3511R.color.green_430;
        this.buttonOutlinePositiveBackgroundHover = ColorUtilsKt.getColorCompat(context, i14);
        int i15 = C3511R.color.green_400;
        this.buttonOutlinePositiveBorder = ColorUtilsKt.getColorCompat(context, i15);
        this.buttonOutlinePositiveBorderActive = ColorUtilsKt.getColorCompat(context, i13);
        this.buttonOutlinePositiveBorderHover = ColorUtilsKt.getColorCompat(context, i14);
        ...
        this.buttonOutlinePrimaryBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.button_outline_primary_background_light);
        int i16 = C3511R.color.primary_600;
        this.buttonOutlinePrimaryBackgroundActive = ColorUtilsKt.getColorCompat(context, i16);
        int i17 = C3511R.color.primary_530;
        this.buttonOutlinePrimaryBackgroundHover = ColorUtilsKt.getColorCompat(context, i17);
        this.buttonOutlinePrimaryBorder = ColorUtilsKt.getColorCompat(context, i17);
        this.buttonOutlinePrimaryBorderActive = ColorUtilsKt.getColorCompat(context, i16);
        this.buttonOutlinePrimaryBorderHover = ColorUtilsKt.getColorCompat(context, i17);
        ...
        this.buttonPositiveBackground = ColorUtilsKt.getColorCompat(context, i14);
        this.buttonPositiveBackgroundActive = ColorUtilsKt.getColorCompat(context, i13);
        this.buttonPositiveBackgroundDisabled = ColorUtilsKt.getColorCompat(context, i14);
        this.buttonPositiveBackgroundHover = ColorUtilsKt.getColorCompat(context, i13);
        this.buttonSecondaryBackground = ColorUtilsKt.getColorCompat(context, i3);
        this.buttonSecondaryBackgroundActive = ColorUtilsKt.getColorCompat(context, i17);
        this.buttonSecondaryBackgroundDisabled = ColorUtilsKt.getColorCompat(context, i3);
        int i18 = C3511R.color.primary_500;
        this.buttonSecondaryBackgroundHover = ColorUtilsKt.getColorCompat(context, i18);
        this.cardGradientBg = ColorUtilsKt.getColorCompat(context, C3511R.color.card_gradient_bg_light);
        this.cardGradientPressedBg = ColorUtilsKt.getColorCompat(context, C3511R.color.card_gradient_pressed_bg_light);
        this.cardPrimaryBg = ColorUtilsKt.getColorCompat(context, i);
        this.cardPrimaryPressedBg = ColorUtilsKt.getColorCompat(context, i5);
        this.cardSecondaryBg = ColorUtilsKt.getColorCompat(context, i);
        this.cardSecondaryPressedBg = ColorUtilsKt.getColorCompat(context, i5);
        this.channelIcon = ColorUtilsKt.getColorCompat(context, i3);
        int i19 = C3511R.color.primary_400;
        this.channelTextAreaPlaceholder = ColorUtilsKt.getColorCompat(context, i19);
        int i20 = C3511R.color.primary_460;
        this.channelsDefault = ColorUtilsKt.getColorCompat(context, i20);
        ...
        this.chatSwipeToReplyBackground = ColorUtilsKt.getColorCompat(context, i5);
        ...
        int i21 = C3511R.color.teal_400;
        this.creatorRevenueIconGradientEnd = ColorUtilsKt.getColorCompat(context, i21);
        int i22 = C3511R.color.teal_345;
        this.creatorRevenueIconGradientStart = ColorUtilsKt.getColorCompat(context, i22);
        this.creatorRevenueInfoBoxBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.creator_revenue_info_box_background_light);
        this.creatorRevenueInfoBoxBorder = ColorUtilsKt.getColorCompat(context, i21);
        this.creatorRevenueLockedChannelIcon = ColorUtilsKt.getColorCompat(context, i21);
        this.creatorRevenueProgressBar = ColorUtilsKt.getColorCompat(context, i22);
        this.deprecatedCardBg = ColorUtilsKt.getColorCompat(context, i2);
        this.deprecatedCardEditableBg = ColorUtilsKt.getColorCompat(context, C3511R.color.deprecated_card_editable_bg_light);
        this.deprecatedQuickswitcherInputBackground = ColorUtilsKt.getColorCompat(context, i);
        this.deprecatedQuickswitcherInputPlaceholder = ColorUtilsKt.getColorCompat(context, C3511R.color.deprecated_quickswitcher_input_placeholder_light);
        ...
        this.deprecatedTextInputBorder = ColorUtilsKt.getColorCompat(context, C3511R.color.deprecated_text_input_border_light);
        this.deprecatedTextInputBorderDisabled = ColorUtilsKt.getColorCompat(context, i6);
        int i23 = C3511R.color.primary_300;
        this.deprecatedTextInputBorderHover = ColorUtilsKt.getColorCompat(context, i23);
        this.deprecatedTextInputPrefix = ColorUtilsKt.getColorCompat(context, i23);
        this.displayBannerOverflowBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.display_banner_overflow_background_light);
        this.dividerStrong = ColorUtilsKt.getColorCompat(context, C3511R.color.divider_strong_light);
        this.dividerSubtle = ColorUtilsKt.getColorCompat(context, C3511R.color.divider_subtle_light);
        this.focusPrimary = ColorUtilsKt.getColorCompat(context, C3511R.color.blue_345);
        this.forumPostExtraMediaCountContainerBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.forum_post_extra_media_count_container_background_light);
        this.forumPostTagBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.forum_post_tag_background_light);
        ...
        int i24 = C3511R.color.primary_860;
        this.headerPrimary = ColorUtilsKt.getColorCompat(context, i24);
        this.headerSecondary = ColorUtilsKt.getColorCompat(context, i18);
        this.homeBackground = ColorUtilsKt.getColorCompat(context, i2);
        this.homeCardRestingBorder = ColorUtilsKt.getColorCompat(context, C3511R.color.home_card_resting_border_light);
        this.iconMuted = ColorUtilsKt.getColorCompat(context, i19);
        this.iconPrimary = ColorUtilsKt.getColorCompat(context, i24);
        this.iconSecondary = ColorUtilsKt.getColorCompat(context, i18);
        this.infoBoxBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.info_box_background_light);
        this.infoDangerBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.info_danger_background_light);
        ...
        this.infoHelpBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.info_help_background_light);
        int i25 = C3511R.color.blue_430;
        this.infoHelpForeground = ColorUtilsKt.getColorCompat(context, i25);
        this.infoHelpText = ColorUtilsKt.getColorCompat(context, i7);
        this.infoPositiveBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.info_positive_background_light);
        this.infoPositiveForeground = ColorUtilsKt.getColorCompat(context, i15);
        this.infoPositiveText = ColorUtilsKt.getColorCompat(context, i7);
        this.infoWarningBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.info_warning_background_light);
        int i26 = C3511R.color.yellow_400;
        this.infoWarningForeground = ColorUtilsKt.getColorCompat(context, i26);
        this.infoWarningText = ColorUtilsKt.getColorCompat(context, i7);
        this.inputBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.input_background_light);
        this.inputPlaceholderText = ColorUtilsKt.getColorCompat(context, i18);
        this.interactiveActive = ColorUtilsKt.getColorCompat(context, i24);
        this.interactiveHover = ColorUtilsKt.getColorCompat(context, i16);
        this.interactiveMuted = ColorUtilsKt.getColorCompat(context, i23);
        this.interactiveNormal = ColorUtilsKt.getColorCompat(context, i18);
        this.legacyAndroidBlurOverlayDefault = ColorUtilsKt.getColorCompat(context, C3511R.color.legacy_android_blur_overlay_default_light);
        this.legacyAndroidBlurOverlayUltraThin = ColorUtilsKt.getColorCompat(context, C3511R.color.legacy_android_blur_overlay_ultra_thin_light);
        this.legacyBlurFallbackDefault = ColorUtilsKt.getColorCompat(context, C3511R.color.legacy_blur_fallback_default_light);
        this.legacyBlurFallbackUltraThin = ColorUtilsKt.getColorCompat(context, C3511R.color.legacy_blur_fallback_ultra_thin_light);
        this.liveStageTileBorder = ColorUtilsKt.getColorCompat(context, C3511R.color.live_stage_tile_border_light);
        this.logoPrimary = ColorUtilsKt.getColorCompat(context, i11);
        this.mentionBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.mention_background_light);
        ...
        this.navigatorHeaderTint = ColorUtilsKt.getColorCompat(context, i18);
        this.profileGradientCardBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.profile_gradient_card_background_light);
        this.profileGradientMessageInputBorder = ColorUtilsKt.getColorCompat(context, C3511R.color.profile_gradient_message_input_border_light);
        this.profileGradientNoteBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.profile_gradient_note_background_light);
        this.profileGradientOverlay = ColorUtilsKt.getColorCompat(context, C3511R.color.profile_gradient_overlay_light);
        this.profileGradientOverlaySyncedWithUserTheme = ColorUtilsKt.getColorCompat(context, C3511R.color.profile_gradient_overlay_synced_with_user_theme_light);
        this.profileGradientProfileBodyBackgroundHover = ColorUtilsKt.getColorCompat(context, C3511R.color.profile_gradient_profile_body_background_hover_light);
        this.profileGradientRolePillBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.profile_gradient_role_pill_background_light);
        this.profileGradientRolePillBorder = ColorUtilsKt.getColorCompat(context, C3511R.color.profile_gradient_role_pill_border_light);
        this.profileGradientSectionBox = ColorUtilsKt.getColorCompat(context, C3511R.color.profile_gradient_section_box_light);
        this.redesignActivityCardBackground = ColorUtilsKt.getColorCompat(context, i);
        this.redesignActivityCardBackgroundPressed = ColorUtilsKt.getColorCompat(context, i5);
        this.redesignActivityCardBadgeIcon = ColorUtilsKt.getColorCompat(context, i19);
        this.redesignActivityCardBorder = ColorUtilsKt.getColorCompat(context, C3511R.color.redesign_activity_card_border_light);
        int i27 = C3511R.color.primary_230;
        this.redesignActivityCardOverflowBackground = ColorUtilsKt.getColorCompat(context, i27);
        this.redesignButtonDangerBackground = ColorUtilsKt.getColorCompat(context, i8);
        this.redesignButtonDangerPressedBackground = ColorUtilsKt.getColorCompat(context, i12);
        this.redesignButtonDangerText = ColorUtilsKt.getColorCompat(context, i);
        this.redesignButtonOverlayAlphaBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.redesign_button_overlay_alpha_background_light);
        this.redesignButtonOverlayAlphaPressedBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.redesign_button_overlay_alpha_pressed_background_light);
        this.redesignButtonOverlayAlphaText = ColorUtilsKt.getColorCompat(context, i);
        this.redesignButtonOverlayBackground = ColorUtilsKt.getColorCompat(context, i);
        this.redesignButtonOverlayPressedBackground = ColorUtilsKt.getColorCompat(context, i27);
        this.redesignButtonOverlayText = ColorUtilsKt.getColorCompat(context, i24);
        this.redesignButtonPositiveBackground = ColorUtilsKt.getColorCompat(context, i14);
        this.redesignButtonPositivePressedBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.green_460);
        this.redesignButtonPositiveText = ColorUtilsKt.getColorCompat(context, i);
        this.redesignButtonPrimaryAltBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.redesign_button_primary_alt_background_light);
        this.redesignButtonPrimaryAltBorder = ColorUtilsKt.getColorCompat(context, i11);
        this.redesignButtonPrimaryAltOnBlurpleBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.redesign_button_primary_alt_on_blurple_background_light);
        this.redesignButtonPrimaryAltOnBlurpleBorder = ColorUtilsKt.getColorCompat(context, i);
        int i28 = C3511R.color.brand_530;
        this.redesignButtonPrimaryAltOnBlurplePressedBackground = ColorUtilsKt.getColorCompat(context, i28);
        this.redesignButtonPrimaryAltOnBlurplePressedBorder = ColorUtilsKt.getColorCompat(context, C3511R.color.brand_360);
        this.redesignButtonPrimaryAltOnBlurpleText = ColorUtilsKt.getColorCompat(context, i);
        this.redesignButtonPrimaryAltPressedBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.redesign_button_primary_alt_pressed_background_light);
        this.redesignButtonPrimaryAltPressedBorder = ColorUtilsKt.getColorCompat(context, C3511R.color.brand_330);
        this.redesignButtonPrimaryAltPressedText = ColorUtilsKt.getColorCompat(context, i10);
        this.redesignButtonPrimaryAltText = ColorUtilsKt.getColorCompat(context, i11);
        this.redesignButtonPrimaryBackground = ColorUtilsKt.getColorCompat(context, i11);
        this.redesignButtonPrimaryOnBlurpleBackground = ColorUtilsKt.getColorCompat(context, i);
        this.redesignButtonPrimaryOnBlurplePressedBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.brand_200);
        this.redesignButtonPrimaryOnBlurplePressedText = ColorUtilsKt.getColorCompat(context, i28);
        ...
        this.redesignButtonPrimaryText = ColorUtilsKt.getColorCompat(context, i);
        this.redesignButtonSecondaryAltBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.redesign_button_secondary_alt_background_light);
        this.redesignButtonSecondaryAltPressedBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.redesign_button_secondary_alt_pressed_background_light);
        this.redesignButtonSecondaryAltPressedText = ColorUtilsKt.getColorCompat(context, i18);
        this.redesignButtonSecondaryAltText = ColorUtilsKt.getColorCompat(context, i16);
        this.redesignButtonSecondaryBackground = ColorUtilsKt.getColorCompat(context, i);
        this.redesignButtonSecondaryBorder = ColorUtilsKt.getColorCompat(context, C3511R.color.redesign_button_secondary_border_light);
        this.redesignButtonSecondaryPressedBackground = ColorUtilsKt.getColorCompat(context, i4);
        this.redesignButtonSecondaryPressedBorder = ColorUtilsKt.getColorCompat(context, C3511R.color.redesign_button_secondary_pressed_border_light);
        this.redesignButtonSecondaryText = ColorUtilsKt.getColorCompat(context, i16);
        this.redesignChannelCategoryNameText = ColorUtilsKt.getColorCompat(context, i18);
        ...
        this.redesignChannelNameText = ColorUtilsKt.getColorCompat(context, i24);
        this.redesignChatInputBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.redesign_chat_input_background_light);
        this.redesignInputControlActiveBg = ColorUtilsKt.getColorCompat(context, i);
        this.redesignInputControlSelected = ColorUtilsKt.getColorCompat(context, i11);
        this.redesignOnlyBackgroundActive = ColorUtilsKt.getColorCompat(context, i3);
        this.redesignOnlyBackgroundDefault = ColorUtilsKt.getColorCompat(context, i);
        this.redesignOnlyBackgroundOverlay = ColorUtilsKt.getColorCompat(context, i5);
        this.redesignOnlyBackgroundRaised = ColorUtilsKt.getColorCompat(context, i4);
        this.redesignOnlyBackgroundSunken = ColorUtilsKt.getColorCompat(context, i6);
        this.scrollbarAutoScrollbarColorThumb = ColorUtilsKt.getColorCompat(context, i27);
        this.scrollbarAutoScrollbarColorTrack = ColorUtilsKt.getColorCompat(context, i4);
        this.scrollbarAutoThumb = ColorUtilsKt.getColorCompat(context, i23);
        this.scrollbarAutoTrack = ColorUtilsKt.getColorCompat(context, i5);
        this.scrollbarThinThumb = ColorUtilsKt.getColorCompat(context, C3511R.color.scrollbar_thin_thumb_light);
        this.scrollbarThinTrack = ColorUtilsKt.getColorCompat(context, C3511R.color.scrollbar_thin_track_light);
        ...
        this.statusDnd = ColorUtilsKt.getColorCompat(context, i8);
        this.statusIdle = ColorUtilsKt.getColorCompat(context, i26);
        this.statusOffline = ColorUtilsKt.getColorCompat(context, i20);
        this.statusOnline = ColorUtilsKt.getColorCompat(context, i15);
        this.statusPositive = ColorUtilsKt.getColorCompat(context, i15);
        this.statusPositiveBackground = ColorUtilsKt.getColorCompat(context, i14);
        this.statusPositiveText = ColorUtilsKt.getColorCompat(context, i);
        this.statusSpeaking = ColorUtilsKt.getColorCompat(context, C3511R.color.green_360);
        this.statusWarning = ColorUtilsKt.getColorCompat(context, i26);
        this.statusWarningBackground = ColorUtilsKt.getColorCompat(context, i26);
        ...
        this.textLink = ColorUtilsKt.getColorCompat(context, i25);
        this.textLinkLowSaturation = ColorUtilsKt.getColorCompat(context, i25);
        ...
        this.textMutedOnDefault = ColorUtilsKt.getColorCompat(context, i3);
        this.textNormal = ColorUtilsKt.getColorCompat(context, i16);
        this.textPositive = ColorUtilsKt.getColorCompat(context, i14);
        this.textPrimary = ColorUtilsKt.getColorCompat(context, i16);
        this.textSecondary = ColorUtilsKt.getColorCompat(context, i18);
        this.textWarning = ColorUtilsKt.getColorCompat(context, C3511R.color.yellow_430);
        this.textboxMarkdownSyntax = ColorUtilsKt.getColorCompat(context, i17);
        this.themeLockedBlurFallback = ColorUtilsKt.getColorCompat(context, C3511R.color.theme_locked_blur_fallback_light);
        this.userProfileHeaderOverflowBackground = ColorUtilsKt.getColorCompat(context, C3511R.color.user_profile_header_overflow_background_light);
        this.voiceVideoTileBlurFallback = ColorUtilsKt.getColorCompat(context, C3511R.color.voice_video_tile_blur_fallback_light);
        this.voiceVideoVideoTileBlurFallback = ColorUtilsKt.getColorCompat(context, C3511R.color.voice_video_video_tile_blur_fallback_light);
