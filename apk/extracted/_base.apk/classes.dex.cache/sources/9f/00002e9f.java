...
public class ClipboardModule extends ContextBaseJavaModule {
    ...
    /* loaded from: /home/user/temp/discord/apk/extracted/_base.apk/classes3.dex */
    class ClipboardManager$OnPrimaryClipChangedListenerC5389a implements ClipboardManager.OnPrimaryClipChangedListener {
        ClipboardManager$OnPrimaryClipChangedListenerC5389a() {
            ClipboardModule.this = r1;
        }
    ...
    public void setListener() {
        try {
            ClipboardManager clipboardService = getClipboardService();
            ClipboardManager$OnPrimaryClipChangedListenerC5389a clipboardManager$OnPrimaryClipChangedListenerC5389a = new ClipboardManager$OnPrimaryClipChangedListenerC5389a();
            this.listener = clipboardManager$OnPrimaryClipChangedListenerC5389a;
            clipboardService.addPrimaryClipChangedListener(clipboardManager$OnPrimaryClipChangedListenerC5389a);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
