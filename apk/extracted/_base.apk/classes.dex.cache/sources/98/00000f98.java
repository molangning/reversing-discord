...
public final class GuildEventInviteEmbedImpl extends CodedLinkEmbed implements GuildEventInviteEmbed, GuildInviteExtendedEmbed {
    ...
    @Metadata(m14358d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u000f\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004HÆ\u0001¨\u0006\u0006"}, m14357d2 = {"Lcom/discord/chat/bridge/codedlinks/GuildEventInviteEmbedImpl$Companion;", "", "()V", "serializer", "Lkotlinx/serialization/KSerializer;", "Lcom/discord/chat/bridge/codedlinks/GuildEventInviteEmbedImpl;", "chat_release"}, m14356k = 1, m14355mv = {1, 8, 0}, m14353xi = 48)
    /* loaded from: /home/user/temp/discord/apk/extracted/_base.apk/classes8.dex */
    ...
    public /* synthetic */ GuildEventInviteEmbedImpl(int i, int i2, int i3, int i4, CodedLinkExtendedType codedLinkExtendedType, int i5, String str, InviteType inviteType, Integer num, Integer num2, Integer num3, String str2, String str3, String str4, String str5, String str6, Integer num4, Boolean bool, String str7, String str8, StructurableText structurableText, String str9, Boolean bool2, String str10, String str11, String str12, Integer num5, Boolean bool3, String str13, String str14, Integer num6, Integer num7, String str15, Boolean bool4, Integer num8, String str16, String str17, String str18, Integer num9, Integer num10, Integer num11, String str19, String str20, Integer num12, String str21, SerializationConstructorMarker serializationConstructorMarker) {
        super(null);
        if ((59 != (i & 59)) | ((i2 & 0) != 0)) {
            C2620n1.m32837a(new int[]{i, i2}, new int[]{59, 0}, GuildEventInviteEmbedImpl$$serializer.INSTANCE.getDescriptor());
        }
    ...
    public static final void write$Self(GuildEventInviteEmbedImpl self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        if (output.mo12879z(serialDesc, 2) || self.getExtendedType() != CodedLinkExtendedType.GUILD_SCHEDULED_EVENT) {
            output.mo12894i(serialDesc, 2, CodedLinkExtendedType.Serializer.INSTANCE, self.getExtendedType());
        }
        output.mo12882w(serialDesc, 3, self.getHeaderColor());
        output.mo12880y(serialDesc, 4, self.getHeaderText());
        output.mo12894i(serialDesc, 5, InviteType.Serializer.INSTANCE, self.getType());
        if (output.mo12879z(serialDesc, 6) || self.getAcceptLabelBackgroundColor() != null) {
            output.mo12904E(serialDesc, 6, C2615m0.f7088a, self.getAcceptLabelBackgroundColor());
        }
        if (output.mo12879z(serialDesc, 7) || self.getAcceptLabelBorderColor() != null) {
            output.mo12904E(serialDesc, 7, C2615m0.f7088a, self.getAcceptLabelBorderColor());
        }
        if (output.mo12879z(serialDesc, 8) || self.getAcceptLabelColor() != null) {
            output.mo12904E(serialDesc, 8, C2615m0.f7088a, self.getAcceptLabelColor());
        }
        if (output.mo12879z(serialDesc, 9) || self.getAcceptLabelIcon() != null) {
            output.mo12904E(serialDesc, 9, C2560a2.f7013a, self.getAcceptLabelIcon());
        }
        if (output.mo12879z(serialDesc, 10) || self.getAcceptLabelText() != null) {
            output.mo12904E(serialDesc, 10, C2560a2.f7013a, self.getAcceptLabelText());
        }
        if (output.mo12879z(serialDesc, 11) || self.getBadgeCount() != null) {
            output.mo12904E(serialDesc, 11, C2560a2.f7013a, self.getBadgeCount());
        }
        if (output.mo12879z(serialDesc, 12) || self.getBadgeIcon() != null) {
            output.mo12904E(serialDesc, 12, C2560a2.f7013a, self.getBadgeIcon());
        }
        ...
        if (output.mo12879z(serialDesc, 18) || self.getContent() != null) {
            output.mo12904E(serialDesc, 18, StructurableTextSerializer.INSTANCE, self.getContent());
        }
        if (output.mo12879z(serialDesc, 19) || self.getCreatorAvatar() != null) {
            output.mo12904E(serialDesc, 19, C2560a2.f7013a, self.getCreatorAvatar());
        }
        if (output.mo12879z(serialDesc, 20) || self.getEmbedCanBeTapped() != null) {
            output.mo12904E(serialDesc, 20, C2590h.f7055a, self.getEmbedCanBeTapped());
        }
        if (output.mo12879z(serialDesc, 21) || self.getGuildIcon() != null) {
            output.mo12904E(serialDesc, 21, C2560a2.f7013a, self.getGuildIcon());
        }
        if (output.mo12879z(serialDesc, 22) || self.getGuildName() != null) {
            output.mo12904E(serialDesc, 22, C2560a2.f7013a, self.getGuildName());
        }
        if (output.mo12879z(serialDesc, 23) || self.getHeaderIcon() != null) {
            output.mo12904E(serialDesc, 23, C2560a2.f7013a, self.getHeaderIcon());
        }
        if (output.mo12879z(serialDesc, 24) || self.getHeaderTextColor() != null) {
            output.mo12904E(serialDesc, 24, C2615m0.f7088a, self.getHeaderTextColor());
        }
        if (output.mo12879z(serialDesc, 25) || self.isRsvped() != null) {
            output.mo12904E(serialDesc, 25, C2590h.f7055a, self.isRsvped());
        }
        if (output.mo12879z(serialDesc, 26) || self.getMemberText() != null) {
            output.mo12904E(serialDesc, 26, C2560a2.f7013a, self.getMemberText());
        }
        if (output.mo12879z(serialDesc, 27) || self.getOnlineText() != null) {
            output.mo12904E(serialDesc, 27, C2560a2.f7013a, self.getOnlineText());
        }
        if (output.mo12879z(serialDesc, 28) || self.getResolvingGradientEnd() != null) {
            output.mo12904E(serialDesc, 28, C2615m0.f7088a, self.getResolvingGradientEnd());
        }
        if (output.mo12879z(serialDesc, 29) || self.getResolvingGradientStart() != null) {
            output.mo12904E(serialDesc, 29, C2615m0.f7088a, self.getResolvingGradientStart());
        }
        if (output.mo12879z(serialDesc, 30) || self.getSecondaryActionIcon() != null) {
            output.mo12904E(serialDesc, 30, C2560a2.f7013a, self.getSecondaryActionIcon());
        }
        if (output.mo12879z(serialDesc, 31) || self.getSplashHasRadialGradient() != null) {
            output.mo12904E(serialDesc, 31, C2590h.f7055a, self.getSplashHasRadialGradient());
        }
        if (output.mo12879z(serialDesc, 32) || self.getSplashOpacity() != null) {
            output.mo12904E(serialDesc, 32, C2615m0.f7088a, self.getSplashOpacity());
        }
        if (output.mo12879z(serialDesc, 33) || self.getSplashUrl() != null) {
            output.mo12904E(serialDesc, 33, C2560a2.f7013a, self.getSplashUrl());
        }
        if (output.mo12879z(serialDesc, 34) || self.getInviteSplash() != null) {
            output.mo12904E(serialDesc, 34, C2560a2.f7013a, self.getInviteSplash());
        }
        if (output.mo12879z(serialDesc, 35) || self.getSubtitle() != null) {
            output.mo12904E(serialDesc, 35, C2560a2.f7013a, self.getSubtitle());
        }
        if (output.mo12879z(serialDesc, 36) || self.getSubtitleColor() != null) {
            output.mo12904E(serialDesc, 36, C2615m0.f7088a, self.getSubtitleColor());
        }
        if (output.mo12879z(serialDesc, 37) || self.getThumbnailBackgroundColor() != null) {
            output.mo12904E(serialDesc, 37, C2615m0.f7088a, self.getThumbnailBackgroundColor());
        }
        if (output.mo12879z(serialDesc, 38) || self.getThumbnailCornerRadius() != null) {
            output.mo12904E(serialDesc, 38, C2615m0.f7088a, self.getThumbnailCornerRadius());
        }
        if (output.mo12879z(serialDesc, 39) || self.getThumbnailText() != null) {
            output.mo12904E(serialDesc, 39, C2560a2.f7013a, self.getThumbnailText());
        }
        if (output.mo12879z(serialDesc, 40) || self.getThumbnailUrl() != null) {
            output.mo12904E(serialDesc, 40, C2560a2.f7013a, self.getThumbnailUrl());
        }
        if (output.mo12879z(serialDesc, 41) || self.getTitleColor() != null) {
            output.mo12904E(serialDesc, 41, C2615m0.f7088a, self.getTitleColor());
        }
        if (output.mo12879z(serialDesc, 42) || self.getTitleText() != null) {
            output.mo12904E(serialDesc, 42, C2560a2.f7013a, self.getTitleText());
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GuildEventInviteEmbedImpl) {
            ...
            return getBackgroundColor() == guildEventInviteEmbedImpl.getBackgroundColor() && getBorderColor() == guildEventInviteEmbedImpl.getBorderColor() && getExtendedType() == guildEventInviteEmbedImpl.getExtendedType() && getHeaderColor() == guildEventInviteEmbedImpl.getHeaderColor() && C9612q.m13922c(getHeaderText(), guildEventInviteEmbedImpl.getHeaderText()) && getType() == guildEventInviteEmbedImpl.getType() && C9612q.m13922c(getAcceptLabelBackgroundColor(), guildEventInviteEmbedImpl.getAcceptLabelBackgroundColor()) && C9612q.m13922c(getAcceptLabelBorderColor(), guildEventInviteEmbedImpl.getAcceptLabelBorderColor()) && C9612q.m13922c(getAcceptLabelColor(), guildEventInviteEmbedImpl.getAcceptLabelColor()) && C9612q.m13922c(getAcceptLabelIcon(), guildEventInviteEmbedImpl.getAcceptLabelIcon()) && C9612q.m13922c(getAcceptLabelText(), guildEventInviteEmbedImpl.getAcceptLabelText()) && C9612q.m13922c(getBadgeCount(), guildEventInviteEmbedImpl.getBadgeCount()) && C9612q.m13922c(getBadgeIcon(), guildEventInviteEmbedImpl.getBadgeIcon()) && C9612q.m13922c(getBodyText(), guildEventInviteEmbedImpl.getBodyText()) && C9612q.m13922c(getBodyTextColor(), guildEventInviteEmbedImpl.getBodyTextColor()) && C9612q.m13922c(getCanBeAccepted(), guildEventInviteEmbedImpl.getCanBeAccepted()) && C9612q.m13922c(getChannelIcon(), guildEventInviteEmbedImpl.getChannelIcon()) && C9612q.m13922c(getChannelName(), guildEventInviteEmbedImpl.getChannelName()) && C9612q.m13922c(getContent(), guildEventInviteEmbedImpl.getContent()) && C9612q.m13922c(getCreatorAvatar(), guildEventInviteEmbedImpl.getCreatorAvatar()) && C9612q.m13922c(getEmbedCanBeTapped(), guildEventInviteEmbedImpl.getEmbedCanBeTapped()) && C9612q.m13922c(getGuildIcon(), guildEventInviteEmbedImpl.getGuildIcon()) && C9612q.m13922c(getGuildName(), guildEventInviteEmbedImpl.getGuildName()) && C9612q.m13922c(getHeaderIcon(), guildEventInviteEmbedImpl.getHeaderIcon()) && C9612q.m13922c(getHeaderTextColor(), guildEventInviteEmbedImpl.getHeaderTextColor()) && C9612q.m13922c(isRsvped(), guildEventInviteEmbedImpl.isRsvped()) && C9612q.m13922c(getMemberText(), guildEventInviteEmbedImpl.getMemberText()) && C9612q.m13922c(getOnlineText(), guildEventInviteEmbedImpl.getOnlineText()) && C9612q.m13922c(getResolvingGradientEnd(), guildEventInviteEmbedImpl.getResolvingGradientEnd()) && C9612q.m13922c(getResolvingGradientStart(), guildEventInviteEmbedImpl.getResolvingGradientStart()) && C9612q.m13922c(getSecondaryActionIcon(), guildEventInviteEmbedImpl.getSecondaryActionIcon()) && C9612q.m13922c(getSplashHasRadialGradient(), guildEventInviteEmbedImpl.getSplashHasRadialGradient()) && C9612q.m13922c(getSplashOpacity(), guildEventInviteEmbedImpl.getSplashOpacity()) && C9612q.m13922c(getSplashUrl(), guildEventInviteEmbedImpl.getSplashUrl()) && C9612q.m13922c(getInviteSplash(), guildEventInviteEmbedImpl.getInviteSplash()) && C9612q.m13922c(getSubtitle(), guildEventInviteEmbedImpl.getSubtitle()) && C9612q.m13922c(getSubtitleColor(), guildEventInviteEmbedImpl.getSubtitleColor()) && C9612q.m13922c(getThumbnailBackgroundColor(), guildEventInviteEmbedImpl.getThumbnailBackgroundColor()) && C9612q.m13922c(getThumbnailCornerRadius(), guildEventInviteEmbedImpl.getThumbnailCornerRadius()) && C9612q.m13922c(getThumbnailText(), guildEventInviteEmbedImpl.getThumbnailText()) && C9612q.m13922c(getThumbnailUrl(), guildEventInviteEmbedImpl.getThumbnailUrl()) && C9612q.m13922c(getTitleColor(), guildEventInviteEmbedImpl.getTitleColor()) && C9612q.m13922c(getTitleText(), guildEventInviteEmbedImpl.getTitleText());
        }
        return false;
    }
    ...
    public /* synthetic */ GuildEventInviteEmbedImpl(int i, int i2, CodedLinkExtendedType codedLinkExtendedType, int i3, String str, InviteType inviteType, Integer num, Integer num2, Integer num3, String str2, String str3, String str4, String str5, String str6, Integer num4, Boolean bool, String str7, String str8, StructurableText structurableText, String str9, Boolean bool2, String str10, String str11, String str12, Integer num5, Boolean bool3, String str13, String str14, Integer num6, Integer num7, String str15, Boolean bool4, Integer num8, String str16, String str17, String str18, Integer num9, Integer num10, Integer num11, String str19, String str20, Integer num12, String str21, int i4, int i5, DefaultConstructorMarker defaultConstructorMarker) {
        this(i, i2, (i4 & 4) != 0 ? CodedLinkExtendedType.GUILD_SCHEDULED_EVENT : codedLinkExtendedType, i3, str, inviteType, (i4 & 64) != 0 ? null : num, (i4 & 128) != 0 ? null : num2, (i4 & 256) != 0 ? null : num3, (i4 & 512) != 0 ? null : str2, (i4 & 1024) != 0 ? null : str3, (i4 & RecyclerView.ItemAnimator.FLAG_MOVED) != 0 ? null : str4, (i4 & RecyclerView.ItemAnimator.FLAG_APPEARED_IN_PRE_LAYOUT) != 0 ? null : str5, (i4 & 8192) != 0 ? null : str6, (i4 & 16384) != 0 ? null : num4, (32768 & i4) != 0 ? null : bool, (65536 & i4) != 0 ? null : str7, (131072 & i4) != 0 ? null : str8, (262144 & i4) != 0 ? null : structurableText, (524288 & i4) != 0 ? null : str9, (1048576 & i4) != 0 ? null : bool2, (2097152 & i4) != 0 ? null : str10, (4194304 & i4) != 0 ? null : str11, (8388608 & i4) != 0 ? null : str12, (16777216 & i4) != 0 ? null : num5, (33554432 & i4) != 0 ? null : bool3, (67108864 & i4) != 0 ? null : str13, (134217728 & i4) != 0 ? null : str14, (268435456 & i4) != 0 ? null : num6, (536870912 & i4) != 0 ? null : num7, (1073741824 & i4) != 0 ? null : str15, (i4 & Integer.MIN_VALUE) != 0 ? null : bool4, (i5 & 1) != 0 ? null : num8, (i5 & 2) != 0 ? null : str16, (i5 & 4) != 0 ? null : str17, (i5 & 8) != 0 ? null : str18, (i5 & 16) != 0 ? null : num9, (i5 & 32) != 0 ? null : num10, (i5 & 64) != 0 ? null : num11, (i5 & 128) != 0 ? null : str19, (i5 & 256) != 0 ? null : str20, (i5 & 512) != 0 ? null : num12, (i5 & 1024) != 0 ? null : str21);
    }
