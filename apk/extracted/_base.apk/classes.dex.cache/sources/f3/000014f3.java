...
public final class LongPressAvatarData implements ReactEvent {
    ...
    @Metadata(m14358d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u000f\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004HÆ\u0001¨\u0006\u0006"}, m14357d2 = {"Lcom/discord/chat/reactevents/LongPressAvatarData$Companion;", "", "()V", "serializer", "Lkotlinx/serialization/KSerializer;", "Lcom/discord/chat/reactevents/LongPressAvatarData;", "chat_release"}, m14356k = 1, m14355mv = {1, 8, 0}, m14353xi = 48)
    /* loaded from: /home/user/temp/discord/apk/extracted/_base.apk/classes8.dex */
    ...
    public /* synthetic */ LongPressAvatarData(int i, String str, String str2, SerializationConstructorMarker serializationConstructorMarker) {
        if (3 != (i & 3)) {
            C2620n1.m32836b(i, 3, LongPressAvatarData$$serializer.INSTANCE.getDescriptor());
        }
        this.messageId = str;
        this.userId = str2;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof LongPressAvatarData) {
            ...
            return C9612q.m13922c(this.messageId, longPressAvatarData.messageId) && C9612q.m13922c(this.userId, longPressAvatarData.userId);
        }
        return false;
    }
