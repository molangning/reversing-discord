...
public final class OnSafeAreaInsetsDidChangeData implements ReactEvent {
    ...
    @Metadata(m14358d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u000f\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004HÆ\u0001¨\u0006\u0006"}, m14357d2 = {"Lcom/discord/safearea/react/events/OnSafeAreaInsetsDidChangeData$Companion;", "", "()V", "serializer", "Lkotlinx/serialization/KSerializer;", "Lcom/discord/safearea/react/events/OnSafeAreaInsetsDidChangeData;", "safe_area_release"}, m14356k = 1, m14355mv = {1, 8, 0}, m14353xi = 48)
    /* loaded from: /home/user/temp/discord/apk/extracted/_base.apk/classes5.dex */
    ...
    public static /* synthetic */ OnSafeAreaInsetsDidChangeData copy$default(OnSafeAreaInsetsDidChangeData onSafeAreaInsetsDidChangeData, float f, float f2, float f3, float f4, float f5, int i, Object obj) {
        ...
        return onSafeAreaInsetsDidChangeData.copy(f, f6, f7, f8, f5);
    }
    ...
    public static final void write$Self(OnSafeAreaInsetsDidChangeData self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.mo12886s(serialDesc, 0, self.top);
        output.mo12886s(serialDesc, 1, self.bottom);
        output.mo12886s(serialDesc, 2, self.left);
        output.mo12886s(serialDesc, 3, self.right);
        output.mo12886s(serialDesc, 4, self.imeInsetsBottom);
    }
    ...
    public /* synthetic */ OnSafeAreaInsetsDidChangeData(int i, float f, float f2, float f3, float f4, float f5, SerializationConstructorMarker serializationConstructorMarker) {
        if (31 != (i & 31)) {
            C2620n1.m32836b(i, 31, OnSafeAreaInsetsDidChangeData$$serializer.INSTANCE.getDescriptor());
        }
        this.top = f;
        this.bottom = f2;
        this.left = f3;
