...
public final class RoleSelectComponent extends SearchableSelectComponent {
    ...
    @Metadata(m14358d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u000f\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004HÆ\u0001¨\u0006\u0006"}, m14357d2 = {"Lcom/discord/chat/bridge/botuikit/RoleSelectComponent$Companion;", "", "()V", "serializer", "Lkotlinx/serialization/KSerializer;", "Lcom/discord/chat/bridge/botuikit/RoleSelectComponent;", "chat_release"}, m14356k = 1, m14355mv = {1, 8, 0}, m14353xi = 48)
    /* loaded from: /home/user/temp/discord/apk/extracted/_base.apk/classes8.dex */
    ...
    public /* synthetic */ RoleSelectComponent(int i, List list, int i2, List list2, String str, String str2, String str3, String str4, int i3, int i4, boolean z, ActionComponentState actionComponentState, SerializationConstructorMarker serializationConstructorMarker) {
        ...
        if (1438 != (i & 1438)) {
            C2620n1.m32836b(i, 1438, RoleSelectComponent$$serializer.INSTANCE.getDescriptor());
        }
        this.type = i2;
        this.indices = list2;
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof RoleSelectComponent) {
            ...
            return getType() == roleSelectComponent.getType() && C9612q.m13922c(getIndices(), roleSelectComponent.getIndices()) && C9612q.m13922c(getApplicationId(), roleSelectComponent.getApplicationId()) && C9612q.m13922c(getCustomId(), roleSelectComponent.getCustomId()) && C9612q.m13922c(getPlaceholder(), roleSelectComponent.getPlaceholder()) && C9612q.m13922c(getAccessibilityLabel(), roleSelectComponent.getAccessibilityLabel()) && getMinValues() == roleSelectComponent.getMinValues() && getMaxValues() == roleSelectComponent.getMaxValues() && getDisabled() == roleSelectComponent.getDisabled() && getState() == roleSelectComponent.getState();
        }
        return false;
    }
