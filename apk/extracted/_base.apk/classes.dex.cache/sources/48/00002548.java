...
public class StackTraceHelper {
    ...
    public static class StackFrameImpl implements StackFrame {
        ...
        public JSONObject toJSON() {
            return new JSONObject(MapBuilder.m30466of(JSStackTrace.FILE_KEY, getFile(), JSStackTrace.METHOD_NAME_KEY, getMethod(), "lineNumber", Integer.valueOf(getLine()), "column", Integer.valueOf(getColumn()), "collapse", Boolean.valueOf(isCollapsed())));
        }
