...
public abstract class ReactBaseTextShadowNode extends LayoutShadowNode {
    ...
    private static void buildSpannedFromShadowNode(ReactBaseTextShadowNode reactBaseTextShadowNode, SpannableStringBuilder spannableStringBuilder, List<SetSpanOperation> list, TextAttributes textAttributes, boolean z, Map<Integer, ReactShadowNode> map, int i) {
        ...
        for (int i2 = 0; i2 < childCount; i2++) {
            ...
            if (childAt instanceof ReactRawTextShadowNode) {
                ...
                YogaUnit yogaUnit = styleWidth.f11094b;
                YogaUnit yogaUnit2 = YogaUnit.POINT;
                if (yogaUnit == yogaUnit2 && styleHeight.f11094b == yogaUnit2) {
                    layoutWidth = styleWidth.f11093a;
                    layoutHeight = styleHeight.f11093a;
                } else {
    ...
    public Spannable spannedFromShadowNode(ReactBaseTextShadowNode reactBaseTextShadowNode, String str, boolean z, NativeViewHierarchyOptimizer nativeViewHierarchyOptimizer) {
        ...
        C5743a.m24584b(z2, "nativeViewHierarchyOptimizer is required when inline views are supported");
        ...
        buildSpannedFromShadowNode(reactBaseTextShadowNode, spannableStringBuilder, arrayList, null, z, hashMap2, 0);
        ...
        for (int i2 = 0; i2 < arrayList.size(); i2++) {
            ...
            if (z3 || (reactSpan instanceof TextInlineViewPlaceholderSpan)) {
                if (z3) {
                    ...
                    ReactShadowNode reactShadowNode = (ReactShadowNode) hashMap2.get(Integer.valueOf(textInlineViewPlaceholderSpan.getReactTag()));
