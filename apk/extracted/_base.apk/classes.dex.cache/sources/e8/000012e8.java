...
public final class SpineDrawer extends RecyclerView.ItemDecoration {
    ...
    public SpineDrawer(Context context, int i) {
        ...
        m7601a = C11577n.m7601a(new SpineDrawer$lineDrawable$2(this));
        this.lineDrawable$delegate = m7601a;
        m7601a2 = C11577n.m7601a(new SpineDrawer$splineView$2(this));
        this.splineView$delegate = m7601a2;
        this.itemPaddingOffset = context.getResources().getDimensionPixelSize(C2912R.dimen.message_accessories_vertical_spacing);
    ...
    public final void drawSpineCurve(Canvas canvas, RecyclerView parent, View child, View viewToCenterSpine, int i) {
        ...
        C9612q.m13917h(viewToCenterSpine, "viewToCenterSpine");
        canvas.save();
